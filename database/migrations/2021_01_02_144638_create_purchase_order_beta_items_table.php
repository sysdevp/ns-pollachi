...
class CreatePurchaseOrderBetaItemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('purchase_order_beta_items', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('purchase_order_beta_items');
    }
}

...
class CreateSaleOrderBlackItemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sale_order_black_items', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sale_order_black_items');
    }
}

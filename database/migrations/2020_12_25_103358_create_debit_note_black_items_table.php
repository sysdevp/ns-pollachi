...
class CreateDebitNoteBlackItemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('debit_note_black_items', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('debit_note_black_items');
    }
}

...
class CreateSaleEntryBlackItemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sale_entry_black_items', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sale_entry_black_items');
    }
}

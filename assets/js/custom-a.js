...
$(document).ready(function() {
  //for Select 2 tap opening
   $(document).on('focus', '.select2-selection.select2-selection--single', function (e) {
    ...
    // pop table search starts here

    $('#new_search thead tr').clone(true).appendTo( '#new_search thead');
    $('#new_search thead tr:eq(1) th').each( function (i) {
        var title = $(this).text();
        $(this).html( '<input type="text" placeholder="Search" />' );
    ...
    var table = $('#new_search').DataTable( {
        orderCellsTop: true,
        fixedHeader: true,
        lengthMenu: [[10, 25, 50, -1], [10, 25, 50, "All"]],
        dom: 'lBfrtip',
    ...
    // pop table search table ends here    

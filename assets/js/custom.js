...
$(document).ready(function() {
    ...
    var table = $('#master,#purchaseorder,#receivable_bill,#receivable_party,#payable_bill,#payable_party,#day_book,#ageing_report,#b2b,#b2c,#registered,#unregistered,#out_b2b,#out_b2c,#stock_summary').DataTable( {
        orderCellsTop: true,
        fixedHeader: true,

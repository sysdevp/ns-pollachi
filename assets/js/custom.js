...
$(document).ready(function() {
  ...
  //for Select 2 tap opening
   $(document).on('focus', '.select2-selection.select2-selection--single', function (e) {
    ...
    var title_name = $("#master,#receivable_bill,#receivable_party,#payable_bill,#payable_party,#day_book,#ageing_report,#b2b,#b2c,#registered,#unregistered,#out_b2b,#stock_summary").attr("class").split(" ");
  //  alert(test[3]);

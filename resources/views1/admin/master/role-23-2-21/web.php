...
Route::group(['prefix' => 'master/location', 'middleware' => ['auth']], function () {
    Route::any('/', 'LocationController@index')->middleware('permission:company_location_list');
    Route::any('create', 'LocationController@create')->middleware('permission:company_location_create');
    Route::any('store', 'LocationController@store')->middleware('permission:company_location_create');
    Route::any('show/{id}', 'LocationController@show')->middleware('permission:company_location_list');
    Route::any('edit/{id}', 'LocationController@edit')->middleware('permission:company_location_edit');
    Route::any('update/{id}', 'LocationController@update')->middleware('permission:company_location_edit');
    Route::any('delete/{id}', 'LocationController@destroy')->middleware('permission:company_location_delete');
});
...
Route::resource('purchase_gatepass_entry', 'PurchaseGatepassEntryController',['middleware' => ['auth']])->middleware('permission:purchase_gate_entry_edit|purchase_gate_entry_create');
Route::group(['middleware' => 'auth'], function () {
     Route::get('purchase_gatepass_entry/index/{id}', 'PurchaseGatepassEntryController@index')->middleware('permission:purchase_gate_entry_list');
});
Route::post('purchase_gatepass_entry/address_details/', 'PurchaseGatepassEntryController@address_details');
Route::get('purchase_gatepass_entry/delete/{id}', 'PurchaseGatepassEntryController@destroy')->middleware('permission:purchase_gate_entry_delete');

...
<div class="col-12 body-sec">
  <div class="card container px-0">
    ...
    <div class="card-body">
      ...
      <form  method="post" class="form-horizontal needs-validation" novalidate action="{{url('master/category-one/store')}}" enctype="multipart/form-data">
      {{csrf_field()}}

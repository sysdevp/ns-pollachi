  ...
  <div class="card container px-0">
    ...
    <div class="card-body" id="DivIdToPrint">
      <div class="row col-md-12">
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> {{ $receipt_note->rn_no }}</label>
          </div>
              </div>
          ...
          <div class="col-md-6">
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> {{ $receipt_note->rn_date }}</label>
          </div>
              </div>
            </div>
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> {{ $receipt_note->po_no }}</label>
          </div>
              </div>
          ...
          <div class="col-md-6">
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> {{ $receipt_note->po_date }}</label>
          </div>
              </div>
            </div>
          ...
          <div class="col-md-6">
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> 
              @if($receipt_note->purchase_type == 1)
              Cash Purchase
              @else
               Credit purchase
              @endif
...
<div class="form-row">
          ...
          <div class="col-md-6">
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> {{ $receipt_note->overall_discount }}</label>
          </div>
              </div>
            </div>
        ...
        <table class="table table-bordered table-responsive" style="width: 100%; height: 100%;">
          <thead>
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> {{ $receipt_note->round_off }}</label>
          </div>
              </div>
          ...
          <div class="col-md-6">
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> {{$receipt_note->total_net_value}}</label>
          </div>
              </div>
            </div>

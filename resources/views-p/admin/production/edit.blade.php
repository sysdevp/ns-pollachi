         ...
         <div class="col-md-6">
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control to_date" placeholder="dd-mm-yyyy" name="entry_date" value="{{$item_wastage->production_date}}" required>
          ...
          <div class="col-md-6 hide" id="id_{{$value->id}}" >
            <div class="form-group row">
              ...
              <div class="col-sm-8">
              <input type="number" class="form-control  remark" placeholder="Amount" name="amount[]" value="{{$explode_amount[$i]}}" >

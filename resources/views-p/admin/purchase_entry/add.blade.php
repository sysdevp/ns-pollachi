...
<form  method="post" class="form-horizontal" action="{{ route('purchase_entry.store') }}" id="dataInput" enctype="multipart/form-data">
      {{csrf_field()}}
                  ...
                  <div class="form-group row">
                     <div class="col-sm-8">
                      <select class="js-example-basic-multiple col-12 form-control custom-select supplier_id" onchange="supplier_details()" name="supplier_id" id="supplier_id" <?php echo Mandatoryfields::validation('purchaseentry_supplierid');?>>

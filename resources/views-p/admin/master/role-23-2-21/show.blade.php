...
// $('.mastersubheading2 input:checked').each(function() {

//      var class_name = $(this).attr('class').split('_')[0];
//      var class_name1 = $(this).attr('class').split(' ')[3];

//      if(class_name == "all")
//      {
//         var all = $(this).attr('class');
//         var submenu_check = all.split(' ')[3];
        
//         //alert(ss);
//         // $('.'+submenu_check 'input:checked').each(function() {
//         //     alert('hj');
//         // });

//          if($('.'+submenu_check).is(':checked')==true && class_name1 == submenu_check)
//          {
//           //   alert(submenu_check);
//             $('#'+submenu_check).prop("checked",true);
//          }
//          else
//          {
//             $('#'+submenu_check).prop("checked",false);
//          }

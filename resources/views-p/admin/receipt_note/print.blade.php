...
<div class="col-md-12">
	<div class="col-md-6">
		<p>
		Voucher No:{{ $receipt_note_print_data->rn_no }}
		</p>
	</div>

	 <div class="col-md-6">
	 	<p>
		Voucher Date:{{ $receipt_note_print_data->rn_date }}
		</p>
	 </div>
</div>
<div class="row col-md-12">
	<div class="col-md-6">
		<p>
		Supplier Details:<br>
		Name:{{ @$receipt_note_print_data->supplier->name }} <br>
...
<div class="col-md-12 mb-3">
	<table class="table-responsive">
		 ...
		 <tbody>
		 	@foreach($receipt_note_item_print_data as $key => $value)
		 	<tr>
		 	<td>{{ $key+1 }}</td>
...
<div class="col-md-12">
	<table class="table-responsive">
		 ...
		 <tbody>
		 	@foreach($receipt_note_expense_print_data as $key => $value)
		 	<tr>
...
<div class="col-md-12">
	<div class="col-md-6">
		<p>
			Net Value: {{ $receipt_note_print_data->total_net_value }}
		</p>
	</div>
	<div class="col-md-6">
		<p>

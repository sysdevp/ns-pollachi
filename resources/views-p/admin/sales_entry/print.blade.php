...
<div class="col-md-12">
	<div class="col-md-6">
		<p>
		Voucher No:{{ $sale_entry_print_data->s_no }}
		</p>
	</div>

	 <div class="col-md-6">
	 	<p>
		Voucher Date:{{ $sale_entry_print_data->s_date }}
		</p>
	 </div>
</div>
<div class="row col-md-12">
	<div class="col-md-6">
		<p>
		Customer Details:<br>
		Name:{{ @$sale_entry_print_data->customer->name }} <br>
...
<div class="col-md-12 mb-3">
	<table class="table-responsive">
		 ...
		 <tbody>
		 	@foreach($sale_entry_item_print_data as $key => $value)
		 	<tr>
		 	<td>{{ $key+1 }}</td>
...
<div class="col-md-12">
	<table class="table-responsive">
		 ...
		 <tbody>
		 	@foreach($sale_entry_expense_print_data as $key => $value)
		 	<tr>
...
<div class="col-md-12">
	<div class="col-md-6">
		<p>
			Net Value: {{ $sale_entry_print_data->total_net_value }}
		</p>
	</div>
	<div class="col-md-6">
		<p>

...
<div class="col-md-12">
	<div class="col-md-6">
		<p>
		Voucher No:{{ $rejection_out_print_data->r_out_no }}
		</p>
	</div>

	 <div class="col-md-6">
	 	<p>
		Voucher Date:{{ $rejection_out_print_data->r_out_date }}
		</p>
	 </div>
</div>
<div class="row col-md-12">
	<div class="col-md-6">
		<p>
		Supplier Details:<br>
		Name:{{ @$rejection_out_print_data->supplier->name }} <br>
...
<div class="col-md-12 mb-3">
	<table class="table-responsive">
		 ...
		 <tbody>
		 	@foreach($rejection_out_item_print_data as $key => $value)
		 	<tr>
		 	<td>{{ $key+1 }}</td>
		 	...
		 	<?php $amount = $value->rate_exclusive_tax * $value->rejected_qty; ?> 
...
<div class="col-md-12">
	<table class="table-responsive">
		 ...
		 <tbody>
		 	@foreach($rejection_out_expense_print_data as $key => $value)
		 	<tr>
...
<div class="col-md-12">
	<div class="col-md-6">
		<p>
			Net Value: {{ $rejection_out_print_data->total_net_value }}
		</p>
	</div>
	<div class="col-md-6">
		<p>

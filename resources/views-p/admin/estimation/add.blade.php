                       ...
                       <div class="row col-md-12 text-center">
                          ...
                          <p>
                             <button class="btn btn-success save" name="save" value="0" type="submit">Save</button>
                              ...
                              <button class="btn btn-info"  type="submit" name="hold_trans" id="hold_trans">Hold Trans </button>
                             <button class="btn btn-dark"  type="button" id="load_trans">Load Trans </button>

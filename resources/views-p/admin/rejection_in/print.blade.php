...
<div class="col-md-12">
	<div class="col-md-6">
		<p>
		Voucher No:{{ $rejection_in_print_data->r_in_no }}
		</p>
	</div>

	 <div class="col-md-6">
	 	<p>
		Voucher Date:{{ $rejection_in_print_data->r_in_date }}
		</p>
	 </div>
</div>
<div class="row col-md-12">
	<div class="col-md-6">
		<p>
		Customer Details:<br>
		Name:{{ @$rejection_in_print_data->customer->name }} <br>
...
<div class="col-md-12 mb-3">
	<table class="table-responsive">
		 ...
		 <tbody>
		 	@foreach($rejection_in_item_print_data as $key => $value)
		 	<tr>
		 	<td>{{ $key+1 }}</td>
...
<div class="col-md-12">
	<table class="table-responsive">
		 ...
		 <tbody>
		 	@foreach($rejection_in_expense_print_data as $key => $value)
		 	<tr>
...
<div class="col-md-12">
	<div class="col-md-6">
		<p>
			Net Value: {{ $rejection_in_print_data->total_net_value }}
		</p>
	</div>
	<div class="col-md-6">
		<p>

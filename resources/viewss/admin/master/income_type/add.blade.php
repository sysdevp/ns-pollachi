...
<div class="col-12 body-sec">
  <div class="card container px-0">
    ...
    <div class="card-body">
      ...
      <form  method="post" class="form-horizontal needs-validation" novalidate action="{{url('master/income-type/store')}}" enctype="multipart/form-data">
      {{csrf_field()}}
        ...
        <div class="col-md-7">
          ...
          <div class="col-md-7">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control name only_allow_alp_num_dot_com_amp" placeholder="Income Name" name="name" value="{{old('name')}}" required>

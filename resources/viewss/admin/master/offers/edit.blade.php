      ...
      <div class="form-row">
        ...
        <div class="col-md-6">
          <div class="form-group row">
            ...
            <div class="col-sm-8">
              <input type="text" class="form-control name only_allow_alp_num_dot_com_amp caps" placeholder="Offer Name" name="name" value="{{old('name',$offers->offer_name)}}" required>
        ...
        <div class="col-md-6" id="date_ranges">
          ...
          <div class="col-md-6" id="time_ranges">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                ...
                @endphp
                <div class="input-group input-daterange from_to">
                  <select name="from_time" id="from_time" class="s-example-basic-multiple form-control col-12 custom-select parent_id" required>
                    <?php echo get_times(); ?>
                    </select>
                    <div class="input-group-addon">&nbsp;&nbsp;to&nbsp;&nbsp;</div>
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="input-group col-sm-8">
                ...
                ?>
                <input type="text" class="value_custom form-control only_allow_digit_and_dot value" placeholder="Variable value" name="value" value="{{old('value', $offers->fixed_amount)}}" required>
                ...
                ?>
                <input type="text" class="value_custom form-control only_allow_digit_and_dot value" placeholder="Variable value" name="value" value="{{old('value', $offers->percentage)}}" required>
                <div class="input-group-append">
                  <span class="input-group-text" id="basic-addon1" style="height: 32px;">%</span>
                </div>
                <?php } ?>
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control  remark" placeholder="Remark" name="comments" value="{{old('comments', $offers->comments)}}">

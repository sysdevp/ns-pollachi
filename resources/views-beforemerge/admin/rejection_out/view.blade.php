          ...
          @foreach($rejection_out_beta as $key=> $value)
            <tr>
              ...
              <td> 
                ...
                <a href="{{ url('rejection_out/cancel_beta/'.$value->r_out_no) }}" class="px-2 py-1 bg-warning text-white rounded">Cancel</a>
                <br><br>
                <a href="{{url('rejection_out/item_beta_details/'.$value->r_out_no )}}" class="px-1 py-0 bg-info text-white rounded"><i class="fa fa-eye" aria-hidden="true"></i>Rejected Item Details</a>
                <a href="{{url('rejection_out/expense_beta_details/'.$value->r_out_no )}}" class="px-1 py-0 bg-info text-white rounded"><i class="fa fa-eye" aria-hidden="true"></i>Expense Details</a>
                @else

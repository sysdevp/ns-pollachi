            ...
            <ul class="dropdown-menu megamenu">
                    ...
                    <li class="col-md-3 dropdown-item">
                        <ul>
                           ...
                           <li><a href="{{ route('advance_settlement_supplier.create') }}">Advance to Suppliers</a></li>
                            <li><a href="{{ route('advance_settlement_customer.create') }}">Advance from Customers</a></li>

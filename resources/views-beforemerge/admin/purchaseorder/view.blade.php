        ...
        <tbody id="test2" style="display: none;">
          @foreach($purchaseorderbeta as $key => $value)
            <tr>
              ...
              <td> 
                @if($value->status == 0)
                <a href="{{ url('purchase_order/show_beta/'.$value->po_no) }}" class="px-2 py-1 bg-info text-white rounded"><i class="fa fa-eye" aria-hidden="true"></i></a>
                <a href="{{ url('purchase_order/edit_beta/'.$value->po_no) }}" class="px-2 py-1 bg-success text-white rounded"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                <a href="{{url('purchase_order/delete_beta/'.$value->po_no )}}" onclick="return confirm('Are you sure ?')" class="px-2 py-1 bg-danger text-white rounded"><i class="fa fa-trash" aria-hidden="true"></i></a>

          ...
          @foreach($delivery_note as $key => $value)
            <tr>
              ...
              <td> 
                ...
                <a href="{{ route('delivery_note.show',$value->d_no) }}" class="px-1 py-0 text-white rounded" title="View">><i class="fa fa-eye" aria-hidden="true"></i></a>
                <a href="{{ route('delivery_note.edit',$value->d_no) }}" class="px-1 py-0  text-white rounded" title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                <a href="{{url('delivery_note/delete/'.$value->d_no )}}" onclick="return confirm('Are you sure ?')" class="px-1 py-0  text-white rounded" title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></a>
        ...
        <tbody id="test2" style="display: none;">
          @foreach($delivery_note_beta as $key => $value)
            <tr>
              ...
              <td> 
                @if($value->cancel_status == 0)
                <a href="{{ url('delivery_note/show_beta/'.$value->d_no) }}" class="px-1 py-0 text-white rounded" title="View">><i class="fa fa-eye" aria-hidden="true"></i></a>
                <a href="{{ url('delivery_note/edit_beta/'.$value->d_no) }}" class="px-1 py-0  text-white rounded" title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i></a>

...
<form  method="post" class="form-horizontal" action="{{ route('sales_entry.store') }}" id="dataInput" enctype="multipart/form-data">
      {{csrf_field()}}
                    ...
                    <div class="row col-md-12">
                          ...
                          <div class="col-md-4">
                  <label style="font-family: Times new roman;">Voucher Type<?php echo Mandatoryfields::mandatory('saleentry_vouchertype');?></label><br>
                  <div class="form-group row">
                     <div class="col-sm-8">
                      <select class="js-example-basic-multiple col-12 form-control custom-select voucher_type" onchange="voucher_types()" name="voucher_type" id="voucher_type" <?php echo Mandatoryfields::validation('saleentry_vouchertype');?> autofocus>
               ...
               <div class="col-md-3">
                      ...
                      <div class="row col-md-12">
                                ...
                                <input type="date" class="form-control voucher_date  required_for_proof_valid" id="voucher_date" placeholder="Voucher Date" name="voucher_date" value="{{ $date }}" <?php echo Mandatoryfields::validation('saleentry_voucherdate');?>> 
                ...
                <table class="table table-responsive" id="team-list">
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <input type="number" class="form-control overall_discount" id="overall_discount" name="overall_discount" oninput="overall_discounts()" pattern="[0-9]{0,100}" title="Numbers Only" value="0" <?php echo Mandatoryfields::validation('saleentry_overall_discount');?>>
                      </div>
                    </div>
 ...
 <div class="col-md-8">
        ...
        <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" required="" class="form-control amount" name="bill_amount" value="0">
              </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <select class="js-example-basic-multiple col-12 form-control custom-select mode" onchange="payment_mode(this.value)" required="" name="mode" id="mode">
...
var voucher_type = $('.voucher_type').val();
  ...
  $.ajax({
                type: "POST",
                url: "{{ url('sales_entry/voucher_type/') }}",

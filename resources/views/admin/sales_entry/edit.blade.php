                    ...
                    <input type="hidden" name="beta_checking_value" value="{{ $beta_checking_value }}">
                      <div class="row col-md-12">
                          ...
                          <div class="col-md-1">
                                ...
                                <input type="date" class="form-control voucher_date  required_for_proof_valid" id="voucher_date" placeholder="Voucher Date" name="voucher_date" value="{{ $sale_entry->s_date }}">
                ...
                <table class="table table-responsive" id="team-list">
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <input type="number" class="form-control overall_discount" id="overall_discount" name="overall_discount" oninput="overall_discounts()" pattern="[0-9]{0,100}" title="Numbers Only" value="{{ $sale_entry->overall_discount }}">
                      </div>
                    </div>

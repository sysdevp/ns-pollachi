...
<div class="col-12 body-sec">
  <div class="card">
    ...
    <div class="card-body">
    <form  method="post" class="form-horizontal needs-validation" novalidate action="{{url('sales-entry-report')}}" enctype="multipart/form-data">
      {{csrf_field()}}
          ...
          @foreach($sale_entry_beta as $key => $value)
            <tr>
              ...
              <td> 
                @if($value->cancel_status == 0)
                <a href="{{ route('sales_entry.show',$value->s_no) }}" class="px-2 py-1 bg-info text-white rounded"><i class="fa fa-eye" aria-hidden="true"></i></a>
                <a href="{{ url('sales_entry/edit_beta/'.$value->s_no) }}" class="px-2 py-1 bg-success text-white rounded"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                <a href="{{url('sales_entry/delete/'.$value->s_no )}}" onclick="return confirm('Are you sure ?')" class="px-2 py-1 bg-danger text-white rounded"><i class="fa fa-trash" aria-hidden="true"></i></a>

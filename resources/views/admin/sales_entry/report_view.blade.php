...
<div class="col-12 body-sec">
  <div class="card">
    ...
    <div class="card-header px-2">
      <div class="row">
        <div class="col-4">
          <h3>Saleman Report</h3>
        </div>
        <div class="col-8 mr-auto">
          <ul class="h-right-btn mb-0 pl-0">
          @if($from!="" && $to!="")
          <li><button type="button" class="btn"><a href="{{url('salesman_report')}}">  Back</a></button></li>
          @endif
          </ul>
        </div>
      </div>
    ...
    <!-- card header end@ -->
    <div class="card-body">
    <form  method="post" class="form-horizontal needs-validation" novalidate action="{{url('salesman_report_search')}}" enctype="multipart/form-data">
      {{csrf_field()}}

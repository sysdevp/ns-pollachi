      ...
      <div class="row">
        ...
        <div class="col-8 mr-auto">
          <ul class="h-right-btn mb-0 pl-0">
            <li><button type="button" class="btn btn-success"><a href="{{ url('debit_note/index/0') }}">Back</a></button></li>
          </ul>
        </div>
      </div>
    </div>
...
<form  method="post" class="form-horizontal" action="{{ route('debit_note.store') }}" id="dataInput" enctype="multipart/form-data">
      {{csrf_field()}}
                            <div class="row col-md-12">
                  <div class="col-md-4">
                  <label style="font-family: Times new roman;">Voucher Type<?php echo Mandatoryfields::mandatory('debitnote_vouchertype');?></label><br>
                  <div class="form-group row">
                     <div class="col-sm-8">
                      <select class="js-example-basic-multiple col-12 form-control custom-select voucher_type" onchange="voucher_types()" name="voucher_type" id="voucher_type" <?php echo Mandatoryfields::validation('debitnote_vouchertype');?> autofocus>
                       ...
                       <div class="row col-md-12">
                        ...
                        <div class="col-md-2">
                                  ...
                                  <div class="">
                                    ...
                                    <input type="date" class="form-control voucher_no  required_for_proof_valid" value="">
                                  </div>
                                ...
                                <div class="col-md-2">
                                  <label style="font-family: Times new roman;">Voucher Date<?php echo Mandatoryfields::mandatory('debitnote_voucherdate');?></label><br>
                                <input type="date" class="form-control voucher_date  required_for_proof_valid" id="voucher_date" placeholder="Voucher Date" name="voucher_date" value="{{ $date }}" <?php echo Mandatoryfields::validation('debitnote_voucherdate');?>>
                                 
                                </div>

                        <div class="col-md-4">
                  <label style="font-family: Times new roman;">Party Name<?php echo Mandatoryfields::mandatory('debitnote_supplierid');?></label><br>
                  <div class="form-group row">
                     <div class="col-sm-8">
                      <select class="js-example-basic-multiple col-12 form-control custom-select supplier_id" onchange="supplier_details()" name="supplier_id" id="supplier_id" <?php echo Mandatoryfields::validation('debitnote_supplierid');?>>
                     ...
                     <button type="button"  class="px-2 btn btn-success mx-2 refresh_supplier_id" title="Add Brand"><i class="fa fa-refresh" aria-hidden="true"></i></button>
                        ...
                        <div class="col-md-2">
                                ...
                                data-placeholder="Choose Purchase Entry No" onchange="p_details()" id="p_no" name="p_no" >
                                <option value="">Choose Purchase Entry No</option>
                                @foreach($purchase_entry as $purchase)
                                <option value="{{ $purchase->p_no }}">{{ $purchase->p_no }}</option>
                                  @endforeach 
                                 </select>
                        ...
                        <div class="col-md-2">
                                ...
                                <input type="date" class="form-control r_out_date  required_for_proof_valid" readonly="" id="r_out_date" placeholder="Voucher Date" name="r_out_date" value="">
                              ...
                              <div class="row col-md-12 mb-3">
                                ...
                                <div class="col-md-2">
                                  <label style="font-family: Times new roman;">Company Location<?php echo Mandatoryfields::mandatory('debitnote_location');?></label><br>
                                <select class="js-example-basic-multiple form-control location" 
                                data-placeholder="Choose Location" id="location" name="location" <?php echo Mandatoryfields::validation('debitnote_location');?>>
                                <option></option>
                ...
                <table class="table table-responsive" id="team-list">
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <div class="col-md-2">
                        <label style="font-family: Times new roman;">Overall Discount<?php echo Mandatoryfields::mandatory('debitnote_overall_discount');?></label>
                      <input type="number" class="form-control overall_discount" id="overall_discount" name="overall_discount" oninput="overall_discounts()" pattern="[0-9]{0,100}" title="Numbers Only" value="0" <?php echo Mandatoryfields::validation('debitnote_overall_discount');?>>
                      </div>
                    </div>
...
var voucher_type = $('.voucher_type').val();
  ...
  $.ajax({
                type: "POST",
                url: "{{ url('debit_note/voucher_type/') }}",
...
$.ajax({
           type: "POST",
            url: "{{ url('debit_note/po_alpha_beta/') }}",
            data: { id: val },
           success: function(data) {
            var result = JSON.parse(data);

            // console.log(result.r_out_no);
            var p_data = result.p_no;
            var r_out_no = result.r_out_no;

            $('.p_no').children('option:not(:first)').remove();
            $('.r_out_no').children('option:not(:first)').remove();
            
            $(p_data).appendTo('.p_no'); 
            $(r_out_no).appendTo('.r_out_no');
...
function browse_item()
{
  ...
  $.ajax({  
        ...
        type: "GET",
        url: "{{ url('debit_note/browse_item/{id}') }}",
...
function p_details()
{
  ...
  $.ajax({
           type: "POST",
            ...
            data: { p_no : p_no, alpha_beta : alpha_beta },
           success: function(data) {
            $('.tables').remove();
            $('.expense').remove();
            var result=JSON.parse(data);
...
function r_out_details()
{
  ...
  $.ajax({
           type: "POST",
            url: "{{ url('debit_note/r_out_details/') }}",
            data: { r_out_no : r_out_no, alpha_beta : alpha_beta },
           success: function(data) {

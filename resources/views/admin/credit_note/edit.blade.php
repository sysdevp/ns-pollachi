...
<form  method="post" class="form-horizontal" action="{{ route('credit_note.update',$credit_note->cn_no) }}" id="dataInput" enctype="multipart/form-data">
      {{csrf_field()}}
      @method('PATCH')
                  ...
                  <div class="form-group row">
                     <div class="col-sm-8">
                      <select class="js-example-basic-multiple col-12 form-control custom-select customer_id" onchange="customer_details()" name="customer_id" id="customer_id">
                           ...
                           <option value="{{ $credit_note->customer->id }}">{{ $credit_note->customer->name }}</option>
                           @else
                     ...
                     <button type="button"  class="px-2 btn btn-success mx-2 refresh_customer_id" title="Add Brand"><i class="fa fa-refresh" aria-hidden="true"></i></button>
                        ...
                        <div class="col-md-2">
                                  ...
                                  <div class="">
                                    <input type="hidden" readonly="" id="voucher_no" name="voucher_no" value="{{ $credit_note->cn_no }}">
                                    <font size="2">{{ $credit_note->cn_no }}</font>
                                  </div>
                                ...
                                <input type="date" class="form-control voucher_date  required_for_proof_valid" id="voucher_date" placeholder="Voucher Date" name="voucher_date" value="{{ $credit_note->cn_date }}">
                        ...
                        <div class="col-md-2">
                                ...
                                <option value="{{ $credit_note->s_no }}">{{ $credit_note->s_no }}</option>
                        ...
                        <div class="col-md-2">
                                ...
                                <input type="date" class="form-control s_date  required_for_proof_valid" readonly="" id="s_date" placeholder="Voucher Date" name="s_date" value="{{ $credit_note->s_date }}">
                                ...
                                <option value="{{ $credit_note->r_in_no }}">{{ $credit_note->r_in_no }}</option>
                                ...
                                <input type="date" class="form-control r_in_date  required_for_proof_valid" readonly="" id="r_in_date" placeholder="Voucher Date" name="r_in_date" value="{{ $credit_note->r_in_date }}">
                ...
                <select class="js-example-basic-multiple col-12 form-control custom-select location" name="location" data-placeholder="Choose Location" id="location" required="">
                 <option value="{{ @$credit_note->location }}">{{ @$credit_note->locations->name }}</option>
                ...
                <table class="table table-responsive" id="team-list">
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <input type="number" class="form-control overall_discount" id="overall_discount" name="overall_discount" oninput="overall_discounts()" pattern="[0-9]{0,100}" title="Numbers Only" value="{{ $credit_note->overall_discount }}">
                      </div>
                    </div>
                    ...
                    <!-- <div class="row col-md-12">
                        ...
                        <div class="row col-md-12 append_expense">
                          ...
                          @foreach($credit_note_expense as $key => $value)
                  ...
                  <div class="form-group row">
                    ...
                    @endif
                      ...
                      <input type="text" class="form-control round_off" readonly="" value="{{$credit_note->round_off}}" id="round_off" name="round_off" >
                      </div>

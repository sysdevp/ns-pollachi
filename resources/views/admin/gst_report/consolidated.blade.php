          ...
          <table class="table table-striped table-bordered" id="consolidate">
                  <thead>
                    ...
                    <tr>
                      ...
                      <td class="cust_sum_tax">{{$cust_sum_tax_b2b}}</td>
                    ...
                    <tr>
                      ...
                      <td class="cust_sum_tax">{{$cust_sum_tax_b2c}}</td>
                    ...
                    <tr>
                      ...
                      <td class="cust_sum_tax">{{$cust_sum_tax_unreg}}</td>
                    ...
                    <tr>
                      ...
                      <td class="sum_tax">{{$sum_tax_b2b}}</td>
                    ...
                    <tr>
                      ...
                      <td class="sum_tax">{{$sum_tax_b2c}}</td>
                    ...
                    <tr>
                      ...
                      <td class="sum_tax">{{$sum_tax_unreg}}</td>

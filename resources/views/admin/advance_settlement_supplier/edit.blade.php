...
<div class="col-12 body-sec">
  <div class="card container px-0">
    ...
    <div class="card-header px-2">
      <div class="row">
        <div class="col-4">
          <h3>Edit Advance Settlement For Supplier</h3>
        </div>
    ...
    <div class="card-body">
      ...
      <form  method="post" class="form-horizontal needs-validation" novalidate action="{{route('advance_settlement_supplier.update',$advance->id)}}" enctype="multipart/form-data">
      {{csrf_field()}}
      @method('PATCH')
        <div class="form-row">
          <div class="col-md-6">
                    ...
                    <label for="validationCustom01" class="col-sm-4 col-form-label">Party Name <?php echo Mandatoryfields::mandatory('advancetosupplier_supplierid');?>:</label>
                     <div class="col-sm-6">
                      <select class="js-example-basic-multiple col-12 form-control custom-select supplier_id"  name="supplier_id" id="supplier_id" <?php echo Mandatoryfields::validation('advancetosupplier_supplierid');?> autofocus>
                           ...
                           <option value="{{ $suppliers->id }}"  {{$advance->supplier_id == $suppliers->id ? 'selected' : '' }}>{{ $suppliers->name }}</option>
                           @endforeach
                        </select>
                     </div>
        ...
        <div class="row col-md-12 append_expense">
                  ...
                  <div class="form-group row">
                     <input type="text" class="form-control voucher_no" id="voucher_no"  placeholder="Payment Voucher No" name="voucher_no" step="any"  value="{{$advance->voucher_no}}" <?php echo Mandatoryfields::validation('advancetosupplier_voucher_no');?>>
                     
                  </div>
               </div>
                      <div class="col-md-3">
                        <label style="font-family: Times new roman;">Date<?php echo Mandatoryfields::mandatory('advancetosupplier_date');?></label>
                      <input type="date" class="form-control date" id="date"  placeholder="" name="payment_date" step="any" value="{{$advance->payment_date}}">

                      <input type="hidden" name="expense_total" id="expense_total" value="{{$advance->payment_date}}" class="expense_total" <?php echo Mandatoryfields::validation('advancetosupplier_date');?>>
        ...
        <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control request_no" placeholder="Total Advance Amount" name="advance_amount" value="{{$advance->advance_amount}}" <?php echo Mandatoryfields::validation('advancetosupplier_advance_amount');?>>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control remark" placeholder="Remarks" name="remark" value="{{$advance->remarks}}" <?php echo Mandatoryfields::validation('advancetosupplier_remark');?>>
              </div>
            </div>
          </div>
        </div>

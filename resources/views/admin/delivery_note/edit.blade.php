...
<form  method="post" class="form-horizontal" action="{{ route('delivery_note.update',$delivery_note->d_no) }}" id="dataInput" enctype="multipart/form-data">
      {{csrf_field()}}
      @method('PATCH')
                      ...
                      <div class="row col-md-12">
                                ...
                                <div class="col-md-4">
                  <label style="font-family: Times new roman;">Customer Name<?php echo Mandatoryfields::mandatory('deliverynote_customerid');?></label><br>
                  <div class="form-group row">
                     <div class="col-sm-8">
                      <select class="js-example-basic-multiple col-12 form-control custom-select customer_id" onchange="customer_details()" name="customer_id" id="customer_id" <?php echo Mandatoryfields::validation('deliverynote_customerid');?> autofocus>
                           @if(isset($delivery_note->customer->name) && !empty($delivery_note->customer->name))
                           <option value="{{ $delivery_note->customer->id }}">{{ $delivery_note->customer->name }}</option>
                           @else
                     ...
                     <button type="button"  class="px-2 btn btn-success mx-2 refresh_customer_id" title="Add Brand"><i class="fa fa-refresh" aria-hidden="true"></i></button>
                                ...
                                <div class="col-md-3">
                  <label style="font-family: Times new roman;">Sales Men Name<?php echo Mandatoryfields::mandatory('deliverynote_salesmenid');?></label><br>
                  <div class="form-group row">
                     <div class="col-sm-8">
                      <select class="js-example-basic-multiple col-12 form-control custom-select salesmen_id" name="salesmen_id" id="salesmen_id" <?php echo Mandatoryfields::validation('deliverynote_salesmenid');?>>
                           @if(isset($delivery_note->salesman->id) && !empty($delivery_note->salesman->id))
                           <option value="{{ $delivery_note->salesman->id }}">{{ $delivery_note->salesman->name }}</option>
                           @else
                       ...
                       <div class="row col-md-12">
                        ...
                        <div class="col-md-2">
                                  ...
                                  <div class="">
                                    ...
                                    <input type="hidden" id="voucher_number" name="voucher_number" value="{{ $delivery_note->voucher_no }}">
                                    <font size="2">{{ $delivery_note->d_no }}</font>
                                  </div>
                                ...
                                <div class="col-md-2">
                                  <label style="font-family: Times new roman;">Voucher Date<?php echo Mandatoryfields::mandatory('deliverynote_voucherdate');?></label><br>
                                <input type="date" class="form-control voucher_date  required_for_proof_valid" id="voucher_date" placeholder="Voucher Date" name="voucher_date" value="{{ $delivery_note->d_date }}" <?php echo Mandatoryfields::validation('deliverynote_voucherdate');?>>
                        ...
                        <div class="col-md-2">
                                ...
                                <option value="{{ $delivery_note->r_in_no }}">{{ $delivery_note->r_in_no }}</option>
                                ...
                                <input type="date" class="form-control r_in_date  required_for_proof_valid" readonly="" id="r_in_date" placeholder="Voucher Date" name="r_in_date" value="{{ $delivery_note->r_in_date }}">
                                ...
                                <div class="col-md-2">
                                  <label style="font-family: Times new roman;">Company Location<?php echo Mandatoryfields::mandatory('deliverynote_location');?></label><br>
                                <select class="js-example-basic-multiple form-control location" 
                                data-placeholder="Choose Location" id="location" name="location" <?php echo Mandatoryfields::validation('deliverynote_location');?>>
                                <option value="{{ @$delivery_note->location }}">{{@$delivery_note->locations->name}}</option>
                ...
                <table class="table table-responsive" id="team-list">
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <input type="number" class="form-control overall_discount" id="overall_discount" name="overall_discount" oninput="overall_discounts()" pattern="[0-9]{0,100}" title="Numbers Only" value="{{ $delivery_note->overall_discount }}">
                      </div>
                    </div>
                  ...
                  <div class="form-group row">
                    ...
                    @endif
                       ...
                       <div class="col-md-12" style="float: right;">
                        ...
                        <font color="black" style="font-size: 150%; margin-left: 700px; font-weight: 900;">NET Value :</font>&nbsp;<font class="total_net_value" style="font-size: 150%; font-weight: 900;">{{$delivery_note->total_net_value}}</font> 
                       </div>
                    <!-- net value -->
                      ...
                      <input type="text" class="form-control round_off" readonly="" value="{{ $delivery_note->round_off }}" id="round_off" name="round_off" >
                      </div>
...
$.ajax({
           type: "POST",
            url: "{{ url('delivery_note/po_alpha_beta/') }}",
            data: { id: val },
...
function add_items()
{
 ...
 else
 {
  ...
  var items='<tr id="row'+counts+'" class="'+counts+' tables"><td><span class="item_s_no"> 1 </span></td><td><div class="form-group row"><div class="col-sm-12"><input class="invoice_no'+counts+'" type="hidden" id="invoice'+counts+'" value="'+invoice_no+'" name="invoice_sno[]"><font class="item_no'+counts+'" style="float:right;">'+invoice_no+'</font></div></div></td><td><div class="form-group row"><div class="col-sm-12"><input type="hidden" class="items_id" value="'+items_codes+'"><input type="hidden" class="item_code'+counts+'" value="'+items_codes+'" name="item_code[]"><font class="items'+counts+'">'+item_code+'</font></div></div></td><td><div class="form-group row"><div class="col-sm-12"><input class="item_name'+counts+'" type="hidden" value="'+item_name+'" name="item_name[]"><input type="hidden" value="'+item_name1+'" name="item_name1[]"><font class="font_item_name'+counts+'">'+item_name+'</font></div></div></td><td><div class="form-group row"><div class="col-sm-12"><input class="hsn'+counts+'" type="hidden" value="'+hsn+'" name="hsn[]"><font class="font_hsn'+counts+'">'+hsn+'</font></div></div></td><td><div class="form-group row"><div class="col-sm-12"><input type="hidden" class="mrp'+counts+'" value="'+mrp+'" name="mrp[]"><font class="font_mrp'+counts+'" style="float:right;">'+mrp+'</font></div></div></td><td><div class="form-group row"><div class="col-sm-12" id="unit_price"><input type="hidden" class="exclusive'+counts+'" value="'+exclusive+'" name="exclusive[]"><font class="font_exclusive'+counts+'" style="float:right;">'+exclusive+'</font><input type="hidden" class="inclusive'+counts+'" value="'+inclusive+'" name="inclusive[]"></div></div></td><td><div class="form-group row"><div class="col-sm-12"><input type="hidden" class="quantity'+counts+'" value="'+quantity+'" name="quantity[]"><font class="font_quantity'+counts+'" style="float:right;">'+quantity+'</font></div></div></td><td><div class="form-group row"><div class="col-sm-12"><input type="hidden" class="uom'+counts+'" value="'+uom_id+'" name="uom[]"><font class="font_uom'+counts+'">'+uom_name+'</font></div></div></td><td><div class="form-group row"><div class="col-sm-12"><input type="hidden" class="table_amount" id="amnt'+counts+'" value="'+amount+'" name="amount[]"><font class="font_amount'+counts+'" style="float:right;">'+amount+'</font></div></div></td><td><div class="form-group row"><div class="col-sm-12"><input type="hidden" class="input_discounts '+counts+'" value="'+discounts+'" id="input_discount'+counts+'" ><input class="discount_val'+counts+'" type="hidden" value="'+discounts+'" name="discount[]"><font class="font_discount" id="font_discount'+counts+'" style="float:right;">'+discounts+'</font></div></div></td><td><div class="form-group row"><div class="col-sm-12"><input type="hidden" class="overall_disc" id="overall_disc'+counts+'" value="0" name="overall_disc[]"><font class="font_overall_disc'+counts+'">0</font></div></div></td><td><div class="form-group row"><div class="col-sm-12"><input type="hidden" class="expenses '+counts+'" id="expenses'+counts+'" value="0" name="expenses[]"><font class="font_expenses'+counts+'">0</font></div></div></td><td><div class="form-group row"><div class="col-sm-12"><input type="hidden" class="table_gst" id="tax'+counts+'" value="'+gst+'" name="gst[]"><input type="hidden" class="tax_gst'+counts+'"  value="'+tax_rate+'" name="tax_rate[]"><font class="font_gst'+counts+'" style="float:right;">'+gst+'</font></div></div></td><td><div class="form-group row"><div class="col-sm-12"><input type="hidden" class="table_net_price" id="net_price'+counts+'" value="'+net_price+'" name="net_price[]"><input type="hidden" class="black_or_white'+counts+'"  value="'+black_or_white+'" name="black_or_white[]"><font class="font_net_price'+counts+'" style="float:right;">'+net_price+'</font></div></div></td><td style="background-color: #FAF860;"><div class="form-group row"><div class="col-sm-12"><center><font class="last_purchase'+counts+'" style="float:right;">'+last_purchase_rate+'</font></center></div></div></td><td><i class="fa fa-eye px-2 py-1 bg-info rounded show_items" id="'+counts+'" aria-hidden="true"></i><i class="fa fa-pencil px-2 py-1 bg-success rounded edit_items" id="'+counts+'" aria-hidden="true"></i><i class="fa fa-trash px-2 py-1 bg-danger rounded remove_items" id="'+counts+'" aria-hidden="true"></i></td></tr>';

      ...
      {{csrf_field()}}
       ...
       <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control code only_allow_alp_numeric required_for_valid" error-data="Enter valid Employee Code" placeholder="Employee Code" name="code" value="{{old('code')}}" <?php echo Mandatoryfields::validation('employee_code');?> tabindex="3">
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control only_allow_digit phone_no required_for_valid" input-type="phone_no" pattern="[1-9]{1}[0-9]{9}" error-data="Enter valid Phone No" placeholder="Phone No" name="phone_no" value="{{old('phone_no')}}" <?php echo Mandatoryfields::validation('employee_phoneno');?> tabindex="4">
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="email" class="form-control email required_for_valid" input-type="email" error_data="Enter valid Email" placeholder="Email" name="email" value="{{old('email')}}" <?php echo Mandatoryfields::validation('employee_email');?> tabindex="5">
...
if($(".remove_address").length >1){
    ...
    var address='';
      address+='<div class="form-row address_div">\
       <div class="col-md-7">\
              ...
              <div class="form-group row">\
                <label for="validationCustom01" class="col-sm-4 col-form-label">Address Type <?php echo Mandatoryfields::mandatory('employee_addresstypeid');?></label>\
                <div class="col-sm-6">\
                  <select class="js-example-basic-multiple col-12 form-control custom-select address_type_id required_for_address_valid" error-data="Enter valid Address Type" name="address_type_id[]" <?php echo Mandatoryfields::validation('employee_addresstypeid');?> tabindex="16">\
                    <option value="">Choose Address Type</option>\
                    @foreach($address_type as $value)\
      ...
      <div class="col-md-6">\
              <div class="form-group row">\
                <label for="validationCustom01" class="col-sm-4 col-form-label">Address Line 1 <?php echo Mandatoryfields::mandatory('employee_addressline1');?></label>\
                <div class="col-sm-8">\
                  <input type="text" class="form-control address_line_1 required_for_address_valid" error-data="Enter valid Address" placeholder="Address Line 1" name="address_line_1[]" value="" <?php echo Mandatoryfields::validation('employee_addressline1');?> tabindex="17">\
                 <div class="invalid-feedback">\
                  Enter valid Address\
                  </div>\
                </div>\
  ...
  <div class="col-md-6">\
              <div class="form-group row">\
                <label for="validationCustom01" class="col-sm-4 col-form-label">Address Line 2 <?php echo Mandatoryfields::mandatory('employee_addressline2');?></label>\
                <div class="col-sm-8">\
                  <input type="text" class="form-control address_line_2 required_for_address_valid" placeholder="Address Line 2" name="address_line_2[]" value="" <?php echo Mandatoryfields::validation('employee_addressline2');?> tabindex="18">\
                  <div class="invalid-feedback">\
                  Enter valid Address\
                  </div>\
                </div>\
    ...
    <div class="col-md-6">\
              <div class="form-group row">\
                <label for="land_mark" class="col-sm-4 col-form-label">Land Mark <?php echo Mandatoryfields::mandatory('employee_landmark');?></label>\
                <div class="col-sm-8">\
                  <input type="text" class="form-control required_for_address_valid land_mark" placeholder="Land Mark" name="land_mark[]" value="" <?php echo Mandatoryfields::validation('employee_landmark');?> tabindex="19">\
                 <div class="invalid-feedback">\
                  Enter valid Land Mark\
                  </div>\
                </div>\
  ...
  <div class="col-md-6">\
              <div class="form-group row">\
                <label for="validationCustom01" class="col-sm-4 col-form-label">State <?php echo Mandatoryfields::mandatory('employee_stateid');?></label>\
                <div class="col-sm-6">\
                  <select class="js-example-basic-multiple col-12 form-control required_for_address_valid custom-select state_id" error-data="Enter valid State" name="state_id[]" <?php echo Mandatoryfields::validation('employee_stateid');?> tabindex="20">\
                    <option value="">Choose State</option>\
                    @foreach($state as $value)\
                    <option value="{{ $value->id }}" >{{ $value->name }}</option>\
                    @endforeach\
  ...
  <div class="col-md-6">\
              <div class="form-group row">\
                <label for="validationCustom01" class="col-sm-4 col-form-label">District <?php echo Mandatoryfields::mandatory('employee_districtid');?></label>\
                <div class="col-sm-6">\
                  <select class="js-example-basic-multiple required_for_address_valid col-12 form-control custom-select district_id" name="district_id[]" <?php echo Mandatoryfields::validation('employee_districtid');?> tabindex="21">\
                    <option value="">Choose District</option>\
                   </select>\
                   <div class="invalid-feedback">\
                    Enter valid District\
             ...
             <div class="col-md-6">\
              <div class="form-group row">\
                <label for="validationCustom01" class="col-sm-4 col-form-label">City <?php echo Mandatoryfields::mandatory('employee_cityid');?></label>\
                <div class="col-sm-6">\
                  <select class="js-example-basic-multiple required_for_address_valid col-12 form-control custom-select city_id" name="city_id[]" <?php echo Mandatoryfields::validation('employee_cityid');?> tabindex="22">\
                    <option value="">Choose City</option>\
                  </select>\
                 <div class="invalid-feedback">\
                    Enter valid City\
   ...
   <div class="col-md-6">\
              <div class="form-group row">\
                <label for="land_mark" class="col-sm-4 col-form-label">Postal Code <?php echo Mandatoryfields::mandatory('employee_postalcode');?></label>\
                <div class="col-sm-8">\
                  <input type="text" class="form-control required_for_address_valid only_allow_digit postal_code  " error-data="Enter valid Postal Code" placeholder="Postal Code" name="postal_code[]" value="" <?php echo Mandatoryfields::validation('employee_postalcode');?> tabindex="23">\
                <div class="invalid-feedback">\
                    Enter valid Postal Code\
                  </div>\
                </div>\

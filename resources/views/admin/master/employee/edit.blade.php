    ...
    <div class="card-body">
      ...
      <div class="form-row">
        <div class="col-md-8">
         ...
         <div class="col-md-6">
           ...
           <input type="text" class="form-control  required_for_valid name caps" name="name" error-data="Employee Name Field is required" aria-label="Text input with dropdown button" value="{{old('name',$employee->name)}}" tabindex="2">
      ...
      <div class="col-md-6">
           <div class="form-group row">
             ...
             <div class="col-sm-8">
               <input type="text" class="form-control code  required_for_valid" error-data="Enter valid Employee Code" placeholder="Employee Code" name="code" value="{{old('code',$employee->code)}}" tabindex="3">
         ...
         <div class="col-md-6">
           <div class="form-group row">
             ...
             <div class="col-sm-8">
               <input type="text" class="form-control only_allow_digit phone_no required_for_valid" input-type="phone_no" pattern="[1-9]{1}[0-9]{9}" error-data="Enter valid Phone No" placeholder="Phone No" name="phone_no" value="{{old('phone_no',$employee->phone_no)}}" tabindex="4">
         ...
         <div class="col-md-6">
           <div class="form-group row">
             ...
             <div class="col-sm-8">
               <input type="email" class="form-control email required_for_valid" input-type="email" error_data="Enter valid Email" placeholder="Email" name="email" value="{{old('email',$employee->email)}}" tabindex="5">
         ...
         <div class="col-md-6">
           ...
           $dob="";
               if(old('dob'))
               {
                ...
                $dob=$employee->dob !="" ? date('d-m-Y',strtotime($employee->dob)) : "";
               }
           @endphp
           <div class="form-group row">
             <label for="validationCustom01" class="col-sm-4 col-form-label">DOB <span class="mandatory">*</span></label>
             <div class="col-sm-8">
               <input type="text" class="form-control dob required_for_valid" error-data="Enter valid DOB" placeholder="dd-mm-yyyy" name="dob" value="{{old('dob',$dob)}}" tabindex="6">
         ...
         <div class="col-md-6">
           <div class="form-group row">
            ...
            <select class="js-example-basic-multiple col-12 form-control custom-select department_id required_for_valid" 
             error-data="Enter valid Department" data-placeholder="Choose Department" name="department_id" tabindex="7">
...
<div class="form-row">
    <div class="col-md-8">
             ...
             <label for="validationCustom01" class=" col-form-label">Address details : </label>
                 <button type="button" for="validationCustom01" class="btn-sm btn-success add_address" tabindex="8">Add Address</button>  
             </div>
               </div>
    </div>
    <div class="common_address_div">
      ...
      <div class="form-row address_div">
          ...
          <div class="col-md-4">
          <h3 class="address_delete_label"><button type="button" class="btn btn-danger remove_address" attr-id="{{$values->id}}" tabindex="9"> Delete </button></h3>
              </div>
          </div>
          </div>
                    <div class="col-md-6">
                  ...
                  <label for="validationCustom01" class="col-sm-4 col-form-label">Address Type <span class="mandatory">*</span></label>
                    <div class="col-sm-6">
                    <select class="js-example-basic-multiple col-12 form-control custom-select old_address_type_id required_for_valid required_for_address_valid" error-data="Enter valid Address Type" name="old_address_type_id[]" required tabindex="10">
          ...
          <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                    <input type="text" class="form-control old_address_line_1 required_for_valid required_for_address_valid" error-data="Enter valid Address" placeholder="Address Line 1" name="old_address_line_1[]" value="{{ old('old_address_line_1.'.$key,$values->address_line_1) }}"  required tabindex="11">
      ...
      <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control old_address_line_2" placeholder="Address Line 2" name="old_address_line_2[]" value="{{ old('old_address_line_2.'.$key,$values->address_line_2) }}" tabindex="12">
        ...
        <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control land_mark" placeholder="Land Mark" name="old_land_mark[]" value="{{ old('old_land_mark.'.$key,$values->land_mark) }}" tabindex="13">
      ...
      <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <select class="js-example-basic-multiple col-12 form-control custom-select state_id old_state_id required_for_valid required_for_address_valid" error-data="Enter valid State" name="old_state_id[]" required tabindex="14">
      ...
      <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <select class="js-example-basic-multiple col-12 form-control custom-select district_id old_district_id" name="old_district_id[]" tabindex="15">
                 ...
                 <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <select class="js-example-basic-multiple col-12 form-control custom-select city_id old_city_id" name="old_city_id[]" tabindex="16">
       ...
       <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                    <input type="text" class="form-control only_allow_digit old_postal_code required_for_valid required_for_address_valid" error-data="Enter valid Postal Code" placeholder="Postal Code" name="old_postal_code[]" value="{{ old('old_postal_code.'.$key,$values->postal_code) }}" required tabindex="17">
      ...
      <div class="col-md-6">
              <div class="form-group row">
                <label for="validationCustom01" class="col-sm-4 col-form-label">Address Line 1 <span class="mandatory">*</span></label>
                <div class="col-sm-8">
                <input type="text" class="form-control address_line_1 required_for_valid required_for_address_valid" error-data="Enter valid Address" placeholder="Address Line 1" name="address_line_1[]" value="{{ old('address_line_1.'.$key) }}" required>
              ...
              <div class="col-md-12">
                <table class="table">
                  <thead>
                    ...
                    <th> Upload </th>
                    <th> Files </th>
                    <th>Action   <label class="btn btn-success add_proof_details">+</label></th>
                  </thead>
                  <tbody class="append_proof_details">
@foreach($employee_proof_details as $key=>$proof_value)
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="form-group row">
                          <div class="col-sm-12">
                          <input type="text" class="form-control old_proof_name  required_for_proof_valid" error-data="Enter valid Postal Code" placeholder="Proof Name" name="old_proof_name[]" value="{{ old('old_proof_name.'.$key,$proof_value->name) }}" tabindex="18">
                   ...
                   <td>
                            <div class="form-group row">
                              <div class="col-sm-12">
                              <input type="text" class="form-control old_proof_number only_allow_digit required_for_proof_valid" error-data="Enter valid Postal Code" placeholder="Proof Number" name="old_proof_number[]" value="{{ old('old_proof_number.'.$key,$proof_value->number) }}" tabindex="19">
                          ...
                          <td>
                              <div class="form-group row">
                                <div class="col-sm-12">
                                <input type="file" class="form-control old_proof_file only_allow_digit " error-data="Enter valid Postal Code" placeholder="Proof Name" name="old_proof_file[]" value="" tabindex="20">
...
var address='';
    address+='<div class="form-row address_div">\
        <div class="col-md-7">\
          ...
          <div class="col-md-4">\
          <h3 class="address_delete_label"><button type="button" class="btn btn-danger remove_new_address" tabindex="9"> Delete </button></h3>\
              </div>\
          </div>\
          </div>\
           <div class="col-md-6">\
            <div class="form-group row">\
              <label for="validationCustom01" class="col-sm-4 col-form-label">Address Type <span class="mandatory">*</span></label>\
              <div class="col-sm-6">\
                <select class="js-example-basic-multiple col-12 form-control custom-select address_type_id required_for_valid required_for_address_valid" error-data="Enter valid Address Type" name="address_type_id[]" tabindex="10">\
                  <option value="">Choose Address Type</option>\
                  @foreach($address_type as $value)\
    ...
    <div class="col-md-6">\
            <div class="form-group row">\
              <label for="validationCustom01" class="col-sm-4 col-form-label">Address Line 1 <span class="mandatory">*</span></label>\
              <div class="col-sm-8">\
                <input type="text" class="form-control address_line_1 required_for_valid required_for_address_valid" error-data="Enter valid Address" placeholder="Address Line 1" name="address_line_1[]" value="" tabindex="11">\
               <div class="invalid-feedback">\
                Enter valid Address\
                </div>\
              </div>\
...
<div class="col-md-6">\
            <div class="form-group row">\
              <label for="validationCustom01" class="col-sm-4 col-form-label">Address Line 2 </label>\
              <div class="col-sm-8">\
                <input type="text" class="form-control address_line_2" placeholder="Address Line 2" name="address_line_2[]" value="" tabindex="12">\
                <div class="invalid-feedback">\
                Enter valid Address\
                </div>\
              </div>\
  ...
  <div class="col-md-6">\
            <div class="form-group row">\
              <label for="land_mark" class="col-sm-4 col-form-label">Land Mark </label>\
              <div class="col-sm-8">\
                <input type="text" class="form-control land_mark" placeholder="Land Mark" name="land_mark[]" value="" tabindex="13">\
               <div class="invalid-feedback">\
                Enter valid Land Mark\
                </div>\
              </div>\
...
<div class="col-md-6">\
            <div class="form-group row">\
              <label for="validationCustom01" class="col-sm-4 col-form-label">State <span class="mandatory">*</span></label>\
              <div class="col-sm-6">\
                <select class="js-example-basic-multiple col-12 form-control custom-select state_id required_for_valid required_for_address_valid" error-data="Enter valid State" name="state_id[]" tabindex="14">\
                  <option value="">Choose State</option>\
                  @foreach($state as $value)\
                  <option value="{{ $value->id }}" >{{ $value->name }}</option>\
                  @endforeach\
...
<div class="col-md-6">\
            <div class="form-group row">\
              <label for="validationCustom01" class="col-sm-4 col-form-label">District </label>\
              <div class="col-sm-6">\
                <select class="js-example-basic-multiple col-12 form-control custom-select district_id" name="district_id[]" tabindex="15">\
                  <option value="">Choose District</option>\
                 </select>\
                 <div class="invalid-feedback">\
                  Enter valid District\
           ...
           <div class="col-md-6">\
            <div class="form-group row">\
              <label for="validationCustom01" class="col-sm-4 col-form-label">City </label>\
              <div class="col-sm-6">\
                <select class="js-example-basic-multiple col-12 form-control custom-select city_id" name="city_id[]" tabindex="16">\
                  <option value="">Choose City</option>\
                </select>\
               <div class="invalid-feedback">\
                  Enter valid City\
 ...
 <div class="col-md-6">\
            <div class="form-group row">\
              <label for="land_mark" class="col-sm-4 col-form-label">Postal Code <span class="mandatory">*</span></label>\
              <div class="col-sm-8">\
                <input type="text" class="form-control only_allow_digit postal_code required_for_valid required_for_address_valid" error-data="Enter valid Postal Code" placeholder="Postal Code" name="postal_code[]" value="" tabindex="17">\
              <div class="invalid-feedback">\
                  Enter valid Postal Code\
                </div>\
              </div>\
...
if($(".remove_address").length >1){
  ...
  if(confirm('Are You Sure Want to Delete this ?')){
    ...
    $.ajax({
                      type: "post",
                      url: "{{ url('master/employee/delete-employee-address-details')}}",

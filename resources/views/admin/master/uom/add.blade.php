        ...
        <div class="form-row">
          <div class="col-md-7">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control name only_allow_alp_num_dot_com_amp caps" placeholder="Name" name="name" value="{{old('name')}}" <?php echo Mandatoryfields::validation('uom_name');?> autofocus>
          ...
          <div class="col-md-7">
              <div class="form-group row">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control description only_allow_alp_num_dot_com_amp" placeholder="Description" name="description" value="{{old('description')}}" <?php echo Mandatoryfields::validation('uom_description');?>>
            ...
            <div class="col-md-7">
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control remark only_allow_alp_num_dot_com_amp" placeholder="Remark" name="remark" value="{{old('remark')}}" <?php echo Mandatoryfields::validation('uom_remark');?>>

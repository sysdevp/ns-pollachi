...
<div class="divTableCell">&nbsp;List</div>
...
<!-- DivTable.com -->
                 ...
                 <?php $class=""; ?>
                 <label class="w-20 heading"> Namess</label>
                 <label class="w-20 heading"> All</label> 
                 <label class="w-20 heading"> List</label> 
                 <label class="w-20 heading"> Create</label>
                 <label class="w-20 heading"> Edit</label>
                 <label class="w-20 heading"> Delete</label>

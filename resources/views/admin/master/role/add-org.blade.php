  ...
  @foreach($permission as $value)
    <tr>
      ...
      @if($class != $value->class)
              ...
              @endif 
      <td><input type="checkbox" name="permission[]" class="all_{{ $value->class }}_master all_classname permission"  value="{{$value->class}}"></td>
      <td scope="row"><input type="checkbox" name="permission[]" class="{{ $value->class }} permission"  value="{{$value->id}}"> </label></td>
      ...
      <td>@mdo</td>
                  ...
                  <label class="w-20">All</label>
                  <label class="w-20">List</label>
                  <label class="w-20">Create</label>
                  <label class="w-20">Edit</label>
                  <label class="w-20">Delete</label>
                  <label class="w-20">Multi Location</label>
                  <label class="w-20">Beta Entry</label>
                </div>
                <div class="row mx-0">
                @foreach($permission as $value)
                  <label class="w-20">{{$value->label}}</label>
                  @if($class != $value->class)
                  <label class="w-20"> 
                      <input type="checkbox" name="permission[]" class="all_{{ $value->class }}_master all_classname permission"  value="{{$value->class}}">  
              ...
              @endif 
              @endforeach
                  <label class="w-20"> <input type="checkbox" name="permission[]" class="{{ $value->class }} permission"  value="{{$value->id}}"> </label>
                  <label class="w-20">ss</label>

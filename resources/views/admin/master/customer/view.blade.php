...
<div class="col-12 body-sec">
  <div class="card">
      ...
      <div class="row">
        ...
        <div class="col-8 mr-auto">
          <ul class="h-right-btn mb-0 pl-0">
            <li><button type="button" class="btn"><a target="_blank" href="{{url('master/customer/import-data')}}"><i class="fa fa-plus"></i> Bulk Import</a></button></li>
    ...
    <!-- card header end@ -->
    <div class="card-body">
      <table id="master" class="table table-bordered table-hover Customer">
        <thead>
          <tr>
            <th>S.No</th>
            <th>Company Name</th>

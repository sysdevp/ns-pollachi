...
<div class="col-12 body-sec">
  <div class="card">
    ...
    <!-- card header end@ -->
    <div class="card-body">
    <form  method="post" class="form-horizontal needs-validation" action="{{url('master/item/bulk-item-store')}}" enctype="multipart/form-data">
      {{csrf_field()}}

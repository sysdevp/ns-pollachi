...
<div class="col-12 body-sec">
  <div class="card">
    ...
    <div class="card-header px-2">
      <div class="row">
        <div class="col-4">
          <h3>Add Multiple Repack Items</h3>
        </div>
    ...
    <!-- card header end@ -->
    <div class="card-body">
    <form  method="post" class="form-horizontal needs-validation" action="{{url('master/item/repack-item-store')}}" enctype="multipart/form-data">
      {{csrf_field()}}
        ...
        <tbody id="test1" class="append_row">
            <tr>
              ...
              <td><select class="js-example-basic-multiple col-12 form-control custom-select category_id" name="category_id[]">
                        ...
                        <td><select class="js-example-basic-multiple col-12 form-control custom-select bulk_item_id" name="bulk_item_id[]">

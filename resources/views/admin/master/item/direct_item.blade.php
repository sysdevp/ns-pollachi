...
<div class="col-12 body-sec">
  <div class="card">
    ...
    <div class="card-header px-2">
      <div class="row">
        <div class="col-4">
          <h3>Add Multiple Direct Items</h3>
        </div>
    ...
    <!-- card header end@ -->
    <div class="card-body">
    <form  method="post" class="form-horizontal needs-validation" action="{{url('master/item/direct-item-store')}}" enctype="multipart/form-data">
      {{csrf_field()}}

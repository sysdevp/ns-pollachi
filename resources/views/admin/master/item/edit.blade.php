      ...
      <div class="form-row">
        <div class="col-md-6">
          <div class="form-group row">
            ...
            <div class="col-sm-8">
              <input type="text" class="form-control name only_allow_alp_num_dot_com_amp caps" placeholder="Item Name" name="name" value="{{old('name',$item->name)}}" <?php echo Mandatoryfields::validation('item_name');?> autofocus>
        ...
        <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control code only_allow_alp_num_dot_com_amp" placeholder="Item Code" name="code" value="{{old('code',$item->code)}}" <?php echo Mandatoryfields::validation('item_code');?>>
              ...
              <a href="{{ url('master/brand/create')}}" target="_blank">
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control weight_in_grams only_allow_digit_and_dot" placeholder="Weight In Grams " name="weight_in_grams" value="{{old('weight_in_grams',$item->weight_in_grams)}}" <?php echo Mandatoryfields::validation('item_weightingrams');?>>
                ...
                <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control print_name_in_english only_allow_alp_num_dot_com_amp" placeholder="Print Name in English " name="print_name_in_english" value="{{old('print_name_in_english',$item->print_name_in_english)}}" <?php echo Mandatoryfields::validation('item_printnameinenglish');?>>
                  ...
                  <div class="col-md-6">
                      ...
                      <label for="validationCustom01" class="col-sm-4 col-form-label">Print Name in {{$language_1}}<?php echo Mandatoryfields::mandatory('item_printnameinlanguage1');?></label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control print_name_in_language_1 only_allow_alp_num_dot_com_amp" placeholder="Print Name in {{ $language_1 }}" name="print_name_in_language_1" value="{{old('print_name_in_language_1',$item->print_name_in_language_1)}}" <?php echo Mandatoryfields::validation('item_printnameinlanguage1');?>>
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control print_name_in_language_2 only_allow_alp_num_dot_com_amp" placeholder="Print Name in {{ $language_2 }}" name="print_name_in_language_2" value="{{old('print_name_in_language_2',$item->print_name_in_language_2)}}" <?php echo Mandatoryfields::validation('item_printnameinlanguage2');?>>
                      ...
                      <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                              <input type="text" class="form-control print_name_in_language_3 only_allow_alp_num_dot_com_amp" placeholder="Print Name in {{ $language_3 }}" name="print_name_in_language_3" value="{{old('print_name_in_language_3',$item->print_name_in_language_3)}}" <?php echo Mandatoryfields::validation('item_printnameinlanguage3');?>>
                        ...
                        <!-- <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                              <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                  <input type="text" class="form-control hsn only_allow_alp_num_dot_com_amp" placeholder="Hsn Code" name="hsn" value="{{old('hsn',$item->hsn)}}" <?php echo Mandatoryfields::validation('item_hsn');?>>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                  ...
                                  <div class="col-sm-8">
                                    <input type="text" class="form-control only_allow_digit_and_dot mrp only_allow_alp_num_dot_com_amp" placeholder="MRP" name="mrp" value="{{old('mrp',$item->mrp)}}" <?php echo Mandatoryfields::validation('item_mrp');?>>
                              ...
                              <div class="col-md-6">
                                  <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                      <input type="text" class="form-control only_allow_digit_and_dot default_selling_price only_allow_alp_num_dot_com_amp" placeholder="Default Selling Price" name="default_selling_price" value="{{old('default_selling_price',$item->default_selling_price)}}" <?php echo Mandatoryfields::validation('item_defaultsellingprice');?>>
              ...
              <div class="col-md-2 mb-3">
                  ...
                  <div class="col-md-2">
                     <label for="validationCustom01" class="">Opening Quantity</label>
                       <input type="number" id="quantity" placeholder="Opening Quantity" name="quantity[]" value="{{ @$opening_data[$k][0]['opening_qty'] }}" class="form-control quantity" >
...
/*Current Date*/   
   ...
   <div class="col-md-2">\
                  ...
                  <!-- <div class="form-group row"> -->\
                     <label for="validationCustom01" class="">Opening Quantity</label>\
                     <!-- <div class="col-sm-8"> -->\
                       <input type="text" placeholder="Opening Quantity" name="quantity[]" value="0" class="form-control quantity" >\
                     <!-- </div> -->\
                     <span class="mandatory"> </span>\
                     <div class="invalid-feedback">\
                           Enter valid Quantity\

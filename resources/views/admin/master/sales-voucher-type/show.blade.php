      ...
      <div class="cat" id="cat" style="display: none;" title="Voucher Number Preview">
          ...
          <div class="col-md-6">
            <div class="form-group row">
              <label for="validationCustom01" class="col-sm-6 col-form-label"><b>Sales Voucher Name</b> : {{ $voucher_data->name }}</label>
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="hidden" class="form-control type caps" placeholder="Type" required="" name="type" value="{{ $voucher_data->type }}">

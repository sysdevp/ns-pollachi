      ...
      <div class="form-row">
          ...
          <div class="col-md-6">
              <div class="form-group row">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control only_allow_alp_num_dot_com_amp company_name required_for_valid" error-data="Enter valid Company Name" placeholder="Company Name" name="company_name" value="{{old('company_name',$supplier->company_name)}}" autofocus>
        ...
        <!--  <div class="col-md-6">
            ...
            <input type="text" class="form-control only_allow_alp_num_dot_com_amp name" name="name" error-data="Supplier Name Field is required" aria-label="Text input with dropdown button" value={{old('name',$supplier->name)}}>
              ...
              <div class="col-sm-8">
                <div class="form-check d-inline">
                  <label class="form-check-label">
                    <input type="radio" class="form-check-input supplier_type" value="1" {{ old('supplier_type',$supplier->supplier_type) == 1 ? 'checked' : '' }} name="supplier_type">Exist
                  </label>
                </div>

                <div class="form-check d-inline mx-4 ">
                  <label class="form-check-label">
                    <input type="radio" class="form-check-input supplier_type" value="0" {{ old('supplier_type',$supplier->supplier_type) == 0 ? 'checked' : '' }} name="supplier_type">New
                  </label>
                </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control only_allow_alp_num_dot_com_amp name" name="name" error-data="Customer Name Field is required" onchange="checkname()" aria-label="Text input with dropdown button" value={{old('name',$supplier->name)}}>
...
@foreach ($exist_supplier_dets as $value)
                <option value="{{ $value->id }}" {{ old('exist_supplier_name',$supplier->supplier_id) == $value->id ? 'selected' : '' }} >{{ $value->name }}</option>
@endforeach
     </select>

      ...
      <div class="form-row">
          ...
          <div class="col-md-6">
              <div class="form-group row">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control only_allow_alp_num_dot_com_amp company_name required_for_valid" error-data="Enter valid Company Name" placeholder="Company Name" name="company_name" value="{{old('company_name',$supplier->company_name)}}" >

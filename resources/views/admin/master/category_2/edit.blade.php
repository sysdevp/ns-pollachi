...
<div class="col-12 body-sec">
  <div class="card container px-0">
    ...
    <div class="card-body">
      ...
      <form  method="post" class="form-horizontal needs-validation" novalidate action="{{url('master/category-two/update/'.$category_two->id)}}" enctype="multipart/form-data">
      {{csrf_field()}}
        ...
        <div class="form-row">
            ...
            <div class="col-md-7">
                ...
                <label for="validationCustom01" class="col-sm-4 col-form-label">Category 1 <span class="mandatory">*</span></label>
                  ...
                  <select class="js-example-basic-multiple col-12 form-control custom-select category_one_id required_for_valid" error-data="Enter valid Category 1" name="category_one_id" required>
                      ...
                      <option value="{{ $value->id }}" {{ old('category_one_id',$category_two->category_one_id) == $value->id ? 'selected' : '' }} >{{ $value->name }}</option>
                      @endforeach
                    </select>
            ...
            <div class="col-md-7">
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control name only_allow_alp_num_dot_com_amp caps" placeholder="Name" name="name" value="{{old('name',$category_two->name)}}" required>
                ...
                <div class="col-md-7">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control remark only_allow_alp_num_dot_com_amp" placeholder="Remark" name="remark" value="{{old('remark',$category_two->remark)}}">

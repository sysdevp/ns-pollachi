      ...
      <div class="form-row">
           <div class="col-md-8">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control name only_allow_alp_num_dot_com_amp branch caps" placeholder="Branch Name" name="branch" value="{{old('branch',$bank_branch->branch)}}" <?php echo Mandatoryfields::validation('bankbranch_branch');?> tabindex="1" autofocus>
           ...
           <div class="col-md-8">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control only_allow_alp_numeric  ifsc" placeholder="IFSC Code" name="ifsc" value="{{old('ifsc',$bank_branch->ifsc)}}" <?php echo Mandatoryfields::validation('bankbranch_ifsc');?> tabindex="3">

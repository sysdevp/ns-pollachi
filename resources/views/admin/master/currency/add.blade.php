...
<div class="col-12 body-sec">
  <div class="card container px-0">
    ...
    <div class="card-body">
      ...
      <form  method="post" class="form-horizontal needs-validation" novalidate action="{{route('currency.store')}}" enctype="multipart/form-data">
      {{csrf_field()}}
        ...
        <div class="form-row">
          <div class="col-md-7">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="number" class="form-control amount only_allow_alp_num_dot_com_amp caps" placeholder="Amount" name="amount" value="{{old('amount')}}" <?php echo Mandatoryfields::validation('bank_name');?> tabindex="1" autofocus>
          ...
          <div class="col-md-7">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control remark only_allow_alp_num_dot_com_amp" placeholder="Remark" name="remark" value="{{old('remark')}}"  <?php echo Mandatoryfields::validation('bank_code');?> tabindex="2">

        ...
        <div class="form-row">
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control only_allow_digit value" placeholder="Quantity" name="get_item_quantity" value="{{ $itemwise_offers->buy_item_quantity }}" <?php echo Mandatoryfields::validation('itemwiseoffer_getitemid');?> tabindex="8">
                <span class="mandatory"> {{ $errors->first('value')  }} </span>
                <div class="invalid-feedback">
                  Enter valid Gift Voucher Quantity
                </div>

...
<div class="col-12 body-sec">
  <div class="card container px-0">
    ...
    <div class="card-header px-2">
      <div class="row">
        <div class="col-4">
          <h3>Bulk Import Banks</h3>
        </div>
        <div class="col-8 mr-auto">
          <ul class="h-right-btn mb-0 pl-0">
            <li><button type="button" class="btn btn-success"><a href="{{ asset('/storage/demofiles/banks.csv') }}">Download Templates</a></button></li>
          </ul>
        </div>
    ...
    <div class="card-body">
      ...
      <form  method="post" class="form-horizontal needs-validation" novalidate action="{{url('master/bank/store-import-data')}}" enctype="multipart/form-data">
      {{csrf_field()}}

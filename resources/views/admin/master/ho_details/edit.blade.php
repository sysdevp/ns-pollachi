      ...
      <div class="form-row">
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control name only_allow_alp_num_dot_com_amp" placeholder="Location Name" name="name" value="{{old('name',$location->name)}}" required>
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control gst_number" style="text-transform: uppercase;" placeholder="GST Number" name="gst_number" value="{{old('name',$location->gst_number)}}" maxlength="15" required>
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control address_line_1 caps" placeholder="Address Line 1" name="address_line_1" value="{{old('address_line_1',$location->address_line_1)}}" required>
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control address_line_2 caps" placeholder="Address Line 2" name="address_line_2" value="{{old('address_line_2',$location->address_line_2)}}">
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control land_mark caps" placeholder="Land Mark" name="land_mark" value="{{old('land_mark',$location->land_mark)}}">
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control only_allow_digit postal_code" maxlength="6" placeholder="Postal Code" name="postal_code" value="{{old('postal_code',$location->postal_code)}}" required>

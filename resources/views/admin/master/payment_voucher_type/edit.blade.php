...
<div class="col-12 body-sec">
  <div class="card container px-0">
    ...
    <div class="card-header px-2">
      <div class="row">
        <div class="col-4">
          <h3>Edit Payment Voucher Type</h3>
        </div>
      ...
      <div class="cat" id="cat" style="display: none;" title="Voucher Number Preview">
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control type caps" placeholder="Type" <?php echo Mandatoryfields::validation('paymentvoucher_type');?> name="type" value="{{ $voucher_data->type }}">
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control prefix" placeholder="Prefix" name="prefix" value="{{ $voucher_data->prefix }}" <?php echo Mandatoryfields::validation('paymentvoucher_prefix');?>> 
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control suffix" placeholder="Suffix" name="suffix" value="{{ $voucher_data->suffix }}" <?php echo Mandatoryfields::validation('paymentvoucher_suffix');?>>
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control starting" placeholder="Starting No" name="starting" value="{{ $voucher_data->starting_no }}" <?php echo Mandatoryfields::validation('paymentvoucher_starting');?>>
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control digits" placeholder="No Of Digits" name="digits" value="{{ $voucher_data->no_digits }}" <?php echo Mandatoryfields::validation('paymentvoucher_digits');?>>

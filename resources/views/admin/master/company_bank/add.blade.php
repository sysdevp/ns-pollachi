        ...
        <div class="form-row">
          ...
          <div class="col-md-8">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control  only_allow_alp_numeric  holder_name caps" placeholder="Account Holder Name" name="holder_name" value="{{old('ifsc')}}" required>
          ...
          <div class="col-md-8">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control  only_allow_alp_numeric  account_no" placeholder="Account No" name="account_no" value="{{old('ifsc')}}" required>

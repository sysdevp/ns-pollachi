...
<div class="col-12 body-sec">
  <div class="card container px-0">
    ...
    <div class="card-body">
      ...
      <form  method="post" class="form-horizontal needs-validation" novalidate action="{{route('sales_man.store')}}" enctype="multipart/form-data">
      {{csrf_field()}}
        ...
        <div class="form-row">
          <div class="col-md-7">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control name" placeholder="Sales Men Name" name="name" value="{{old('name')}}" required>
          ...
          <div class="col-md-7">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control code only_allow_alp_num_dot_com_amp" placeholder="Employee Code" name="code" value="{{old('code')}}" >
          ...
          <div class="col-md-7">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <textarea class="form-control address" placeholder="Address" name="address" value="{{old('address')}}" style="height: 100px;"></textarea>
          ...
          <div class="col-md-7">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control phone_no" placeholder="Phone Number" name="phone_no" value="{{old('phone_no')}}" pattern="[1-9]{1}[0-9]{9}" required>
          ...
          <div class="col-md-7">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="email" class="form-control email" placeholder="Email Id" name="email" value="{{old('email')}}">

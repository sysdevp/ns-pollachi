...
<div class="col-12 body-sec">
  <div class="card container px-0">
    ...
    <div class="card-body">
      ...
      <form  method="post" class="form-horizontal needs-validation" action="{{route('terms-and-condition.store')}}" enctype="multipart/form-data">
      {{csrf_field()}}
        ...
        <div class="col-md-6">
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control" placeholder="Terms" required="" name="terms" value="">
              </div>
            </div>
          </div>

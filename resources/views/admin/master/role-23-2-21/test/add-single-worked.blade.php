		  ...
		  <div class="col-md-12">
			...
			<div class="subparent">
                    ...
                    <div class="card-header locationbg">
                       ...
                       <input type="checkbox" name="checkAll1" id="offers"> Offers
                   </div>
...
// Master Menu check fn
    $(".masters_head").click(function () {
            if ($(".masters_head").is(':checked'))
            {
...
// master submenus
        ...
        $("#location_head").click(function () {
            if ($("#location_head").is(':checked'))
            {

            $("#collapselocation input[type=checkbox]").each(function () {
                $(this).prop("checked", true);
            });
        }
         else {
        ...
        //bank
        $("#bank_head").click(function () {
            if ($("#bank_head").is(':checked'))
            {

            $("#collapsebank input[type=checkbox]").each(function () {
                $(this).prop("checked", true);
            });
        }
         else {
...
$("#employee_head").click(function () {
            if ($("#employee_head").is(':checked'))
            {

            $("#collapseEmployee input[type=checkbox]").each(function () {
                $(this).prop("checked", true);
            });
        }
         else {
...
$("#user_head").click(function () {
            if ($("#user_head").is(':checked'))
            {

            $("#collapseUser input[type=checkbox]").each(function () {
                $(this).prop("checked", true);
            });
        }
         else {
        ...
        $("#offers").click(function () {
            ...
            $("#collapseOffers input[type=checkbox]").each(function () {
                $(this).prop("checked", true);
            });
        }
         else {
...
$("#category_head").click(function () {
            if ($("#category_head").is(':checked'))
            {

            $("#collapseCategory input[type=checkbox]").each(function () {
                $(this).prop("checked", true);
            });
        }
         else {

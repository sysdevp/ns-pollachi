...
<div class="col-12 body-sec">
  <div class="card container px-0">
    ...
    <div class="card-body">
      ...
      <form  method="post" class="form-horizontal needs-validation" novalidate action="{{route('po-sales.store')}}" enctype="multipart/form-data">
      {{csrf_field()}}
        ...
        <div class="form-row">
          ...
          <div class="col-md-7">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="number" class="form-control name only_allow_alp_num_dot_com_amp pos_number" placeholder="POS Number" name="pos_number" value="{{old('name')}}" <?php echo Mandatoryfields::validation('bank_name');?> tabindex="1" autofocus>
          ...
          <div class="col-md-7">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control name only_allow_alp_num_dot_com_amp pos_name" placeholder="POS Name" name="pos_name" value="{{old('name')}}" <?php echo Mandatoryfields::validation('bank_name');?> tabindex="1" autofocus>
                <span class="mandatory"> {{ $errors->first('name')  }} </span>
                <div class="invalid-feedback">
                  Enter valid Bank Name
                </div>

...
<div class="col-12 body-sec">
  <div class="card container px-0">
    ...
    <div class="card-body">
      ...
      <form  method="post" class="form-horizontal needs-validation" action="{{route('purchase-voucher-type.store')}}" enctype="multipart/form-data">
      {{csrf_field()}}
      ...
      <div class="cat" id="cat" style="display: none;" title="Voucher Number Preview">
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control type caps" placeholder="Type" <?php echo Mandatoryfields::validation('purchasevoucher_type');?> name="type" value="">
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control prefix" placeholder="Prefix" name="prefix" <?php echo Mandatoryfields::validation('purchasevoucher_prefix');?>>
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control suffix" placeholder="Suffix" name="suffix" <?php echo Mandatoryfields::validation('purchasevoucher_suffix');?>>
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control starting" placeholder="Starting No" name="starting"<?php echo Mandatoryfields::validation('purchasevoucher_starting');?>>
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control digits" placeholder="No Of Digits" name="digits" <?php echo Mandatoryfields::validation('purchasevoucher_digits');?>>

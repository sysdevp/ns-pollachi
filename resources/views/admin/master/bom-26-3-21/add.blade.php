        ...
        <div class="col-md-2">
          ...
          <input type="hidden" class="form-control items_codes  required_for_proof_valid" placeholder="Item Code" id="items_codes" name="items_codes" value="">
                    ...
                    <div class="col-md-2">
                      ...
                      <input type="number" class="form-control min_qty required_for_proof_valid"  placeholder="Min Qty" id="min_qty" name="min_qty" value="">

                      <input type="hidden" class="form-control min_qty  required_for_proof_valid"  placeholder="Min Qty" id="uom_id" name="min_qty" value="">
                       
                      </div>
                      <div class="col-md-2">
                      <label style="font-family: Times new roman;">Max Qty</label>
                      <input type="number" class="form-control max_qty required_for_proof_valid"  placeholder="Max Qty" id="max_qty" name="max_qty" value="">

                      <input type="hidden" class="form-control max_qty  required_for_proof_valid"  placeholder="Max Qty" id="max_qty" name="max_qty" value="">

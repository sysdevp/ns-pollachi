      ...
      @method('PATCH')
        <div class="form-row">
          <div class="col-md-6">
                  <div class="form-group row">
                    <label for="validationCustom01" class="col-sm-4 col-form-label">Party Name <?php echo Mandatoryfields::mandatory('advancefromcustomer_customerid');?>:</label>
                     <div class="col-sm-6">
        ...
        <div class="row col-md-12 append_expense">
                          ...
                          <div class="row col-md-12 expense">
                            <div class="col-md-3">
                    <label style="font-family: Times new roman;">Payment Voucher No<?php echo Mandatoryfields::mandatory('advancefromcustomer_voucher_no');?></label><br>
                  <div class="form-group row">
                     <input type="text" class="form-control voucher_no" id="voucher_no"  placeholder="Payment Voucher No" name="voucher_no" step="any"  value="{{$advance->voucher_no}}" <?php echo Mandatoryfields::validation('advancefromcustomer_voucher_no');?>>
                     
                  </div>
               </div>
                      <div class="col-md-3">
                        <label style="font-family: Times new roman;">Date<?php echo Mandatoryfields::mandatory('advancefromcustomer_date');?></label>
                      <input type="date" class="form-control date" id="date"  placeholder="" name="receipt_date" step="any" value="{{$advance->receipt_date}}" <?php echo Mandatoryfields::validation('advancefromcustomer_date');?>> 
        ...
        <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control request_no" placeholder="Total Advance Amount" name="advance_amount" value="{{$advance->advance_amount}}" <?php echo Mandatoryfields::validation('advancefromcustomer_advanceamount');?>>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control remark" placeholder="Remarks" name="remark" value="{{$advance->remarks}}" <?php echo Mandatoryfields::validation('advancefromcustomer_remark');?>>
              </div>
            </div>
          </div>
        </div>

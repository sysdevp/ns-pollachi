...
<form  method="post" class="form-horizontal" action="{{ route('rejection_in.store') }}" id="dataInput" enctype="multipart/form-data">
      {{csrf_field()}}
                      ...
                      <div class="row col-md-12">
                          ...
                          <div class="col-md-4">
                  <label style="font-family: Times new roman;">Voucher Type<?php echo Mandatoryfields::mandatory('rejectionin_vouchertype');?></label><br>
                  <div class="form-group row">
                     <div class="col-sm-8">
                      <select class="js-example-basic-multiple col-12 form-control custom-select voucher_type" onchange="voucher_types()" name="voucher_type" id="voucher_type" <?php echo Mandatoryfields::validation('rejectionin_vouchertype');?> autofocus>  
                       ...
                       <div class="row col-md-12 mb-3">
                        ...
                        <div class="col-md-2">
                                ...
                                <div class="col-md-2">
                                  <label style="font-family: Times new roman;">Voucher Date<?php echo Mandatoryfields::mandatory('rejectionin_voucherdate');?></label><br>
                                <input type="date" class="form-control voucher_date  required_for_proof_valid" id="voucher_date" placeholder="Voucher Date" name="voucher_date" value="{{ $date }}" <?php echo Mandatoryfields::validation('rejectionin_voucherdate');?>>
                                 
                                </div>

                        <div class="col-md-3">
                  <label style="font-family: Times new roman;">Customer Name<?php echo Mandatoryfields::mandatory('rejectionin_customerid');?></label><br>
                  <div class="form-group row">
                     <div class="col-sm-8">
                      <select class="js-example-basic-multiple col-12 form-control custom-select customer_id" onchange="customer_details()" name="customer_id" id="customer_id" <?php echo Mandatoryfields::validation('rejectionin_customerid');?>>
               ...
               <div class="col-md-3">
                  <label style="font-family: Times new roman;">Sales Men Name<?php echo Mandatoryfields::mandatory('rejectionin_salesmenid');?></label><br>
                  <div class="form-group row">
                     <div class="col-sm-8">
                      <select class="js-example-basic-multiple col-12 form-control custom-select salesmen_id" name="salesmen_id" id="salesmen_id" <?php echo Mandatoryfields::validation('rejectionin_salesmenid');?>>
                     ...
                     <button type="button"  class="px-2 btn btn-success mx-2 refresh_salesmen_id" title="Add Sales Men"><i class="fa fa-refresh" aria-hidden="true"></i></button>
                        ...
                        <div class="col-md-2">
                                ...
                                <div class="col-md-2">
                                  <label style="font-family: Times new roman;">Company Location<?php echo Mandatoryfields::mandatory('rejectionin_location');?></label><br>
                                <select class="js-example-basic-multiple form-control location" 
                                data-placeholder="Choose Location" id="location" name="location" <?php echo Mandatoryfields::validation('rejectionin_location');?>>
                                <option></option>
                ...
                <table class="table table-responsive" id="team-list">
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <div class="col-md-2">
                        <label style="font-family: Times new roman;">Overall Discount<?php echo Mandatoryfields::mandatory('rejectionin_overall_discount');?></label>
                      <input type="number" class="form-control overall_discount" id="overall_discount" name="overall_discount" oninput="overall_discounts()" pattern="[0-9]{0,100}" title="Numbers Only" value="0" <?php echo Mandatoryfields::validation('rejectionin_overall_discount');?>>
                      </div>
                    </div>
...
var voucher_type = $('.voucher_type').val();
  ...
  $.ajax({
                type: "POST",
                url: "{{ url('rejection_in/voucher_type/') }}",
...
$.ajax({
           type: "POST",
            url: "{{ url('rejection_in/po_alpha_beta/') }}",
            data: { id: val },
           success: function(data) {
...
function browse_item()
{
  ...
  $.ajax({  
        ...
        type: "GET",
        url: "{{ url('rejection_in/browse_item/{id}') }}",
...
function delivery_details()
{
  ...
  $.ajax({
           type: "POST",
            url: "{{ url('rejection_in/delivery_details/') }}",
            data: { d_no : d_no, alpha_beta :alpha_beta },
           success: function(data) {
            if(data == 1)
            {
              alert('There Is Data In Sales Entry');
              $('.d_no').val('');
              $('.d_date').val('');
              $('select').select2();
            }

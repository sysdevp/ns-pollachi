  ...
  <div class="card container px-0">
    ...
    <div class="card-body">
      <div class="row col-md-12">
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> {{ $estimation->estimation_no }}</label>
          </div>
              </div>
          ...
          <div class="col-md-6">
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> {{ $estimation->estimation_date }}</label>
          </div>
              </div>
            </div>
...
<div class="form-row">
          ...
          <div class="col-md-6">
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> {{ $estimation->overall_discount }}</label>
          </div>
              </div>
            </div>
        ...
        <table class="table table-bordered table-responsive" style="width: 100%; height: 100%;">
          <thead>
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> {{ $estimation->round_off }}</label>
          </div>
              </div>
          ...
          <div class="col-md-6">
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> {{$estimation->total_net_value}}</label>
          </div>
              </div>
            </div>

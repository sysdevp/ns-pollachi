      ...
      <div class="row">
        ...
        <div class="col-8 mr-auto">
          <ul class="h-right-btn mb-0 pl-0">
            <li><button type="button" class="btn btn-success"><a href="{{ url('estimation/index/0') }}">Back</a></button></li>
          </ul>
        </div>
      </div>
    </div>
                  ...
                  <div class="form-group row">
                    ...
                    @endif
                       ...
                       <div class="col-md-12" style="float: right;">
                        ...
                        <font color="black" style="font-size: 150%; margin-left: 700px; font-weight: 900;">NET Value :</font>&nbsp;<font class="total_net_value" style="font-size: 150%; font-weight: 900;">{{$estimation->total_net_value}}</font> 
                       </div>
                    <!-- net value -->
...
$(document).on("click",".remove_items",function(){
    ...
    $.ajax({
           type: "GET",
            url: "{{ url('estimation/remove_data/{id}') }}",
...
function browse_item()
{
  ...
  $.ajax({  
        ...
        type: "GET",
        url: "{{ url('estimation/browse_item/{id}') }}",

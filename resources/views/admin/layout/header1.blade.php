...
<div class="page-wrapper chiller-theme toggled">
  ...
  <nav class="acnav" role="navigation">
    ...
    <div class="acnav__label">
         ...
         Masters     <i class="fa fa-database fonticonright" aria-hidden="true"></i> 
                ...
                <ul class="acnav__list acnav__list--level2">  
                  ...
                  <li class="has-children">
                    ...
                    <li class="has-children">
                      ...
                      <li class="has-children">
                          ...
                          @can('supplier_list')
                            ...
                            <li><a class="acnav__link acnav__link--level3" href="{{route('margin-setup.index')}}">Margin Set Up<i class="fas fa-percentage fonticonright sublisticon" aria-hidden="true"></i></a></li>
                    ...
                    <li class="has-children">
                          <div class="acnav__label acnav__label--level2">Currency<i class="fa fa-file-text-o fonticonright" aria-hidden="true"></i></div>
                          <ul class="acnav__list acnav__list--level3">
                            
                          <li><a class="acnav__link acnav__link--level3" href="{{route('currency.index')}}">Currency<i class="fa fa-file-text-o fonticonright sublisticon" aria-hidden="true"></i></a></li>
              
                          </ul>
                    </li>

                    <li class="has-children">
                          <div class="acnav__label acnav__label--level2">PO Sales<i class="fa fa-file-text-o fonticonright" aria-hidden="true"></i></div>
                          <ul class="acnav__list acnav__list--level3">
                            
                          <li><a class="acnav__link acnav__link--level3" href="{{route('po-sales.index')}}">PO Sales<i class="fa fa-file-text-o fonticonright sublisticon" aria-hidden="true"></i></a></li>
      ...
      <li class="has-children"><div class="acnav__label"> Target <i class="fa fa-pencil fonticonright" aria-hidden="true"></i></div> 
        
        <ul class="acnav__list acnav__list--level3">
          
        <li><a class="acnav__link acnav__link--level3" href="{{route('salesman-target-details.index')}}">Assign Target To Sales Man<i class="fa fa-pencil fonticonright sublisticon" aria-hidden="true"></i></a></li>
  </ul> 
          ...
          <ul class="acnav__list acnav__list--level2">  
                  ...
                  <!-- <li class="has-children">
                    ...
                    <ul class="acnav__list acnav__list--level2">  
                      <!--1st Add sub menu--> 
                  <li class="has-children">
                          <div class="acnav__label acnav__label--level2">Sales Men Report<i class="fa fa-percent fonticonright" aria-hidden="true"></i></div>
                          <ul class="acnav__list acnav__list--level3">
                          <li><a class="acnav__link acnav__link--level3" href="{{ route('salesman_report.index') }}">Sales Men Report<i class="fa fa-percent fonticonright sublisticon" aria-hidden="true"></i></a></li>
                            </ul>
                    </li>
                    </ul>
      ...
      <li class="has-children"><div class="acnav__label">    Settings  <i class="fa fa-cog fonticonright" aria-hidden="true"></i></div> 
        ...
        <li class="has-children">
                          <div class="acnav__label acnav__label--level2">Vendor Margin<i class="fa fa-cog fonticonright" aria-hidden="true"></i></div>
                          <ul class="acnav__list acnav__list--level3">
                          <li><a class="acnav__link acnav__link--level3" href="{{ route('vendor-margin.index') }}">Vendor Margin Setup<i class="fa fa-cog fonticonright sublisticon" aria-hidden="true"></i></a></li>
                  ...
                  <li class="has-children">
                    ...
                    <!-- <li class="has-children">
                          <div class="acnav__label acnav__label--level2"></div>
                          <ul class="acnav__list acnav__list--level3">
                          <li><a class="acnav__link acnav__link--level3" href="{{ route('upload-logo.index') }}"></a></li>
      ...
      <li class="has-children"><div class="acnav__label">  POS    <i class="fa fa-stack-exchange fonticonright" aria-hidden="true"></i></div> 
        ...
        <ul class="acnav__list acnav__list--level2">  
                  ...
                  <li class="has-children">
                          ...
                          <li><a class="acnav__link acnav__link--level3" href="{{ route('pos-cash-report.index') }}">POS Cash Report<i class="fa fa-stack-exchange fonticonright sublisticon" aria-hidden="true"></i></a></li>

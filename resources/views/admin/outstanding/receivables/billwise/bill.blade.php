      ...
      <div class="row">
        ...
        <div class="col-8 mr-auto">
          <ul class="h-right-btn mb-0 pl-0">
            <li><button type="button" class="btn btn-success"><a href="{{route('receivable_billwise.index')}}">Back</a></button></li>
          </ul>
        </div>
      </div>
    </div>
...
#receivable_bill_wrapper div.dt-buttons {
  z-index: 10;
    ...
    <div class="card-body">
      ...
      <form  method="post" class="form-horizontal needs-validation" novalidate action="{{route('receivable_billwise.store')}}" enctype="multipart/form-data">
      {{csrf_field()}}

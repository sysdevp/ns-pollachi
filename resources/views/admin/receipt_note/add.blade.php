...
<form  method="post" class="form-horizontal" action="{{ route('receipt_note.store') }}" id="dataInput" enctype="multipart/form-data">
      {{csrf_field()}}
                        ...
                        <div class="row col-md-12">
                          ...
                          <div class="col-md-4">
                  <label style="font-family: Times new roman;">Voucher Type<?php echo Mandatoryfields::mandatory('receiptnote_vouchertype');?></label><br>
                  <div class="form-group row">
                     <div class="col-sm-8">
                      <select class="js-example-basic-multiple col-12 form-control custom-select voucher_type" onchange="voucher_types()" name="voucher_type" id="voucher_type" <?php echo Mandatoryfields::validation('receiptnote_vouchertype');?> autofocus>
                  ...
                  <div class="form-group row">
                     <div class="col-sm-8">
                      <select class="js-example-basic-multiple col-12 form-control custom-select supplier_id" onchange="supplier_details()" name="supplier_id" id="supplier_id" <?php echo Mandatoryfields::validation('receiptnote_supplierid');?>>
                     ...
                     <button type="button"  class="px-2 btn btn-success mx-2 refresh_supplier_id" title="Add Brand"><i class="fa fa-refresh" aria-hidden="true"></i></button>
                       ...
                       <div class="row col-md-12">
                        ...
                        <div class="col-md-2">
                                ...
                                <input type="date" class="form-control voucher_date  required_for_proof_valid" id="voucher_date" placeholder="Voucher Date" name="voucher_date" value="{{ $date }}" <?php echo Mandatoryfields::validation('receiptnote_voucherdate');?>>
                                 
                                </div>

                        <div class="col-md-2">
                          <!-- <input type="checkbox" name="po_black_white" class="po_black_white" value=""> -->
                ...
                <table class="table table-responsive" id="team-list">
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <input type="number" class="form-control overall_discount" id="overall_discount" name="overall_discount" oninput="overall_discounts()" pattern="[0-9]{0,100}" title="Numbers Only" value="0" <?php echo Mandatoryfields::validation('receiptnote_overall_discount');?>>
                      </div>
                    </div>
...
var voucher_type = $('.voucher_type').val();
  ...
  $.ajax({
                type: "POST",
                url: "{{ url('receipt_note/voucher_type/') }}",
...
$.ajax({
           type: "POST",
            url: "{{ url('receipt_note/po_alpha_beta/') }}",
            data: { id: val },
           success: function(data) {

...
<div class="col-12 body-sec">
  <div class="card px-0">
    ...
    <div class="card-header px-2">
      <div class="row">
        <div class="col-4">
          <h3>Last Purchase Cost Report</h3>
        </div>
          ...
          <table class="table table-striped table-bordered" id="stock_summary">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="icon">
                      <span class="tdshow">
                      <a href="{{ route('purchase_cost.show',$value->item_id) }}" class="px-1 py-0 text-white rounded" title="View"><i class="fa fa-eye" aria-hidden="true" style="color: black;"></i></a>
                      </span>
              </td>
                    </tr>

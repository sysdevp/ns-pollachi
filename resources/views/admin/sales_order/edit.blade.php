      ...
      @method('PATCH')
                       ...
                       <div class="row col-md-10">
                                ...
                                <div class="col-md-2">
                                  ...
                                  <div class="">
                                    <input type="hidden" readonly="" id="voucher_no" name="voucher_no" value="{{ $saleorder->so_no }}">
                                    <input type="hidden" id="voucher_number" name="voucher_number" value="{{ $saleorder->voucher_no }}">
                                ...
                                <input type="date" class="form-control voucher_date  required_for_proof_valid" id="voucher_date" placeholder="Voucher Date" name="voucher_date" value="{{ $saleorder->so_date }}" <?php echo Mandatoryfields::validation('saleorder_voucherdate');?> autofocus>
                  ...
                  <input type="date" class="form-control estimation_date  required_for_proof_valid" readonly="" id="estimation_date" placeholder="Estimation Date" name="estimation_date" value="{{ $saleorder->estimation_date }}">
                  ...
                  <div class="form-group row">
                     <div class="col-sm-8">
                      <select class="js-example-basic-multiple col-12 form-control custom-select salesmen_id" name="salesmen_id" id="salesmen_id" <?php echo Mandatoryfields::validation('saleorder_salesmenid');?>> 
                           @if(isset($saleorder->salesman->id) && !empty($saleorder->salesman->id))
                           <option value="{{ $saleorder->salesman->id }}">{{ $saleorder->salesman->name }}</option>
                           @else
                  ...
                  <select class="js-example-basic-multiple col-12 form-control custom-select location" name="location" id="location" <?php echo Mandatoryfields::validation('saleorder_location');?>>
                           <option value="{{ @$saleorder->location }}">{{ @$saleorder->locations->name }}</option>
                ...
                <table class="table table-responsive" id="team-list">
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <input type="number" class="form-control overall_discount" id="overall_discount" name="overall_discount" oninput="overall_discounts()" pattern="[0-9]{0,100}" title="Numbers Only" value="{{ $saleorder->overall_discount }}" <?php echo Mandatoryfields::validation('saleorder_overall_discount');?>>
                      </div>
                    </div>
                  ...
                  <div class="form-group row">
                    ...
                    @endif
                       ...
                       <div class="col-md-12" style="float: right;">
                        ...
                        <font color="black" style="font-size: 150%; margin-left: 700px; font-weight: 900;">NET Value :</font>&nbsp;<font class="total_net_value" style="font-size: 150%; font-weight: 900;">{{$saleorder->total_net_value}}</font> 
                       </div>
                    <!-- net value -->

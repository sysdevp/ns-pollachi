...
class IndividualLedgerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.individual_ledger.ledger',compact('head','initial_page'));
    }
        ...
        if($request->head_id)
          ...
          else
          {
            ...
            array_push($array_details, $new_array);
             ...
             return view('admin.individual_ledger.ledger',compact('head','array_details','initial_page'));
    }
}

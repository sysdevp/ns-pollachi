...
class PurchaseVoucherTypeController extends Controller
{
    /**
    ...
    {
        $voucher_data = PurchaseVoucherType::all();
        return view('admin.master.purchase-voucher-type.view',compact('voucher_data'));
    }
    ...
    {
        return view('admin.master.purchase-voucher-type.add');
    }
    ...
    {
        $voucher_data = new PurchaseVoucherType();
    ...
    public function show($id)
    {
        ...
        return view('admin.master.purchase-voucher-type.show',compact('voucher_data'));
    }
    ...
    {
        $voucher_data = PurchaseVoucherType::find($id);
        return view('admin.master.purchase-voucher-type.edit',compact('voucher_data'));
    }
    ...
    {
       return view('admin.master.purchase-voucher-type.index');
    }
    ...
    public function importCsv(Request $request)
    {
        ...
        {
            PurchaseVoucherType::firstOrCreate($customerArr[$i]);
        }

...
class PurchaseOrderController extends Controller
{
    ...
    $location = Location::all();
        ...
        return view('admin.purchaseorder.view',compact('purchaseorder','check_id','taxable_value','tax_value','total','expense_total','total_discount','supplier','location'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $tax = Tax::all();                   
         ...
         {
             $current_voucher_num=$po_no->po_no;
             $voucher_no=$current_voucher_num+1;
...
echo "<pre>"; print_r($data); exit;
    ...
    $location = Location::all();
        ...
        return view('admin.purchaseorder.view',compact('purchaseorder','check_id','taxable_value','tax_value','total','expense_total','total_discount','supplier','location','cond','from','to'));
    }

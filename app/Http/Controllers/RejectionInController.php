...
class RejectionInController extends Controller
{
    ...
    public function store(Request $request)
    {
...

        {
            ...
            $rejection_in_items->actual_qty = $request->actual_qty[$i];

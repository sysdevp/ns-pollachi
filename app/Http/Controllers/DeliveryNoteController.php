...
class DeliveryNoteController extends Controller
{
    ...
    $location = Location::all();
        return view('admin.delivery_note.view',compact('delivery_note','check_id','taxable_value','tax_value','total','expense_total','total_discount','customer','sales_man','location'));
    }
...
echo "<pre>"; print_r($data); exit;
    ...
    $sales_man = SalesMan::all();
    $location = Location::all();
        return view('admin.delivery_note.view',compact('delivery_note','check_id','taxable_value','tax_value','total','expense_total','total_discount','customer','sales_man','location','from','to','cond'));
    }
}

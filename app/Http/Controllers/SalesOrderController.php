...
class SalesOrderController extends Controller
{
    ...
    $location = Location::all();
        ...
        return view('admin.sales_order.view',compact('saleorder','check_id','taxable_value','tax_value','total','expense_total','total_discount','customer','sales_man','location'));
    }
...
echo "<pre>"; print_r($data); exit;
    ...
    $location = Location::all();
        ...
        return view('admin.sales_order.view',compact('saleorder','check_id','taxable_value','tax_value','total','expense_total','total_discount','customer','sales_man','location','cond','from','to'));
    }

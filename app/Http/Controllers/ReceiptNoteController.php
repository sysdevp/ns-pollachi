...
class ReceiptNoteController extends Controller
{
    ...
    $location = Location::all();
        ...
        return view('admin.receipt_note.view',compact('receipt_note','check_id','taxable_value','tax_value','total','expense_total','total_discount','supplier','location'));
    }
...
echo "<pre>"; print_r($data); exit;
    ...
    $supplier = Supplier::all();
    $location = Location::all();
        return view('admin.receipt_note.view',compact('receipt_note','check_id','taxable_value','tax_value','total','expense_total','total_discount','cond','from','to','supplier','location'));
    }

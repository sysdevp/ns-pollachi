...
class CreditNoteController extends Controller
{
    ...
    public function index($id)
    {
        ...
        return view('admin.credit_note.view',compact('credit_note','check_id','customer','location'));
    }
...
echo "<pre>"; print_r($data); exit;
    ...
    public function report(Request $request)
    {
       ...
       $credit_note = CreditNote::where($cond)->whereBetween('s_date',[$from,$to])->where('active',1)->get();
        $customer = Customer::all();
        $location = Location::all();
        return view('admin.credit_note.view',compact('credit_note','check_id','customer','location','cond','from','to'));
    }
}

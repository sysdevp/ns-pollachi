    ...
    public function change_items(Request $request,$id)
    {
        ...
        foreach($item as $key=>$value){
            ...
            if(count($value->item_barcode_details)>0){
             ...
             $result .='<tr class="row_category" id="'.$key.'"><td><font style="font-family: Times new roman;">'.++$key.'</font></td><td><input type="hidden" value="'.$value->id.'" class="append_item_id'.$key.'"><input type="hidden" value="'.$value->code.'" class="append_item_code'.$key.'"><font style="font-family: Times new roman;">'.$value->code.'</font></td><td><input type="hidden" value="'.$value->name.'" class="append_item_name'.$key.'"><font style="font-family: Times new roman;">'.$value->name.'</font></td><td><input type="hidden" value="'.$value->brand_id.'" class="append_item_brand_name'.$key.'"><font style="font-family: Times new roman;">'.$barnd_name .'</font></td><td><input type="hidden" value="'.$value->category_id.'" class="append_item_category_name'.$key.'"><font style="font-family: Times new roman;">'.$category_name .'</font></td><td><input type="hidden" value="'.$value->hsn.'" class="append_item_hsn'.$key.'"><font style="font-family: Times new roman;">'.$value->hsn.'</font></td><td><input type="hidden" value="'.$value->mrp.'" class="append_item_mrp'.$key.'"><font style="font-family: Times new roman;">'.$value->mrp.'</font></td><td><input type="hidden" value="'.$uom_id.'" class="append_item_uom'.$key.'"><font style="font-family: Times new roman;">'.$uom_name.'</font></td><td><input type="hidden" value="'.$value->default_selling_price.'" class="append_item_selling_price'.$key.'"><font style="font-family: Times new roman;">'.$value->default_selling_price.'</font></td><td><i class="fa fa-level-up px-2 py-1 bg-info  text-white rounded show_items" id="'.$key.'" aria-hidden="true"></i><i class="fa fa-level-down px-2 py-1 bg-success  text-white rounded edit_items" id="'.$key.'" aria-hidden="true"></i></td></tr>';

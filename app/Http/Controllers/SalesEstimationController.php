...
$result=[];
   ...
   function get_item_id($item_id)
   {
    ...
    $sales_man = SalesMan::all();
    $agent = Agent::all();
        return view('admin.sales_estimation.view',compact('sale_estimation','check_id','tax_value','taxable_value','total','expense_total','total_discount','customer','sales_man','agent','cond','from','to'));
    }   
}

...
class ReceiptRequestController extends Controller
{
    ...
    public function create()
    {
        ...
        $type = ReceiptVoucherType::where('name','Receipt Request')->get();
        return view('admin.receipt_request.add',compact('supplier','date','type'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $vouchers=ReceiptRequest::orderBy('created_at','DESC')->first();                  

  ...
  <div class="card container px-0">
    ...
    <div class="card-body">
      <div class="row col-md-12">
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> <?php echo e($estimation->estimation_no); ?></label>
          </div>
              </div>
          ...
          <div class="col-md-6">
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> <?php echo e($estimation->estimation_date); ?></label>
          </div>
              </div>
            </div>
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> 
              ...
              <?php echo e($estimation->supplier->name); ?>
          ...
          <div class="col-md-6">
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> 
              ...
              <?php echo e($estimation->agent->name); ?>
...
<div class="form-row">
              ...
              <div>
                ...
                <table class="table table-bordered table-responsive" style="max-width: 85%; height: 100%;">
                  <thead>
                    <th> S.no </th>
                    <th> Item S.no </th>
                    <th> Item Code</th>
          ...
          <div class="col-md-6">
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> <?php echo e($estimation->overall_discount); ?></label>
          </div>
              </div>
            </div>
        ...
        <table class="table table-bordered table-responsive" style="width: 100%; height: 100%;">
          <thead>
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> <?php echo e($estimation->round_off); ?></label>
          </div>
              </div>
          ...
          <div class="col-md-6">
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> <?php echo e($estimation->total_net_value); ?></label>
          </div>
              </div>
            </div>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ns_pollachi\resources\views/admin/estimation/show.blade.php ENDPATH**/ ?>
  ...
  <div class="card container px-0">
    ...
    <div class="card-body">
      <div class="row col-md-12">
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> <?php echo e($purchase_gatepass->purchase_gatepass_no); ?></label>
          </div>
              </div>
          ...
          <div class="col-md-6">
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> <?php echo e($purchase_gatepass->purchase_gatepass_date); ?></label>
          </div>
              </div>
            </div>
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> <?php echo e($purchase_gatepass->po_no); ?></label>
          </div>
              </div>
          ...
          <div class="col-md-6">
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> <?php echo e($purchase_gatepass->po_date); ?></label>
          </div>
              </div>
            </div>
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> 
              <?php if(isset($purchase_gatepass->supplier->name) && !empty($purchase_gatepass->supplier->name)): ?>
              <?php echo e($purchase_gatepass->supplier->name); ?>
          ...
          <div class="col-md-6">
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> 
              <?php echo e($purchase_gatepass->estimation_no); ?>
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> 
              <?php echo e($purchase_gatepass->estimation_date); ?>
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> <?php echo e($purchase_gatepass->load_live); ?></label>
          </div>
              </div>
          ...
          <div class="col-md-6">
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> <?php echo e($purchase_gatepass->unload_live); ?></label>
          </div>
              </div>
            </div>
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> <?php echo e($purchase_gatepass->load_bill); ?></label>
          </div>
              </div>
          ...
          <div class="col-md-6">
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> <?php echo e($purchase_gatepass->unload_bill); ?></label>
          </div>
              </div>
            </div>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ns_pollachi\resources\views/admin/purchase_gatepass/show.blade.php ENDPATH**/ ?>
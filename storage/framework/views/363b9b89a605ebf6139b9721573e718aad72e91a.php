      ...
      <div class="row">
        ...
        <div class="col-8 mr-auto">
          <ul class="h-right-btn mb-0 pl-0">
            <li><button type="button" class="btn btn-success"><a href="<?php echo e(url('credit_note/index/0')); ?>">Back</a></button></li>
          </ul>
        </div>
      </div>
    </div>
...
<form  method="post" class="form-horizontal" action="<?php echo e(route('credit_note.update',$credit_note->cn_no)); ?>" id="dataInput" enctype="multipart/form-data">
                  ...
                  <div class="form-group row">
                     <div class="col-sm-8">
                      <select class="js-example-basic-multiple col-12 form-control custom-select customer_id" onchange="customer_details()" name="customer_id" id="customer_id">
                           <?php if(isset($credit_note->customer->name) && !empty($credit_note->customer->name)): ?>
                           <option value="<?php echo e($credit_note->customer->id); ?>"><?php echo e($credit_note->customer->name); ?></option>
                           <?php else: ?>
                     ...
                     <button type="button"  class="px-2 btn btn-success mx-2 refresh_customer_id" title="Add Brand"><i class="fa fa-refresh" aria-hidden="true"></i></button>
                        ...
                        <div class="col-md-2">
                                  ...
                                  <div class="">
                                    <input type="hidden" readonly="" id="voucher_no" name="voucher_no" value="<?php echo e($credit_note->cn_no); ?>">
                                    <font size="2"><?php echo e($credit_note->cn_no); ?></font>
                                  </div>
                                ...
                                <input type="date" class="form-control voucher_date  required_for_proof_valid" id="voucher_date" placeholder="Voucher Date" name="voucher_date" value="<?php echo e($credit_note->cn_date); ?>">
                        ...
                        <div class="col-md-2">
                                ...
                                <option value="<?php echo e($credit_note->s_no); ?>"><?php echo e($credit_note->s_no); ?></option>
                        ...
                        <div class="col-md-2">
                                ...
                                <input type="date" class="form-control s_date  required_for_proof_valid" readonly="" id="s_date" placeholder="Voucher Date" name="s_date" value="<?php echo e($credit_note->s_date); ?>">
                                ...
                                <option value="<?php echo e($credit_note->r_in_no); ?>"><?php echo e($credit_note->r_in_no); ?></option>
                                ...
                                <input type="date" class="form-control r_in_date  required_for_proof_valid" readonly="" id="r_in_date" placeholder="Voucher Date" name="r_in_date" value="<?php echo e($credit_note->r_in_date); ?>">
                ...
                <table class="table" id="team-list">
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <input type="number" class="form-control overall_discount" id="overall_discount" name="overall_discount" oninput="overall_discounts()" pattern="[0-9]{0,100}" title="Numbers Only" value="<?php echo e($credit_note->overall_discount); ?>">
                      </div>
                    </div>
                    ...
                    <!-- <div class="row col-md-12">
                        ...
                        <div class="row col-md-12 append_expense">
                          ...
                          <?php $__currentLoopData = $credit_note_expense; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <div class="form-group row">
                     ...
                     <button type="button"  class="px-2 btn btn-success mx-2 refresh_expense_type_id" title="Add Expense Type"><i class="fa fa-refresh" aria-hidden="true"></i></button>
                      ...
                      <div class="col-md-2">
                        <label style="font-family: Times new roman;">Expense Amount</label>
                      <input type="number" class="form-control expense_amount" id="expense_amount"  placeholder="Expense Amount" readonly="" name="expense_amount[]" step="any" title="Numbers Only" value="<?php echo e($value->expense_amount); ?>">
                  ...
                  <div class="form-group row">
                    ...
                    <?php endif; ?>
                      ...
                      <input type="text" class="form-control round_off" readonly="" value="<?php echo e($credit_note->round_off); ?>" id="round_off" name="round_off" >
                      </div>
                      ...
                      <div class="col-md-4" style="float: right;">
                        ...
                        <font color="black" style="font-size: 150%; margin-left: 100px; font-weight: 900;">NET Value :</font>&nbsp;<font class="total_net_value" style="font-size: 150%; font-weight: 900;"><?php echo e($credit_note->total_net_value); ?></font> 
                       </div>
...
if(append_value == 1)
{
  var row_id=$('#last').val();
      ...
      $.ajax({  
        ...
        type: "GET",
        url: "<?php echo e(url('credit_note/getdata/{id}')); ?>",
        data: { id: item_code },             
      ...
      $.ajax({
           type: "POST",
            url: "<?php echo e(url('credit_note/last_purchase_rate/')); ?>",
            data: { id: item_code },
           success: function(data) {
...
var row_id=$('#last').val();
      ...
      $.ajax({  
        ...
        type: "GET",
        url: "<?php echo e(url('credit_note/getdata_item/{id}')); ?>",
        data: { id: item_code },             
...
function item_with_same_data(item_code)
{
  $.ajax({
        ...
        type: "GET",
        url: "<?php echo e(url('credit_note/same_items/{id}')); ?>",
        data: { id: item_code },
...
function browse_item()
{
  ...
  $.ajax({  
        ...
        type: "GET",
        url: "<?php echo e(url('credit_note/browse_item/{id}')); ?>",
...
function categories_check()
{
  ...
  $.ajax({  
        ...
        type: "GET",
        url: "<?php echo e(url('credit_note/change_items/{id}')); ?>",
...
function brand_check()
{
  ...
  $.ajax({
        ...
        type: "POST",
        url: "<?php echo e(url('credit_note/brand_filter/')); ?>",
        data: {brand: brand },             
...
function customer_details()
{
  ...
  $.ajax({
           type: "POST",
            url: "<?php echo e(url('credit_note/address_details/')); ?>",
...
function s_details()
{
  ...
  $.ajax({
           type: "POST",
            url: "<?php echo e(url('credit_note/s_details/')); ?>",
            data: { s_no : s_no },
           success: function(data) {
            $('.tables').remove();
            $('.expense').remove();
...
function rejection_in_details()
{
  ...
  $.ajax({
           type: "POST",
            url: "<?php echo e(url('credit_note/rejection_in_details/')); ?>",
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ns_pollachi\resources\views/admin/credit_note/edit.blade.php ENDPATH**/ ?>
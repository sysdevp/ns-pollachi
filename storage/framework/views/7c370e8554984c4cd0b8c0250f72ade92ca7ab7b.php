      ...
      <div class="row">
        ...
        <div class="col-8 mr-auto">
          <ul class="h-right-btn mb-0 pl-0">
            <li><button type="button" class="btn btn-success"><a href="<?php echo e(url('purchase_order/index/0')); ?>">Back</a></button></li>
          </ul>
        </div>
      </div>
    </div>
...
<form  method="post" class="form-horizontal" action="<?php echo e(route('purchase_order.update',$purchaseorder->po_no)); ?>" id="dataInput" enctype="multipart/form-data">
      ...
      <?php echo method_field('PATCH'); ?>
                       ...
                       <div class="row col-md-10">
                                ...
                                <div class="col-md-2">
                                  ...
                                  <div class="">
                                    <input type="hidden" readonly="" id="voucher_no" name="voucher_no" value="<?php echo e($purchaseorder->po_no); ?>">
                                    <font size="2"><?php echo e($purchaseorder->po_no); ?></font>
                                  </div>
                                ...
                                <input type="date" class="form-control voucher_date  required_for_proof_valid" id="voucher_date" placeholder="Voucher Date" name="voucher_date" value="<?php echo e($purchaseorder->po_date); ?>">
                  ...
                  <div class="form-group row">
                     <div class="col-sm-8">
                      <select class="js-example-basic-multiple col-12 form-control custom-select supplier_id" onchange="supplier_details()" name="supplier_id" id="supplier_id">
                        <?php if(isset($purchaseorder->supplier->name) && !empty($purchaseorder->supplier->name)): ?>
                           <option value="<?php echo e($purchaseorder->supplier->id); ?>"><?php echo e($purchaseorder->supplier->name); ?></option>
                           <?php else: ?>
                  ...
                  <select class="js-example-basic-multiple col-12 form-control custom-select estimation_no" onchange="estimation_details()"  name="estimation_no" id="estimation_no" required="">
                           <option value="<?php echo e($purchaseorder->estimation_no); ?>"><?php echo e($purchaseorder->estimation_no); ?></option>
                  ...
                  <input type="date" class="form-control estimation_date  required_for_proof_valid" readonly="" id="estimation_date" placeholder="Estimation Date" name="estimation_date" value="<?php echo e($purchaseorder->estimation_date); ?>">
                    ...
                    <?php if($purchaseorder->purchase_type == 1): ?>
...
<div class="form-row">
              ...
              <div class="col-md-12" id="middlecol">
                ...
                <table class="table" id="team-list">
                  ...
                  <input type="hidden" name="total_price" value="<?php echo e($purchaseorder->total_net_value); ?>" id="total_price">
                  <input type="hidden" name="last_purchase_rate" value="0" id="last_purchase_rate">

                  <?php $__currentLoopData = $purchaseorder_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <input type="number" class="form-control overall_discount" id="overall_discount" name="overall_discount" oninput="overall_discounts()" pattern="[0-9]{0,100}" title="Numbers Only" value="<?php echo e($purchaseorder->overall_discount); ?>">
                      </div>
                    </div>
                    ...
                    <!-- <div class="row col-md-12">
                        ...
                        <div class="row col-md-12 append_expense">
                          ...
                          <?php $__currentLoopData = $purchaseorder_expense; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <div class="form-group row">
                    ...
                    <?php endif; ?>
                       ...
                       <div class="col-md-12" style="float: right;">
                        ...
                        <font color="black" style="font-size: 150%; margin-left: 700px; font-weight: 900;">NET Value :</font>&nbsp;<font class="total_net_value" style="font-size: 150%; font-weight: 900;"><?php echo e($purchaseorder->total_net_value); ?></font> 
                       </div>
                    <!-- net value -->
                      ...
                      <input type="text" class="form-control round_off" readonly="" value="<?php echo e($purchaseorder->round_off); ?>" id="round_off" name="round_off" >
                      </div>
...
$(document).on("click",".remove_items",function(){
    ...
    $.ajax({
           type: "GET",
            url: "<?php echo e(url('purchase_order/remove_data/{id}')); ?>",
...
if(append_value == 1)
{
  var row_id=$('#last').val();
      ...
      $.ajax({  
        ...
        type: "GET",
        url: "<?php echo e(url('purchase_order/getdata/{id}')); ?>",
        data: { id: item_code },             
      ...
      $.ajax({
           type: "POST",
            url: "<?php echo e(url('purchase_order/last_purchase_rate/')); ?>",
            data: { id: item_code },
           success: function(data) {
...
var row_id=$('#last').val();
      ...
      $.ajax({  
        ...
        type: "GET",
        url: "<?php echo e(url('purchase_order/getdata_item/{id}')); ?>",
        data: { id: item_code },             
...
function item_with_same_data(item_code)
{
  $.ajax({
        ...
        type: "GET",
        url: "<?php echo e(url('purchase_order/same_items/{id}')); ?>",
        data: { id: item_code },
...
function browse_item()
{
  ...
  $.ajax({  
        ...
        type: "GET",
        url: "<?php echo e(url('purchase_order/browse_item/{id}')); ?>",
...
function categories_check()
{
  ...
  $.ajax({  
        ...
        type: "GET",
        url: "<?php echo e(url('purchase_order/change_items/{id}')); ?>",
...
function brand_check()
{
  ...
  $.ajax({
        ...
        type: "POST",
        url: "<?php echo e(url('purchase_order/brand_filter/')); ?>",
        data: {brand: brand },             
...
function supplier_details()
{
  ...
  $.ajax({
           type: "POST",
            url: "<?php echo e(url('purchase_order/address_details/')); ?>",
...
function estimation_details()
{
  ...
  $.ajax({
           type: "POST",
            url: "<?php echo e(url('purchase_order/estimation_details/')); ?>",
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ns_pollachi\resources\views/admin/purchaseorder/edit.blade.php ENDPATH**/ ?>
...
<div class="col-12 body-sec">
  <div class="card container px-0">
    ...
    <div class="card-header px-2">
      <div class="row">
        <div class="col-4">
          <h3>View Receipt Note Details</h3>
        </div>
    ...
    <div class="card-body">
      <div class="row col-md-12">
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> <?php echo e($receipt_note->rn_no); ?></label>
          </div>
              </div>
          ...
          <div class="col-md-6">
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> <?php echo e($receipt_note->rn_date); ?></label>
          </div>
              </div>
            </div>
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> <?php echo e($receipt_note->po_no); ?></label>
          </div>
              </div>
          ...
          <div class="col-md-6">
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> <?php echo e($receipt_note->po_date); ?></label>
          </div>
              </div>
            </div>
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> 
              ...
              <?php echo e($receipt_note->supplier->name); ?>
          ...
          <div class="col-md-6">
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> 
              <?php if($receipt_note->purchase_type == 1): ?>
              Cash Purchase
              <?php else: ?>
               Credit purchase
              <?php endif; ?>
...
<div class="form-row">
          ...
          <div class="col-md-6">
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> <?php echo e($receipt_note->overall_discount); ?></label>
          </div>
              </div>
            </div>
        ...
        <table class="table table-bordered table-responsive" style="width: 100%; height: 100%;">
          <thead>
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> <?php echo e($receipt_note->round_off); ?></label>
          </div>
              </div>
          ...
          <div class="col-md-6">
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> <?php echo e($receipt_note->total_net_value); ?></label>
          </div>
              </div>
            </div>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ns_pollachi\resources\views/admin/receipt_note/show.blade.php ENDPATH**/ ?>
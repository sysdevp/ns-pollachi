...
<div class="col-12 body-sec">
  <div class="card container-fluid px-0">
    ...
    <div class="card-body">
      ...
      <form  method="post" class="form-horizontal needs-validation form_submit" novalidate action="<?php echo e(url('master/item-tax-details/store')); ?>" enctype="multipart/form-data">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <select class="js-example-basic-multiple col-12 form-control custom-select search_brand_id" name="search_brand_id">
                  ...
                  <option value="<?php echo e($value->id); ?>" <?php echo e(old('search_brand_id') == $value->id ? 'selected' : ''); ?>  ><?php echo e($value->name); ?></option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                <span class="mandatory"> <?php echo e($errors->first('search_brand_id')); ?> </span>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <select class="js-example-basic-multiple col-12 form-control custom-select category_id search_category_id" name="search_category_id">
                  ...
                  <option value="<?php echo e($value->id); ?>" <?php echo e(old('search_category_id') == $value->id ? 'selected' : ''); ?>  ><?php echo e($value->name); ?></option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                <span class="mandatory"> <?php echo e($errors->first('search_category_id')); ?> </span>
               <div class="invalid-feedback">
            ...
            <div class="col-md-3">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          ...
                          <span class="mandatory"> <?php echo e($errors->first('search_item_id')); ?> </span>
                         <div class="invalid-feedback">
  ...
  <table class="table">
    <thead class="thead-gray">
      <tr>
        ...
        <th><?php echo e($value->name); ?>(%) <input type="text" class="form-control common" id="<?php echo e($value->name); ?>_id" placeholder="<?php echo e($value->name); ?> (%)"> </th>
    ...
    <tbody class="append_row">
     ...
     <?php if(old('item_id')): ?>
         <?php $__currentLoopData = old('item_id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $old_key=>$old_value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  <tr>
         <td class="s_no"></td> 
         <td>
             <p> <?php echo e(old('item_name.'.$old_key)); ?> </p>
             <input type="hidden" class="form-control item_id" name="item_id[]" value="<?php echo e(old('item_id.'.$old_key)); ?>">
             <input type="hidden" class="form-control item_name" name="item_name[]" value="<?php echo e(old('item_name.'.$old_key)); ?>">
             <span class="mandatory"> <?php echo e($errors->first('item_id.'.$old_key)); ?> </span>
                  <div class="invalid-feedback">
                  Enter valid Item
                  </div>
         </td>
         ...
         <td>
             <div class="col-sm-12">
             <input type="text" class="form-control cgst only_allow_digit_and_dot" name="cgst[]" placeholder="CGST" value="<?php echo e(old('cgst.'.$old_key)); ?>" required>
       ...
       <td>
                 <div class="col-sm-12">
                 <input type="text" class="form-control sgst only_allow_digit_and_dot" name="sgst[]" placeholder="SGST" value="<?php echo e(old('sgst.'.$old_key)); ?>" required>
  ...
  if(category_id !="")
  {
    category_based_item(category_id,"");
      ...
      function category_based_item(category_id,item_id){
        $.ajax({
              type: "post",
              url: "<?php echo e(url('common/get-category-based-item-dets')); ?>",
...
function get_category_based_item(category_one_id,category_two_id,category_three_id,item_id)
{
  $.ajax({
              type: "post",
              url: "<?php echo e(url('common/get-category-based-item')); ?>",
...
$(document).on("click",".search_btn",function(){
  $.ajax({
              type: "post",
              url: "<?php echo e(url('master/item-tax-details/search-item-by-category')); ?>",
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ns_pollachi\resources\views/admin/master/item_tax_details/add.blade.php ENDPATH**/ ?>
...
<form  method="post" class="form-horizontal" action="<?php echo e(route('delivery_note.store')); ?>" id="dataInput" enctype="multipart/form-data">
                     ...
                     <button type="button"  class="px-2 btn btn-success mx-2 refresh_salesmen_id" title="Add Sales Men"><i class="fa fa-refresh" aria-hidden="true"></i></button>
                       ...
                       <div class="row col-md-12">
                        ...
                        <div class="col-md-2">
                                ...
                                <?php $__currentLoopData = $sale_estimation; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale_estimations): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($sale_estimations->sale_estimation_no); ?>"><?php echo e($sale_estimations->sale_estimation_no); ?></option>
                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
                                 </select>
                ...
                <table class="table" id="team-list">
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <th></th>
                      <th></th>
                      <th><label class="total_amount" style="float:right;">0</label></th>
                      <th></th>
                      <th></th>
                      <th></th>
                      <th></th>
                      <th><label class="total_net_price" style="float:right;">0</label></th>
                  ...
                  <div class="form-group row">
                    ...
                    <!-- net value -->
                      ...
                      <input type="text" class="form-control <?php echo e($value->id); ?>" readonly="" id="<?php echo e($value->id); ?>" name="<?php echo e($value->name); ?>" value="0">

                      <input type="hidden" name="<?php echo e($value->name); ?>_id" value="<?php echo e($value->id); ?>">
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ns_pollachi\resources\views/admin/delivery_note/add.blade.php ENDPATH**/ ?>
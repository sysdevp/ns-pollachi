...
<form  method="post" class="form-horizontal" action="<?php echo e(route('purchase_entry.update',$purchase_entry->p_no)); ?>" id="dataInput" enctype="multipart/form-data">
                  ...
                  <div class="form-group row">
                     <div class="col-sm-8">
                      <select class="js-example-basic-multiple col-12 form-control custom-select supplier_id" onchange="supplier_details()" name="supplier_id" id="supplier_id">
                           <?php if(isset($purchase_entry->supplier->name) && !empty($purchase_entry->supplier->name)): ?>
                           <option value="<?php echo e($purchase_entry->supplier->id); ?>"><?php echo e($purchase_entry->supplier->name); ?></option>
                           <?php else: ?>
                     ...
                     <button type="button"  class="px-2 btn btn-success mx-2 refresh_supplier_id" title="Add Brand"><i class="fa fa-refresh" aria-hidden="true"></i></button>
                                ...
                                <div class="col-md-2">
                                  ...
                                  <div class="">
                                    <input type="hidden" readonly="" id="voucher_no" name="voucher_no" value="<?php echo e($purchase_entry->p_no); ?>">
                                    <font size="2"><?php echo e($purchase_entry->p_no); ?></font>
                                  </div>
                                ...
                                <input type="date" class="form-control voucher_date  required_for_proof_valid" id="voucher_date" placeholder="Voucher Date" name="voucher_date" value="<?php echo e($purchase_entry->p_date); ?>">
                       ...
                       <div class="row col-md-12">
                        ...
                        <!-- <div class="col-md-2">
                                ...
                                <option value="<?php echo e($purchase_entry->po_no); ?>"><?php echo e($purchase_entry->po_no); ?></option>
                                <?php $__currentLoopData = $purchaseorder; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $purchaseorders): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($purchaseorders->po_no); ?>"><?php echo e($purchaseorders->po_no); ?></option>
                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
                                 </select>
                        ...
                        <div class="col-md-2">
                                ...
                                <input type="date" class="form-control po_date  required_for_proof_valid" id="po_date" placeholder="Voucher Date" name="po_date" value="<?php echo e($date); ?>">
                                ...
                                <option value="<?php echo e($purchase_entry->estimation_no); ?>"><?php echo e($purchase_entry->estimation_no); ?></option>
                                  ...
                                  <option value="<?php echo e($value->estimation_no); ?>"><?php echo e($value->estimation_no); ?></option>
                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                 </select>
                                ...
                                <input type="date" class="form-control p_estimation_date  required_for_proof_valid" readonly="" id="p_estimation_date" placeholder="Estimation Date" name="p_estimation_date" value="<?php echo e($purchase_entry->estimation_date); ?>">
                                ...
                                <div class="col-md-2">
                                  <label style="font-family: Times new roman;">Purchase Order Date</label><br>
                                <input type="date" class="form-control po_date  required_for_proof_valid" readonly="" id="po_date" placeholder="Voucher Date" name="po_date" value="<?php echo e($purchase_entry->po_date); ?>">
                                ...
                                <option value="<?php echo e($purchase_entry->rn_no); ?>"><?php echo e($purchase_entry->rn_no); ?></option>
                                  <?php $__currentLoopData = $receipt_notes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <option value="<?php echo e($value->rn_no); ?>"><?php echo e($value->rn_no); ?></option>
                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                 </select>
                                ...
                                <input type="date" class="form-control receipt_date  required_for_proof_valid" readonly="" id="receipt_date" placeholder="Receipt Note Date" name="receipt_date" value="<?php echo e($purchase_entry->rn_date); ?>">
                                ...
                                <div class="col-md-2">
                                  ...
                                  <div class="purchase_date">
                                    <?php echo e($purchase_entry->po_date); ?>
                                ...
                                <div class="col-md-2">
                                  ...
                                  <div class="estimation_no">
                                    <?php echo e($purchase_entry->estimation_no); ?>
                              ...
                              <div class=" row col-md-12 mb-3">
                                ...
                                <option value="<?php echo e(@$purchase_entry->location); ?>"><?php echo e(@$purchase_entry->locations->name); ?></option>
                ...
                <table class="table" id="team-list">
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <input type="number" class="form-control overall_discount" id="overall_discount" name="overall_discount" oninput="overall_discounts()" pattern="[0-9]{0,100}" title="Numbers Only" value="<?php echo e($purchase_entry->overall_discount); ?>">
                      </div>
                    </div>
                    ...
                    <!-- <div class="row col-md-12">
                        ...
                        <div class="row col-md-12 append_expense">
                          ...
                          <?php $__currentLoopData = $purchase_entry_expense; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <div class="form-group row">
                     <div class="col-sm-8">
                      <select class="js-example-basic-multiple col-12 form-control custom-select expense_type" name="expense_type[]" id="expense_type" >
                         <?php if(isset($value->expense_types->name) && !empty($value->expense_types->name)): ?>
                           <option value="<?php echo e($value->expense_types->id); ?>"><?php echo e($value->expense_types->name); ?></option>
                           <?php else: ?>
                     ...
                     <button type="button"  class="px-2 btn btn-success mx-2 refresh_expense_type_id" title="Add Expense Type"><i class="fa fa-refresh" aria-hidden="true"></i></button>
                      ...
                      <div class="col-md-2">
                        <label style="font-family: Times new roman;">Expense Amount</label>
                      <input type="number" class="form-control expense_amount" id="expense_amount"  placeholder="Expense Amount" name="expense_amount[]" step="any" title="Numbers Only" value="<?php echo e($value->expense_amount); ?>">
                  ...
                  <div class="form-group row">
                    ...
                    <?php endif; ?>
                       ...
                       <div class="col-md-12" style="float: right;">
                        ...
                        <font color="black" style="font-size: 150%; margin-left: 700px; font-weight: 900;">NET Value :</font>&nbsp;<font class="total_net_value" style="font-size: 150%; font-weight: 900;"><?php echo e($purchase_entry->total_net_value); ?></font> 
                       </div>
                    <!-- net value -->
                      ...
                      <input type="text" class="form-control round_off" readonly="" value="<?php echo e($purchase_entry->round_off); ?>" id="round_off" name="round_off" >
                      </div>
                      ...
                      <input type="text" class="form-control sgst" readonly="" id="sgst" name="sgst" value="0">
                       ...
                       <div class="row col-md-12 taxes mb-3">
                        <?php $__currentLoopData = $tax; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                         <div class="col-md-2">
                           <label style="font-family: Times new roman;"><?php echo e($value->taxes->name); ?></label>
                      <input type="text" class="form-control <?php echo e($value->taxes->id); ?>" readonly="" id="<?php echo e($value->taxes->id); ?>" name="<?php echo e($value->taxes->name); ?>" value="<?php echo e($value->value); ?>">

                      <input type="hidden" name="<?php echo e($value->taxes->name); ?>_id" value="<?php echo e($value->taxes->id); ?>">
...
$(document).on("click",".remove_items",function(){
    ...
    $.ajax({
           type: "GET",
            url: "<?php echo e(url('purchase_entry/remove_data/{id}')); ?>",
...
if(append_value == 1)
{
  var row_id=$('#last').val();
      ...
      $.ajax({  
        ...
        type: "GET",
        url: "<?php echo e(url('purchase_entry/getdata/{id}')); ?>",
        data: { id: item_code },             
      ...
      $.ajax({
           type: "POST",
            url: "<?php echo e(url('purchase_entry/last_purchase_rate/')); ?>",
            data: { id: item_code },
           success: function(data) {
...
var row_id=$('#last').val();
      ...
      $.ajax({  
        ...
        type: "GET",
        url: "<?php echo e(url('estimation/getdata_item/{id}')); ?>",
        data: { id: item_code },             
      ...
      $.ajax({
           ...
           type: "POST",
            url: "<?php echo e(url('estimation/last_purchase_rate/')); ?>",
            data: { id: item_id },
           success: function(data) {
             $('#last_purchase_rate').val(data);
...
function item_with_same_data(item_code)
{
  $.ajax({
        ...
        type: "GET",
        url: "<?php echo e(url('purchase_entry/same_items/{id}')); ?>",
        data: { id: item_code },
...
function browse_item()
{
  ...
  $.ajax({  
        ...
        type: "GET",
        url: "<?php echo e(url('purchase_entry/browse_item/{id}')); ?>",
...
function categories_check()
{
  ...
  $.ajax({  
        ...
        type: "GET",
        url: "<?php echo e(url('purchase_entry/change_items/{id}')); ?>",
...
function brand_check()
{
  ...
  $.ajax({
        ...
        type: "POST",
        url: "<?php echo e(url('purchase_entry/brand_filter/')); ?>",
        data: {brand: brand },             
...
function supplier_details()
{
  ...
  $.ajax({
           type: "POST",
            url: "<?php echo e(url('purchase_entry/address_details/')); ?>",
...
function estimation_details()
{
  ...
  $.ajax({
           type: "POST",
            url: "<?php echo e(url('purchase_entry/estimation_details/')); ?>",
...
function po_details()
{
  ...
  $.ajax({
           type: "POST",
            url: "<?php echo e(url('purchase_entry/po_details/')); ?>",
            data: { po_no : po_no },
           success: function(data) {
            // $('.purchase_type').show();
            // $('.purchase_date').show();
...
function receipt_details()
{
  ...
  $.ajax({
           type: "POST",
            url: "<?php echo e(url('purchase_entry/receipt_details/')); ?>",
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ns_pollachi\resources\views/admin/purchase_entry/edit.blade.php ENDPATH**/ ?>
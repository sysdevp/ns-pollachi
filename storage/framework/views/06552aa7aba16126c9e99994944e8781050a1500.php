...
<form  method="post" class="form-horizontal" action="<?php echo e(route('delivery_note.update',$delivery_note->d_no)); ?>" id="dataInput" enctype="multipart/form-data">
                  ...
                  <div class="form-group row">
                     <div class="col-sm-8">
                      <select class="js-example-basic-multiple col-12 form-control custom-select customer_id" onchange="customer_details()" name="customer_id" id="customer_id">
                           ...
                           <option value="<?php echo e($delivery_note->customer->id); ?>"><?php echo e($delivery_note->customer->name); ?></option>
                           <?php else: ?>
                  ...
                  <div class="form-group row">
                     <div class="col-sm-8">
                      <select class="js-example-basic-multiple col-12 form-control custom-select salesmen_id" name="salesmen_id" id="salesmen_id">
                           <?php if(isset($delivery_note->salesman->id) && !empty($delivery_note->salesman->id)): ?>
                           <option value="<?php echo e($delivery_note->salesman->id); ?>"><?php echo e($delivery_note->salesman->name); ?></option>
                           <?php else: ?>
                     ...
                     <button type="button"  class="px-2 btn btn-success mx-2 refresh_salesmen_id" title="Add Sales Men"><i class="fa fa-refresh" aria-hidden="true"></i></button>
                       ...
                       <div class="row col-md-12">
                        ...
                        <div class="col-md-2">
                                  ...
                                  <div class="">
                                    <input type="hidden" readonly="" id="voucher_no" name="voucher_no" value="<?php echo e($delivery_note->d_no); ?>">
                                    <font size="2"><?php echo e($delivery_note->d_no); ?></font>
                                  </div>
                                ...
                                <input type="date" class="form-control voucher_date  required_for_proof_valid" id="voucher_date" placeholder="Voucher Date" name="voucher_date" value="<?php echo e($delivery_note->d_date); ?>">
                        ...
                        <div class="col-md-2">
                                ...
                                <option value="<?php echo e($delivery_note->sale_estimation_no); ?>"><?php echo e($delivery_note->sale_estimation_no); ?></option>
                                ...
                                <option value="<?php echo e($saleorders->sale_estimation_no); ?>"><?php echo e($saleorders->sale_estimation_no); ?></option>
                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
                                 </select>
                        ...
                        <div class="col-md-2">
                                ...
                                <input type="date" class="form-control sale_estimation_date  required_for_proof_valid" id="sale_estimation_date" readonly="" placeholder="Voucher Date" name="sale_estimation_date" value="<?php echo e($delivery_note->sale_estimation_date); ?>">
                                ...
                                <option value="<?php echo e($delivery_note->so_no); ?>"><?php echo e($delivery_note->so_no); ?></option>
                                <?php $__currentLoopData = $sale_orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($value->so_no); ?>"><?php echo e($value->so_no); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <input type="date" class="form-control so_date  required_for_proof_valid" readonly="" id="so_date" placeholder="Sale Order Date" name="so_date" value="<?php echo e($delivery_note->so_date); ?>">
                                ...
                                <option value="<?php echo e($delivery_note->r_in_no); ?>"><?php echo e($delivery_note->r_in_no); ?></option>
                                  <?php $__currentLoopData = $rejection_in; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <option value="<?php echo e($value->r_in_no); ?>"><?php echo e($value->r_in_no); ?></option>
                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                 </select>
                                ...
                                <input type="date" class="form-control r_in_date  required_for_proof_valid" readonly="" id="r_in_date" placeholder="Voucher Date" name="r_in_date" value="<?php echo e($delivery_note->r_in_date); ?>">
...
<div class="form-row">
              ...
              <div class="col-md-12" id="middlecol">
                ...
                <table class="table" id="team-list">
                  ...
                  <input type="hidden" name="total_price" value="<?php echo e($delivery_note->total_net_value); ?>" id="total_price">
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <input type="number" class="form-control overall_discount" id="overall_discount" name="overall_discount" oninput="overall_discounts()" pattern="[0-9]{0,100}" title="Numbers Only" value="<?php echo e($delivery_note->overall_discount); ?>">
                      </div>
                    </div>
                  ...
                  <div class="form-group row">
                    ...
                    <?php endif; ?>
                       ...
                       <div class="col-md-12" style="float: right;">
                        ...
                        <font color="black" style="font-size: 150%; margin-left: 700px; font-weight: 900;">NET Value :</font>&nbsp;<font class="total_net_value" style="font-size: 150%; font-weight: 900;"><?php echo e($delivery_note->total_net_value); ?></font> 
                       </div>
                    <!-- net value -->
                      ...
                      <input type="text" class="form-control round_off" readonly="" value="<?php echo e($delivery_note->round_off); ?>" id="round_off" name="round_off" >
                      </div>
...
$(document).on("click",".remove_items",function(){
    ...
    $.ajax({
           type: "GET",
            url: "<?php echo e(url('delivery_note/remove_data/{id}')); ?>",
...
if(append_value == 1)
{
  var row_id=$('#last').val();
      ...
      $.ajax({  
        ...
        type: "GET",
        url: "<?php echo e(url('delivery_note/getdata/{id}')); ?>",
        data: { id: item_code },             
      ...
      $.ajax({
           type: "POST",
            url: "<?php echo e(url('delivery_note/last_purchase_rate/')); ?>",
            data: { id: item_code },
           success: function(data) {
...
var row_id=$('#last').val();
      ...
      $.ajax({  
        ...
        type: "GET",
        url: "<?php echo e(url('delivery_note/getdata_item/{id}')); ?>",
        data: { id: item_code },             
...
function item_with_same_data(item_code)
{
  $.ajax({
        ...
        type: "GET",
        url: "<?php echo e(url('delivery_note/same_items/{id}')); ?>",
        data: { id: item_code },
...
function browse_item()
{
  ...
  $.ajax({  
        ...
        type: "GET",
        url: "<?php echo e(url('delivery_note/browse_item/{id}')); ?>",
...
function categories_check()
{
  ...
  $.ajax({  
        ...
        type: "GET",
        url: "<?php echo e(url('delivery_note/change_items/{id}')); ?>",
...
function brand_check()
{
  ...
  $.ajax({
        ...
        type: "POST",
        url: "<?php echo e(url('delivery_note/brand_filter/')); ?>",
        data: {brand: brand },             
...
function customer_details()
{
  ...
  $.ajax({
           type: "POST",
            url: "<?php echo e(url('delivery_note/address_details/')); ?>",
...
function so_details()
{
  ...
  $.ajax({
           type: "POST",
            url: "<?php echo e(url('delivery_note/so_details/')); ?>",
            data: { so_no : so_no },
           success: function(data) {
            $('.tables').remove();
            $('.expense').remove();
...
function rejection_in_details()
{
  ...
  $.ajax({
           type: "POST",
            url: "<?php echo e(url('delivery_note/rejection_in_details/')); ?>",
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ns_pollachi\resources\views/admin/delivery_note/edit.blade.php ENDPATH**/ ?>
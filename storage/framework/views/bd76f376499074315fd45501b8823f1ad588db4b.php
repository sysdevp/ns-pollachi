...
<div class="col-12 body-sec">
  <div class="card container px-0">
    ...
    <div class="card-body">
      ...
      <form  method="post" class="form-horizontal needs-validation" novalidate action="<?php echo e(url('master/location/update/'.$location->id)); ?>" enctype="multipart/form-data">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-6">
                <select class="js-example-basic-multiple form-control col-12 custom-select location_type_id" name="location_type_id" required>
                  ...
                  <option value="<?php echo e($value->id); ?>" <?php echo e(old('location_type_id',$location->location_type_id) == $value->id ? 'selected' : ''); ?>><?php echo e($value->name); ?></option>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ns_pollachi\resources\views/admin/master/location/edit.blade.php ENDPATH**/ ?>
      ...
      <div class="row">
        ...
        <div class="col-8 mr-auto">
          <ul class="h-right-btn mb-0 pl-0">
            <li><button type="button" class="btn btn-success"><a href="<?php echo e(route('receivable_billwise.index')); ?>">Back</a></button></li>
          </ul>
        </div>
      </div>
    </div>
...
#receivable_bill_wrapper div.dt-buttons {
  z-index: 10;
    ...
    <div class="card-body">
      ...
      <form  method="post" class="form-horizontal needs-validation" novalidate action="<?php echo e(route('receivable_billwise.store')); ?>" enctype="multipart/form-data">
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ns_pollachi\resources\views/admin/outstanding/receivables/billwise/bill.blade.php ENDPATH**/ ?>
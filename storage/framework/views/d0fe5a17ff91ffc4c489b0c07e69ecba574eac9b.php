...
<div class="col-12 body-sec">
  <div class="card container-fluid px-0">
    ...
    <div class="card-header px-2">
      <div class="row">
        <div class="col-4">
          <h3>Edit Rejection Out</h3>
        </div>
        <div class="col-8 mr-auto">
          <ul class="h-right-btn mb-0 pl-0">
            <li><button type="button" class="btn btn-success"><a href="<?php echo e(route('rejection_out.index')); ?>">Back</a></button></li>
          </ul>
        </div>
      </div>
    </div>
...
<form  method="post" class="form-horizontal" action="<?php echo e(route('rejection_out.update',$rejection_out->r_out_no)); ?>" id="dataInput" enctype="multipart/form-data">
      ...
      <?php echo method_field('PATCH'); ?>
                  ...
                  <div class="form-group row">
                     <div class="col-sm-8">
                      <select class="js-example-basic-multiple col-12 form-control custom-select supplier_id" onchange="supplier_details()" name="supplier_id" id="supplier_id">
                           <?php if(isset($rejection_out->supplier->name) && !empty($rejection_out->supplier->name)): ?>
                           <option value="<?php echo e($rejection_out->supplier->id); ?>"><?php echo e($rejection_out->supplier->name); ?></option>
                           <?php else: ?>
               ...
               <div class="col-md-2">
                                  ...
                                  <div class="">
                                    <input type="hidden" readonly="" id="voucher_no" name="voucher_no" value="<?php echo e($rejection_out->r_out_no); ?>">
                                    <font size="2"><?php echo e($rejection_out->r_out_no); ?></font>
                                  </div>
                                ...
                                <input type="date" class="form-control voucher_date  required_for_proof_valid" id="voucher_date" placeholder="Voucher Date" name="voucher_date" value="<?php echo e($rejection_out->r_out_date); ?>">
                        ...
                        <div class="col-md-2">
                                ...
                                <option value="<?php echo e($rejection_out->p_no); ?>"><?php echo e($rejection_out->p_no); ?></option>
                        ...
                        <div class="col-md-2">
                                ...
                                <input type="date" class="form-control p_date  required_for_proof_valid" readonly="" id="p_date" placeholder="Voucher Date" name="p_date" value="<?php echo e($rejection_out->p_date); ?>">
      ...
      <div class="row col-md-12">
        ...
        <div class="col-md-2">
          ...
          <input type="hidden" class="form-control items_codes  required_for_proof_valid" placeholder="Item Code" id="items_codes" name="items_codes" value="">
                    ...
                    <div class="row col-md-12">
                      <div class="col-md-2 display_remarks" style="display: none;">
                ...
                <table class="table" id="team-list">
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <input type="number" class="form-control overall_discount" id="overall_discount" name="overall_discount" oninput="overall_discounts()" pattern="[0-9]{0,100}" title="Numbers Only" value="<?php echo e($rejection_out->overall_discount); ?>">
                      </div>
                    </div>
                    ...
                    <!-- <div class="row col-md-12">
                        ...
                        <div class="row col-md-12 append_expense">
                          ...
                          <?php $__currentLoopData = $rejection_out_expense; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <div class="form-group row">
                    ...
                    <?php endif; ?>
                      ...
                      <input type="text" class="form-control round_off" readonly="" value="<?php echo e($rejection_out->round_off); ?>" id="round_off" name="round_off" >
                      </div>
                      ...
                      <div class="col-md-4" style="float: right;">
                        ...
                        <font color="black" style="font-size: 150%; margin-left: 100px; font-weight: 900;">NET Value :</font>&nbsp;<font class="total_net_value" style="font-size: 150%; font-weight: 900;"><?php echo e($rejection_out->total_net_value); ?></font> 
                       </div>
  ...
  if($('.p_no').val() != '')
{
  ...
  $.ajax({
           type: "POST",
            url: "<?php echo e(url('rejection_out/check_qty/')); ?>",
...
if(append_value == 1)
{
  var row_id=$('#last').val();
      ...
      $.ajax({  
        ...
        type: "GET",
        url: "<?php echo e(url('rejection_out/getdata/{id}')); ?>",
        data: { id: item_code },             
      ...
      $.ajax({
           type: "POST",
            url: "<?php echo e(url('rejection_out/last_purchase_rate/')); ?>",
            data: { id: item_code },
           success: function(data) {
...
var row_id=$('#last').val();
      ...
      $.ajax({  
        ...
        type: "GET",
        url: "<?php echo e(url('rejection_out/getdata_item/{id}')); ?>",
        data: { id: item_code },             
...
function item_with_same_data(item_code)
{
  $.ajax({
        ...
        type: "GET",
        url: "<?php echo e(url('rejection_out/same_items/{id}')); ?>",
        data: { id: item_code },
...
function browse_item()
{
  ...
  $.ajax({  
        ...
        type: "GET",
        url: "<?php echo e(url('rejection_out/browse_item/{id}')); ?>",
...
function categories_check()
{
  ...
  $.ajax({  
        ...
        type: "GET",
        url: "<?php echo e(url('rejection_out/change_items/{id}')); ?>",
...
function brand_check()
{
  ...
  $.ajax({
        ...
        type: "POST",
        url: "<?php echo e(url('rejection_out/brand_filter/')); ?>",
        data: {brand: brand },             
...
function supplier_details()
{
  ...
  $.ajax({
           type: "POST",
            url: "<?php echo e(url('rejection_out/address_details/')); ?>",
...
function p_details()
{
  ...
  $.ajax({
           type: "POST",
            url: "<?php echo e(url('rejection_out/p_details/')); ?>",
            data: { p_no : p_no },
           success: function(data) {
            $('.tables').remove();
            $('.expense').remove();
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ns_pollachi\resources\views/admin/rejection_out/edit.blade.php ENDPATH**/ ?>
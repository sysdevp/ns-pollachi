...
<div class="col-12 body-sec">
  <div class="card container px-0">
    ...
    <div class="card-body">
      ...
      novalidate action="<?php echo e(url('master/agent/store')); ?>" enctype="multipart/form-data">
      <?php echo e(csrf_field()); ?>
        ...
        <div class="form-row">
          ...
          <div class="col-md-6">
            ...
            <input type="text" class="form-control required_for_valid name caps" name="name" error-data="Agent Name Field is required" onchange="checkname()" aria-label="Text input with dropdown button" value=<?php echo e(old('name')); ?>>
...
<div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control code only_allow_alp_num_dot_com_amp required_for_valid" error-data="Enter valid Agent Code" placeholder="Agent Code" name="code" value="<?php echo e(old('code')); ?>" >
 ...
 <div class="col-md-8">
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control father_name required_for_valid caps" error-data="Enter valid Father's Name" placeholder="Father's Name" name="father_name" value="<?php echo e(old('father_name')); ?>">
                ...
                <table class="table">
                  ...
                  <tbody class="append_proof_details">
                   ...
                   <td>
                            <div class="form-group row">
                              <div class="col-sm-12">
                              <input type="text" class="form-control proof_number only_allow_alp_num_dot_com_amp required_for_proof_valid" error-data="Enter valid Postal Code" placeholder="Proof Number" name="proof_number[]" value="<?php echo e(old('proof_number.0')); ?>" >
            ...
            <tr>
             ...
             <td>
                    ...
                    <td>
                        <div class="form-group row">
                          <div class="col-sm-12">
                          <input type="file" class="form-control proof_file only_allow_digit  required_for_proof_valid" error-data="Enter valid Postal Code" placeholder="Proof Name" name="proof_file[]" value="<?php echo e(old('proof_file.'.$key)); ?>" >
 ...
 function checkname()
  {
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo e(url('master/agent/checkname/')); ?>",
        data: {name: name,},
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ns_pollachi\resources\views/admin/master/agent/add.blade.php ENDPATH**/ ?>
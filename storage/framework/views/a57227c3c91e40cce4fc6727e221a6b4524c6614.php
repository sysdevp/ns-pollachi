...
<form  method="post" class="form-horizontal" action="<?php echo e(route('purchase_gatepass_entry.update',$purchase_gatepass->purchase_gatepass_no)); ?>" id="dataInput" enctype="multipart/form-data">
      ...
      <?php echo method_field('PATCH'); ?>
                       ...
                       <div class="row col-md-12">
                                ...
                                <div class="col-md-2">
                                  ...
                                  <div class="">
                                    <input type="hidden" readonly="" class="form-control proof_file  required_for_proof_valid" id="voucher_no" placeholder="Auto Generate Voucher No" name="voucher_no" value="<?php echo e($purchase_gatepass->purchase_gatepass_no); ?>">
                                    <font size="2"><?php echo e($purchase_gatepass->purchase_gatepass_no); ?></font>
                                  </div>
                                ...
                                <input type="date" class="form-control voucher_date  required_for_proof_valid" id="voucher_date" placeholder="Voucher Date" name="voucher_date" value="<?php echo e($purchase_gatepass->purchase_gatepass_date); ?>">
                                ...
                                <option value="<?php echo e($purchase_gatepass->po_no); ?>"><?php echo e($purchase_gatepass->po_no); ?></option>
                                ...
                                <input type="date" class="form-control po_date  required_for_proof_valid" id="po_date" placeholder="Purchase Order Date" name="po_date" value="<?php echo e($purchase_gatepass->po_date); ?>">
                                ...
                                <option value="<?php echo e($purchase_gatepass->estimation_no); ?>"><?php echo e($purchase_gatepass->estimation_no); ?></option>
                                ...
                                <input type="date" class="form-control estimation_date  required_for_proof_valid" id="estimaton_date" placeholder="Estimaton Date" name="estimation_date" value="<?php echo e($purchase_gatepass->estimation_date); ?>">
                  ...
                  <div class="form-group row">
                     <div class="col-sm-8">
                      <select class="js-example-basic-multiple col-12 form-control custom-select supplier_id" onchange="supplier_details()" name="supplier_id" id="supplier_id">
                           <option value="<?php echo e($purchase_gatepass->supplier->id); ?>"><?php echo e($purchase_gatepass->supplier->name); ?></option>
              ...
              <div class="row col-md-12">
                      ...
                      <input type="text" class="form-control" name="load_bill" id="load_bill" placeholder="Load Bill" value="<?php echo e($purchase_gatepass->load_bill); ?>">
                      </div>

                      <div class="col-md-2">
                      <label style="font-family: Times new roman;">Unload Bill</label><br>
                      <input type="text" class="form-control" name="unload_bill" id="unload_bill" placeholder="Unload Bill" value="<?php echo e($purchase_gatepass->unload_bill); ?>">
                      </div>
                      
                      <div class="col-md-2">
                      <label style="font-family: Times new roman;">Load Live</label><br>
                      <input type="text" class="form-control" name="load_live" id="load_live" placeholder="Load Live" value="<?php echo e($purchase_gatepass->load_live); ?>">
                      </div>

                      <div class="col-md-2">
                      <label style="font-family: Times new roman;">Unload Live</label><br>
                      <input type="text" class="form-control" name="unload_live" id="unload_live" placeholder="Unload Live" value="<?php echo e($purchase_gatepass->unload_live); ?>">
                      </div>          
...
function supplier_details()
{
  ...
  $.ajax({
           type: "POST",
            url: "<?php echo e(url('purchase_gatepass_entry/address_details/')); ?>",
...
function po_details()
{
  ...
  $.ajax({
           type: "POST",
            url: "<?php echo e(url('purchase_gatepass_entry/po_details/')); ?>",
            data: { po_no : po_no },
           success: function(data) {
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ns_pollachi\resources\views/admin/purchase_gatepass/edit.blade.php ENDPATH**/ ?>
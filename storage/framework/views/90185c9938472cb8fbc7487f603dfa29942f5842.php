  ...
  <div class="card container px-0">
    ...
    <div class="card-body">
      <div class="row col-md-12">
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> <?php echo e($sale_entry->s_no); ?></label>
          </div>
              </div>
          ...
          <div class="col-md-6">
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> <?php echo e($sale_entry->s_date); ?></label>
          </div>
              </div>
            </div>
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> <?php echo e($sale_entry->so_no); ?></label>
          </div>
              </div>
          ...
          <div class="col-md-6">
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> <?php echo e($sale_entry->so_date); ?></label>
          </div>
              </div>
            </div>
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> 
              ...
              <?php echo e($sale_entry->customer->name); ?>
          ...
          <div class="col-md-6">
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> 
              <?php if(isset($sale_entry->salesman->name) && !empty($sale_entry->salesman->name)): ?>
              <?php echo e($sale_entry->salesman->name); ?>
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> 
              <?php if($sale_entry->purchase_type == 1): ?>
              Cash Purchase
              <?php else: ?>
               Credit purchase
              <?php endif; ?>
...
<div class="form-row">
          ...
          <div class="col-md-6">
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> <?php echo e($sale_entry->overall_discount); ?></label>
          </div>
              </div>
            </div>
        ...
        <table class="table table-bordered table-responsive" style="width: 100%; height: 100%;">
          <thead>
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> <?php echo e($sale_entry->round_off); ?></label>
          </div>
              </div>
          ...
          <div class="col-md-6">
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> <?php echo e($sale_entry->total_net_value); ?></label>
          </div>
              </div>
            </div>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ns_pollachi\resources\views/admin/sales_entry/show.blade.php ENDPATH**/ ?>
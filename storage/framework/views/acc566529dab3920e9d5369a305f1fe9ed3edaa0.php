        ...
        <div class="form-row">
         <div class="col-md-8">
          ...
          <div class="col-md-6">
            ...
            <input type="text" class="form-control required_for_valid only_allow_alp_numeric name caps" name="name" error-data="Employee Name Field is required" aria-label="Text input with dropdown button" value=<?php echo e(old('name')); ?>>
 ...
 <div class="col-md-8">
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control father_name only_allow_alp_numeric required_for_valid caps" error-data="Enter valid Father's Name" placeholder="Father's Name" name="father_name" value="<?php echo e(old('father_name')); ?>">

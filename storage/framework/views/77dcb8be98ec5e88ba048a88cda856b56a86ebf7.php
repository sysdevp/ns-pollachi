...
<div class="col-12 body-sec">
  <div class="card container px-0">
    ...
    <div class="card-body">
      ...
      <form method="post" class="form-horizontal needs-validation" novalidate action="<?php echo e(url('master/district/store')); ?>" enctype="multipart/form-data">
        ...
        <div class="form-row">
          <div class="col-md-8">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control name only_allow_alp_num_dot_com_amp caps" placeholder="District Name" name="name" value="<?php echo e(old('name')); ?>" required>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ns_pollachi\resources\views/admin/master/district/add.blade.php ENDPATH**/ ?>
...
<div class="col-12 body-sec">
   <div class="card container-fluid px-0">
      ...
      <!-- card header end@ -->
      <div class="card-body">
         <form  method="post" class="form-horizontal needs-validation submit_form" autocomplete="off" novalidate action="<?php echo e(url('master/item/store')); ?>" enctype="multipart/form-data">
            ...
            <div class="form-row mb-6">
               ...
               <div class="col-md-6">
                  <div class="form-group row">
                     ...
                     <div class="col-sm-8">
                        <input type="text" class="form-control code only_allow_alp_num_dot_com_amp" placeholder="Item Code" name="code" value="<?php echo e(old('code')); ?>" required>
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-sm-6">
                        <select class="js-example-basic-multiple col-12 form-control custom-select brand_id" name="brand_id" required>
                           ...
                           <option value="0" <?php echo e(old('brand_id') == "0" ? 'selected' : ''); ?>> Not Applicable </option>
                           ...
                           <option value="<?php echo e($value->id); ?>" <?php echo e(old('brand_id') == $value->id ? 'selected' : ''); ?>  ><?php echo e($value->name); ?></option>
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-sm-6">
                        <select class="js-example-basic-multiple col-12 form-control custom-select category_id" name="category_id" required>
                           ...
                           <option value="<?php echo e($value->id); ?>" <?php echo e(old('category_id') == $value->id ? 'selected' : ''); ?>  ><?php echo e($value->name); ?></option>
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-sm-8">
                        <select class="js-example-basic-multiple col-12 form-control custom-select item_type" name="item_type" required>
                           ...
                           <option value="Direct" selected  <?php echo e(old('item_type') == "Direct" ? 'selected' : ''); ?>  >Direct</option>
                           <option value="Bulk" <?php echo e(old('item_type') == "Bulk" ? 'selected' : ''); ?>  >Bulk</option>
                           <option value="Repack" <?php echo e(old('item_type') == "Repack" ? 'selected' : ''); ?>  >Repack</option>
                           <option value="Parent" <?php echo e(old('item_type') == "Parent" ? 'selected' : ''); ?>  >Parent</option>
                           <!--<option value="Child" <?php echo e(old('item_type') == "Child" ? 'selected' : ''); ?>  >Child</option>
                              -->    
                        </select>
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-sm-6">
                        <select class="js-example-basic-multiple col-12 form-control custom-select child_item_id" name="child_item_id">
                           ...
                           <option value="<?php echo e($value->id); ?>" <?php echo e(old('child_item_id') == $value->id ? 'selected' : ''); ?>  ><?php echo e($value->name); ?></option>
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
               ...
               <div class="col-md-6 child_div" style="display:none">
                  <div class="form-group row">
                     ...
                     <div class="col-sm-8">
                        <input type="text" class="form-control child_unit only_allow_digit_and_dot" placeholder="Units" name="child_unit" value="<?php echo e(old('child_unit')); ?>" >
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-sm-6">
                        <select class="js-example-basic-multiple col-12 form-control custom-select  uom_for_repack_item" name="uom_for_repack_item" required>
                           ...
                           <option value="<?php echo e($value->id); ?>" <?php echo e(old('uom_for_repack_item') == $value->id ? 'selected' : ''); ?>  ><?php echo e($value->name); ?></option>
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <span class="mandatory"> <?php echo e($errors->first('uom_for_repack_item')); ?> </span>
                        <div class="invalid-feedback">
                           Enter valid UOM for Repack Item
                        </div>
                     </div>
                     <a href="<?php echo e(url('master/uom/create')); ?>" target="_blank">
               ...
               <div class="col-md-6">
                  <div class="form-group row">
                     ...
                     <div class="col-sm-8">
                        <input type="text" class="form-control weight_in_grams only_allow_digit_and_dot" placeholder="Weight In Grams " name="weight_in_grams" value="<?php echo e(old('weight_in_grams')); ?>" >
               ...
               <div class="col-md-6">
                  <div class="form-group row">
                     ...
                     <div class="col-sm-8">
                        <input type="text" class="form-control print_name_in_english only_allow_alp_num_dot_com_amp" placeholder="Print Name in English " name="print_name_in_english" value="<?php echo e(old('print_name_in_english')); ?>" required>
               ...
               <div class="col-md-6">
                  <div class="form-group row">
                     ...
                     <div class="col-sm-8">
                        <input type="text" class="form-control print_name_in_language_1 only_allow_alp_num_dot_com_amp" placeholder="Print Name in <?php echo e($language_1); ?>" name="print_name_in_language_1" value="<?php echo e(old('print_name_in_language_1')); ?>" >
               ...
               <div class="col-md-6">
                  <div class="form-group row">
                     ...
                     <div class="col-sm-8">
                        <input type="text" class="form-control print_name_in_language_2 only_allow_alp_num_dot_com_amp" placeholder="Print Name in <?php echo e($language_2); ?>" name="print_name_in_language_2" value="<?php echo e(old('print_name_in_language_2')); ?>" >
               ...
               <div class="col-md-6">
                  <div class="form-group row">
                     ...
                     <div class="col-sm-8">
                        <input type="text" class="form-control print_name_in_language_3 only_allow_alp_num_dot_com_amp" placeholder="Print Name in <?php echo e($language_3); ?>" name="print_name_in_language_3" value="<?php echo e(old('print_name_in_language_3')); ?>">
               ...
               <!-- <div class="col-md-6">
                  <div class="form-group row">
                     ...
                     <div class="col-sm-8">
                        <input type="text" class="form-control ptc only_allow_alp_num_dot_com_amp" placeholder="PTC Code" name="ptc" value="<?php echo e(old('ptc')); ?>" required>
               ...
               <div class="col-md-6">
                  <div class="form-group row">
                     ...
                     <div class="col-sm-8">
                        <input type="text" class="form-control hsn only_allow_alp_num_dot_com_amp" placeholder="Hsn Code" name="hsn" value="<?php echo e(old('hsn')); ?>">
               ...
               <div class="col-md-6">
                  <div class="form-group row">
                     ...
                     <div class="col-sm-8">
                        <input type="text" class="form-control only_allow_digit_and_dot mrp only_allow_alp_num_dot_com_amp" placeholder="MRP" name="mrp" value="<?php echo e(old('mrp')); ?>" required>
               ...
               <div class="col-md-6">
                  <div class="form-group row">
                     ...
                     <div class="col-sm-8">
                        <input type="text" class="form-control only_allow_digit_and_dot default_selling_price only_allow_alp_num_dot_com_amp" placeholder="Default Selling Price" name="default_selling_price" value="<?php echo e(old('default_selling_price')); ?>" required>
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-sm-6">
                        <select class="js-example-basic-multiple col-12 form-control custom-select uom_id" name="uom_id" required>
                           <option value="">Choose UOM</option>
                           <?php $__currentLoopData = $uom; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                           <option value="<?php echo e($value->id); ?>" <?php echo e(old('uom_id') == $value->id ? 'selected' : ''); ?>  ><?php echo e($value->name); ?></option>
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-sm-8">
                        <div class="form-check d-inline">
                           ...
                           <input type="radio" class="form-check-input is_machine_weight_applicable" value ="1" <?php echo e(old('is_machine_weight_applicable') == 1 ? 'checked' : ''); ?> name="is_machine_weight_applicable">Yes
                           </label>
                        </div>
                        <div class="form-check d-inline">
                           <label class="form-check-label">
                           <input type="radio" class="form-check-input is_machine_weight_applicable" value ="0" <?php echo e(old('is_machine_weight_applicable') == 0 ? 'checked' : ''); ?> name="is_machine_weight_applicable">No
                           </label>
                        </div>
                        <span class="mandatory"> <?php echo e($errors->first('machine_weight_applicable')); ?> </span>
                        <div class="invalid-feedback">
               ...
               <div class="col-md-6">
                  <div class="form-group row">
                     ...
                     <div class="col-sm-8">
                        <div class="form-check d-inline">
                           <label class="form-check-label">
                           <input type="radio" class="form-check-input is_expiry_date" value ="1" <?php echo e(old('is_expiry_date') == 1 ? 'checked' : ''); ?> name="is_expiry_date">Yes
                           </label>
                        </div>
                        <div class="form-check d-inline">
                           <label class="form-check-label">
                           <input type="radio" class="form-check-input is_expiry_date" value ="0" <?php echo e(old('is_expiry_date') == 0 ? 'checked' : ''); ?> name="is_expiry_date">No
                           </label>
                        </div>
                        <span class="mandatory"> <?php echo e($errors->first('uom_id')); ?> </span>
                        <div class="invalid-feedback">
               ...
               <div class="col-md-6 expiry_date_div" style="display: none">
                  <div class="form-group row">
                     ...
                     <div class="col-sm-8">
                        <input type="text" class="form-control expiry_date" placeholder="Expiry Date" name="expiry_date" value="<?php echo e(old('expiry_date')); ?>">
               ...
               <div class="col-md-6">
                  <div class="form-group row">
                     ...
                     <div class="col-sm-8">
                        <div class="form-check d-inline">
                           <label class="form-check-label">
                           <input type="radio" class="form-check-input is_minimum_sales_qty_applicable" value ="1" <?php echo e(old('is_minimum_sales_qty_applicable') == 1 ? 'checked' : ''); ?> name="is_minimum_sales_qty_applicable">Yes
                           </label>
                        </div>
                        <div class="form-check d-inline">
                           <label class="form-check-label">
                           <input type="radio" class="form-check-input is_minimum_sales_qty_applicable" value ="0" <?php echo e(old('is_minimum_sales_qty_applicable') == 0 ? 'checked' : ''); ?> name="is_minimum_sales_qty_applicable">No
                           </label>
                        </div>
               ...
               <div class="col-md-6 minimum_sales_div" style="display: none">
                  <div class="form-group row">
                     ...
                     <div class="col-sm-8">
                        <input type="text" class="form-control minimum_sales_qty" placeholder="Minimum Sales Qty" name="minimum_sales_qty" value="<?php echo e(old('minimum_sales_qty')); ?>">
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-sm-6">
                        <select class="js-example-basic-multiple col-12 form-control custom-select  uom_for_minimum_sales_item" name="uom_for_minimum_sales_item">
                           <option value="">Choose UOM</option>
                           <?php $__currentLoopData = $uom; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                           <option value="<?php echo e($value->id); ?>" <?php echo e(old('uom_for_minimum_sales_item') == $value->id ? 'selected' : ''); ?>  ><?php echo e($value->name); ?></option>
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <span class="mandatory"> <?php echo e($errors->first('uom_for_minimum_sales_item')); ?> </span>
                        <div class="invalid-feedback">
                           Enter valid UOM 
                        </div>
                     </div>
               ...
               <div class="col-md-6 minimum_sales_div" style="display: none">
                  <div class="form-group row">
                     ...
                     <div class="col-sm-8">
                        <input type="text" class="form-control minimum_sales_price" placeholder="Minimum Sales Price" name="minimum_sales_price" value="<?php echo e(old('minimum_sales_price')); ?>">
               ...
               <div class="col-md-6 mb-3">
                  <div class="form-group row">
                     ...
                     <div class="col-sm-6">
                        <select class="js-example-basic-multiple col-12 form-control custom-select supplier_id" name="supplier_id">
                           ...
                           <option value="<?php echo e($value->id); ?>" <?php echo e(old('supplier_id') == $value->id ? 'selected' : ''); ?>  ><?php echo e($value->name); ?></option>
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                  ...
                  <div class="row mb-3 opening_row">
                     ...
                     <label for="validationCustom01" class="">Batch No</label>
                       ...
                       <span class="mandatory"> <?php echo e($errors->first('batch_no')); ?> </span>
                     <div class="invalid-feedback">
                  ...
                  <!-- <div class="form-group row"> -->
                     ...
                     <!-- <div class="col-sm-8"> -->
                       <input type="date" name="applicable_date[]" value="<?php echo e($date); ?>" class="form-control applicable_date" >
                     <!-- /div>
               ...
               <table class="table">
                  ...
                  <tbody class="append_row">
                     <tr class="row_count">
                        ...
                        <td>
                           <div class="col-sm-12">
                              <input type="text" class="form-control <?php echo e($value->name); ?>_id only_allow_digit_and_dot common" name="<?php echo e($value->name); ?>_id[]"  placeholder="<?php echo e($value->name); ?>" id="<?php echo e($value->name); ?>_id<?php echo e($key); ?>" value="0" required>
                        ...
                        <!-- <td>
                           <div class="col-sm-12">
                              <input type="text" class="form-control cgst only_allow_digit_and_dot" name="cgst[]" readonly placeholder="CGST" value="<?php echo e(old('cgst.0')); ?>" required>
                              <span class="mandatory"> <?php echo e($errors->first('cgst.0')); ?> </span>
                              <div class="invalid-feedback">
                                 Enter valid CGST
                              </div>
                           </div>
                        ...
                        <td>
                           <div class="col-sm-12">
                              <input type="text" class="form-control sgst only_allow_digit_and_dot" name="sgst[]" readonly placeholder="SGST" value="<?php echo e(old('sgst.0')); ?>" required>
                              <span class="mandatory"> <?php echo e($errors->first('sgst.0')); ?> </span>
                              <div class="invalid-feedback">
                                 Enter valid SGST
                              </div>
                           </div>
                        ...
                        <td>
                           <div class="col-sm-12">
                              <input type="text" class="form-control valid_from" name="valid_from[]" placeholder="dd-mm-yyyy" value="<?php echo e(old('valid_from.0')); ?>" required>
                              <span class="mandatory">  </span>
                              <div class="invalid-feedback">
               ...
               <table class="table">
                  ...
                  <tbody class="append_barcode_dets">
                     <tr class="tables">
                        ...
                        <td>
                           <div class="col-sm-12">
                              <input type="text" class="form-control barcode" name="barcode[]"  placeholder="Barcode" id="barcode0" value="<?php echo e(old('barcode.0')); ?>" onchange="testing(0)" required>
                              <input type="hidden" id="num0" value="0">
                              <span class="mandatory"> <?php echo e($errors->first('barcode.0')); ?> </span>
                              <div class="invalid-feedback">
                                 Enter valid Barcode
                              </div>
                           </div>
                        ...
                        <td>
                           <div class="col-sm-12">
                              <input type="text" class="form-control confirm_barcode" name="barcode_confirmation[]"  placeholder="Confirm Barcode" oninput="confirm_barcode()" value="<?php echo e(old('barcode_confirmation.0')); ?>" required>
                              <span class="mandatory"> <?php echo e($errors->first('barcode_confirmation.0')); ?> </span>
                              <div class="invalid-feedback">
                     ...
                     <?php if($old_barcode_key >0): ?>
                     <tr class="tables">
                        <td class="barcode_s_no">1</td>
                        <td>
                           <div class="col-sm-12">
                              <input type="text" class="form-control barcode" name="barcode[]"  placeholder="Barcode" id="barcode0" onchange="testing(0)" value="<?php echo e(old('barcode.'.$old_barcode_key)); ?>" required>
                              <input type="hidden" id="num0" value="0">
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ns_pollachi\resources\views/admin/master/item/add.blade.php ENDPATH**/ ?>
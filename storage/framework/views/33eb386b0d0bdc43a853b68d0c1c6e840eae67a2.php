        ...
        <div class="form-row">
          ...
          <div class="col-md-12">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
              <input type="text" class="form-control name only_allow_alp_num_dot_com_amp caps" placeholder="Role Name" name="name" value="<?php echo e(old('name')); ?>" required>
          ...
          <div class="col-12 col-sm-12 col-md-12">
              <div class="form-group row">
                  ...
                  <?php if($class != $value->class): ?>
                  <label class="w-20"> 
                      <input type="checkbox" name="permission[]" class="all_<?php echo e($value->class); ?>_master all_classname permission"  value="<?php echo e($value->class); ?>">  
                     ALL
                </label>
              <?php endif; ?> 
               ...
               <label class="w-20"> 
                      <input type="checkbox" name="permission[]" class="<?php echo e($value->class); ?> permission"  value="<?php echo e($value->id); ?>">  

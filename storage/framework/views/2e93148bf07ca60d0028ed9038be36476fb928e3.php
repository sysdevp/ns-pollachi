      ...
      <div class="form-row">
        ...
        <div class="col-md-6">
          <div class="form-group row">
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"><?php echo e($location->gst_number); ?> </label>
          </div>
        </div>
        <div class="col-md-7">
          <div class="form-group row">
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ns_pollachi\resources\views/admin/master/ho_details/show.blade.php ENDPATH**/ ?>
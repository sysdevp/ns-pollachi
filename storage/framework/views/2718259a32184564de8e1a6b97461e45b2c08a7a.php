      ...
      <div class="row">
        ...
        <div class="col-8 mr-auto">
          <ul class="h-right-btn mb-0 pl-0">
            <li><button type="button" class="btn btn-success"><a href="<?php echo e(url('sales_estimation/index/0')); ?>">Back</a></button></li>
          </ul>
        </div>
      </div>
    </div>
...
<form  method="post" class="form-horizontal" action="<?php echo e(route('sales_estimation.update',$sale_estimation->sale_estimation_no)); ?>" id="dataInput" enctype="multipart/form-data">
      ...
      <?php echo method_field('PATCH'); ?>
                       ...
                       <div class="row col-md-10">
                                ...
                                <div class="col-md-2">
                                  ...
                                  <div class="">
                                    <input type="hidden" readonly="" id="voucher_no" name="voucher_no" value="<?php echo e($sale_estimation->sale_estimation_no); ?>">
                                    <font size="2"><?php echo e($sale_estimation->sale_estimation_no); ?></font>
                                  </div>
                                ...
                                <input type="date" class="form-control voucher_date  required_for_proof_valid" id="voucher_date" placeholder="Voucher Date" name="voucher_date" value="<?php echo e($sale_estimation->sale_estimation_date); ?>">
                  ...
                  <div class="form-group row">
                     <div class="col-sm-8">
                      <select class="js-example-basic-multiple col-12 form-control custom-select customer_id" onchange="customer_details()" name="customer_id" id="customer_id">
                        <?php if(isset($sale_estimation->customer->name) && !empty($sale_estimation->customer->name)): ?>
                           <option value="<?php echo e($sale_estimation->customer->id); ?>"><?php echo e($sale_estimation->customer->name); ?></option>
                           <?php else: ?>
                  ...
                  <div class="form-group row">
                     <div class="col-sm-8">
                      <select class="js-example-basic-multiple col-12 form-control custom-select salesmen_id" name="salesmen_id" id="salesmen_id">
                           <?php if(isset($sale_estimation->salesman->name) && !empty($sale_estimation->salesman->name)): ?>
                           <option value="<?php echo e($sale_estimation->salesman->id); ?>"><?php echo e($sale_estimation->salesman->name); ?></option>
                           <?php else: ?>
                  ...
                  <div class="form-group row">
                     <div class="col-sm-8">
                      <select class="js-example-basic-multiple col-12 form-control custom-select agent_id" name="agent_id" id="agent_id" >
                           <?php if(isset($sale_estimation->agent->name) && !empty($sale_estimation->agent->name)): ?>
                           <option value="<?php echo e($sale_estimation->agent->id); ?>"><?php echo e($sale_estimation->agent->name); ?></option>
                           <?php else: ?>
                     ...
                     <a href="<?php echo e(url('master/agent/create')); ?>" target="_blank">
...
<div class="form-row">
              ...
              <div class="col-md-12" id="middlecol">
                ...
                <table class="table" id="team-list">
                  ...
                  <input type="hidden" name="total_price" value="<?php echo e($sale_estimation->total_net_value); ?>" id="total_price">
                  <input type="hidden" name="last_purchase_rate" value="0" id="last_purchase_rate">

                  <?php $__currentLoopData = $sale_estimation_item; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <input type="number" class="form-control overall_discount" id="overall_discount" name="overall_discount" oninput="overall_discounts()" pattern="[0-9]{0,100}" title="Numbers Only" value="<?php echo e($sale_estimation->overall_discount); ?>">
                      </div>
                    </div>
                    ...
                    <!-- <div class="row col-md-12">
                        ...
                        <div class="row col-md-12 append_expense">
                          ...
                          <?php $__currentLoopData = $sale_estimation_expense; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <div class="form-group row">
                    ...
                    <?php endif; ?>
                       ...
                       <div class="col-md-12" style="float: right;">
                        ...
                        <font color="black" style="font-size: 150%; margin-left: 700px; font-weight: 900;">NET Value :</font>&nbsp;<font class="total_net_value" style="font-size: 150%; font-weight: 900;"><?php echo e($sale_estimation->total_net_value); ?></font> 
                       </div>
                    <!-- net value -->
                      ...
                      <input type="text" class="form-control round_off" readonly="" value="<?php echo e($sale_estimation->round_off); ?>" id="round_off" name="round_off" >
                      </div>
...
$(document).on("click",".remove_items",function(){
    ...
    $.ajax({
           type: "GET",
            url: "<?php echo e(url('sales_estimation/remove_data/{id}')); ?>",
...
if(append_value == 1)
{
  var row_id=$('#last').val();
      ...
      $.ajax({  
        ...
        type: "GET",
        url: "<?php echo e(url('sales_estimation/getdata/{id}')); ?>",
        data: { id: item_code },             
      ...
      $.ajax({
           type: "POST",
            url: "<?php echo e(url('sales_estimation/last_purchase_rate/')); ?>",
            data: { id: item_code },
           success: function(data) {
...
function item_with_same_data(item_code)
{
  $.ajax({
        ...
        type: "GET",
        url: "<?php echo e(url('sales_estimation/same_items/{id}')); ?>",
        data: { id: item_code },
...
function browse_item()
{
  ...
  $.ajax({  
        ...
        type: "GET",
        url: "<?php echo e(url('sales_estimation/browse_item/{id}')); ?>",
...
function categories_check()
{
  ...
  $.ajax({  
        ...
        type: "GET",
        url: "<?php echo e(url('sales_estimation/change_items/{id}')); ?>",
...
function brand_check()
{
  ...
  $.ajax({
        ...
        type: "POST",
        url: "<?php echo e(url('sales_estimation/brand_filter/')); ?>",
        data: {brand: brand },             
...
function customer_details()
{
  ...
  $.ajax({
           type: "POST",
            url: "<?php echo e(url('sales_estimation/address_details/')); ?>",
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ns_pollachi\resources\views/admin/sales_estimation/edit.blade.php ENDPATH**/ ?>
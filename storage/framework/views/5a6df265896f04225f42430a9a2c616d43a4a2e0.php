...
<div class="col-12 body-sec">
  <div class="card container-fluid px-0">
    ...
    <div class="card-body">
      ...
      <form method="post" class="form-horizontal needs-validation" novalidate action="<?php echo e(url('master/customer/store')); ?>" enctype="multipart/form-data">
              ...
              <div class="col-sm-8">
                <div class="form-check d-inline">
                  <label class="form-check-label">
                    <input type="radio" class="form-check-input customer_type" value="1" <?php echo e(old('customer_type') == 1 ? 'checked' : ''); ?> name="customer_type">Exist
                  </label>
                </div>

                <div class="form-check d-inline mx-4 ">
                  <label class="form-check-label">
                    <input type="radio" class="form-check-input customer_type" value="0" <?php echo e(old('customer_type') == 0 ? 'checked' : ''); ?> name="customer_type">New
                  </label>
                </div>
...
<?php $__currentLoopData = $exist_customer_dets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($value->id); ?>" <?php echo e(old('exist_customer_name') == $value->id ? 'selected' : ''); ?> ><?php echo e($value->name); ?></option>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control pan_card required_for_valid" input-type="pan_card" error_data="Enter valid Pancard No" placeholder="Pan Card No" name="pan_card" value="<?php echo e(old('pan_card')); ?>">
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control max_credit_limit only_allow_digit required_for_valid" error_data="Enter valid Maximum Credit Limit" placeholder="Maximum Credit Limit" name="max_credit_limit" value="<?php echo e(old('max_credit_limit')); ?>">
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control max_credit_days only_allow_digit required_for_valid" error_data="Enter valid Maximum Credit Days" placeholder="Maximum Credit Days" name="max_credit_days" value="<?php echo e(old('max_credit_days')); ?>">
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control only_allow_digit required_for_valid" input-type="opening_balance" error_data="Enter valid Opening Balance" placeholder="Opening Balance" name="opening_balance" value="<?php echo e(old('opening_balance')); ?>">
...
<script>
  ...
  function checkname()
  {
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo e(url('master/customer/checkname/')); ?>",
        data: {name: name,},
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ns_pollachi\resources\views/admin/master/customer/add.blade.php ENDPATH**/ ?>
...
<div class="col-12 body-sec">
  <div class="card container px-0">
      ...
      <div class="row">
        ...
        <div class="col-8 mr-auto">
          <ul class="h-right-btn mb-0 pl-0">
            <li><button type="button" class="btn btn-success"><a href="<?php echo e(url('master/accounts-type')); ?>">Back</a></button></li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="card-body">
      ...
      <form  method="post" class="form-horizontal needs-validation" novalidate action="<?php echo e(url('master/accounts-type/store')); ?>" enctype="multipart/form-data">
        ...
        <div class="form-row">
          <div class="col-md-7">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control name only_allow_alp_num_dot_com_amp caps" placeholder="Accounts Type Name" name="name" value="<?php echo e(old('name')); ?>" required>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ns_pollachi\resources\views/admin/master/accounts_type/add.blade.php ENDPATH**/ ?>
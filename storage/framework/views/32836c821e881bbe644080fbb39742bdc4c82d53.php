...
<div class="col-12 body-sec">
  <div class="card container px-0">
      ...
      <div class="row">
        ...
        <div class="col-8 mr-auto">
          <ul class="h-right-btn mb-0 pl-0">
            <li><button type="button" class="btn btn-success"><a href="<?php echo e(route('cart.index')); ?>">Back</a></button></li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="card-body">
      ...
      <form  method="post" class="form-horizontal needs-validation" action="<?php echo e(route('cart.update',$cart->cart_id)); ?>" enctype="multipart/form-data">
         ...
         <!--  <div class="col-md-8">
          ...
          <div class="col-md-6">
            ...
            <div class="input-group">
                     ...
                     <input type="text" class="form-control" readonly placeholder="Gate Pass No" name="num" value="<?php echo e($gatepss_no); ?>">
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="date" class="form-control"  placeholder="Date"  name="date" value="<?php echo e($cart->date); ?>" >
         ...
         <!--  <div class="col-md-8">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-6">
                        <select class="js-example-basic-multiple col-12 form-control custom-select supplier_name required_for_valid" name="supplier_name">
                          <option value="<?php echo e($cart->suppliers_id); ?>"><?php echo e($cart->name); ?></option>
            ...
            <div class="input-group">
                     ...
                     <input type="text" class="form-control"   placeholder="Supplier Name" name="name" pattern="[a-z A-Z]{4,100}" title="Alphabetic Letters Only should be more than 3 letters" value="<?php echo e($cart->name); ?>">
                
                 <input type="hidden" name="supplier_name" value="<?php echo e($cart->suppliers_id); ?>">
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="hidden" name="value" value="<?php echo e($type_value); ?>">
                <?php if($cart->type == 1): ?>
         ...
         <!--  <div class="col-md-8">
          ...
          <div class="col-md-6">
            ...
            <div class="input-group">
                     ...
                     <input type="text" class="form-control" id="invoice_num"  placeholder="Supplier Invoice No" name="supplier_invoice_number"  value="<?php echo e($cart->supplier_invoice_number); ?>">
          ...
          <div class="form-group row"  style="display: none;" id="delivery_number">
            ...
            <div class="input-group">
                     ...
                     <input type="text" class="form-control" id="delivery_num" placeholder="Supplier Delivery No" name="supplier_delivery_number"  value="<?php echo e($cart->supplier_delivery_number); ?>">
...
<div class="form-group row" style="display: none;" id="invoice_number">
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control" id="taxable_value" onchange="calc1()"  placeholder="Taxable Value" name="taxable_value" pattern="[0-9][0-9 . 0-9]{0,100}" title="Numbers Only" required="" value="<?php echo e($cart->taxable_value); ?>">
         ...
         <!--  <div class="col-md-8">
          ...
          <div class="col-md-6">
            ...
            <div class="input-group">
                     ...
                     <input type="text" class="form-control" id="tax_value" onchange="calc2()"  placeholder="Tax Value" name="tax_value"  pattern="[0-9][0-9 . 0-9]{0,100}" title="Numbers Only" required="" value="<?php echo e($cart->tax_value); ?>">
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control" readonly="" id="total_invoice_value" onclick="calc()" placeholder="Total invoice Value" name="total_invoice_value"  pattern="[0-9][0-9 . 0-9]{0,100}" required="" title="Numbers Only" value="<?php echo e($cart->total_invoice_value); ?>">
         ...
         <!--  <div class="col-md-8">
          ...
          <div class="col-md-6">
            ...
            <div class="input-group">
                     ...
                     <input type="text" class="form-control"  placeholder="Load Bill" name="load_bill" pattern="[0-9][0-9 . 0-9]{0,100}" required="" title="Numbers Only" value="<?php echo e($cart->load_bill); ?>">
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control"  placeholder="Load Live" name="load_live"  pattern="[0-9][0-9 . 0-9]{0,100}" required="" title="Numbers Only" value="<?php echo e($cart->load_live); ?>">
         ...
         <!--  <div class="col-md-8">
          ...
          <div class="col-md-6">
            ...
            <div class="input-group">
                     ...
                     <input type="text" class="form-control"  placeholder="Unload Bill" name="unload_bill" pattern="[0-9][0-9 . 0-9]{0,100}" title="Numbers Only" value="<?php echo e($cart->unload_bill); ?>">
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control"  placeholder="Unload Live" name="unload_live" pattern="[0-9][0-9 . 0-9]{0,100}" title="Numbers Only" value="<?php echo e($cart->unload_live); ?>">
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ns_pollachi\resources\views/admin/master/cart/add.blade.php ENDPATH**/ ?>
...
<div class="col-12 body-sec">
  <div class="card container-fluid px-0">
      ...
      <div class="row">
        ...
        <div class="col-8 mr-auto">
          <ul class="h-right-btn mb-0 pl-0">
            <li><button type="button" class="btn btn-success"><a href="<?php echo e(url('master/customer')); ?>">Back</a></button></li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="card-body">
      ...
      <form  method="post" class="form-horizontal needs-validation" novalidate action="<?php echo e(url('master/customer/update/'.$customer->id)); ?>" enctype="multipart/form-data">
...
<div class="form-row">
          ...
          <div class="col-md-6">
              <div class="form-group row">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control only_allow_alp_num_dot_com_amp company_name required_for_valid" error-data="Enter valid Company Name" placeholder="Company Name" name="company_name" value="<?php echo e(old('company_name',$customer->company_name)); ?>" >
            ...
            <div class="col-md-6">
              <div class="form-group row">
                <label for="validationCustom01" class="col-sm-4 col-form-label">Customer Type <?php echo e($customer->customer_type); ?> <span class="mandatory">*</span></label>
                <div class="col-sm-8">
                  <div class="form-check d-inline">
                    <label class="form-check-label">
                      <input type="radio" class="form-check-input customer_type" value="1" <?php echo e(old('customer_type',$customer->customer_type) == 1 ? 'checked' : ''); ?> name="customer_type">Exist
                    </label>
                  </div>
  
                  <div class="form-check d-inline mx-4 ">
                    <label class="form-check-label">
                      <input type="radio" class="form-check-input customer_type" value="0" <?php echo e(old('customer_type',$customer->customer_type) == 0 ? 'checked' : ''); ?> name="customer_type">New
                    </label>
                  </div>
  
                  <span class="mandatory"> <?php echo e($errors->first('customer_type')); ?> </span>
                  <div class="invalid-feedback">
                  ...
                  <div class="input-group">
                    <div class="input-group-prepend">
                      <select class="form-control  salutation" name="salutation" error-data="Enter valid Salutation">
                        <option value="Mr" <?php echo e(old('salutation',$customer->salutation) == 'Mr' ? 'selected' : ''); ?>>Mr</option>
                        <option value="Mrs" <?php echo e(old('salutation',$customer->salutation) == 'Mrs' ? 'selected' : ''); ?>>Mrs</option>
                      </select>
                      <span class="mandatory"> <?php echo e($errors->first('salutation')); ?> </span>
                    </div>
                    <input type="text" class="form-control only_allow_alp_num_dot_com_amp name" name="name" error-data="Customer Name Field is required" aria-label="Text input with dropdown button" value=<?php echo e(old('name',$customer->name)); ?>>
  ...
  <?php $__currentLoopData = $exist_customer_dets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option value="<?php echo e($value->id); ?>" <?php echo e(old('exist_customer_name',$customer->customer_id) == $value->id ? 'selected' : ''); ?> ><?php echo e($value->name); ?></option>
  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
       </select>
  
                  <span class="mandatory"> <?php echo e($errors->first('exist_customer_name')); ?> </span>
                  <div class="invalid-feedback">
                    Enter valid Customer Name
                  </div>
                </div>
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control  phone_no only_allow_digit required_for_valid" input-type="phone_no" pattern="[1-9]{1}[0-9]{9}" error-data="Enter valid Phone No" placeholder="Phone No" name="phone_no" value="<?php echo e(old('phone_no',$customer->phone_no)); ?>" >
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control whatsapp_no only_allow_digit" input-type="phone_no" pattern="[1-9]{1}[0-9]{9}" error-data="Enter valid Whatsapp No" placeholder="Whatsapp No" name="whatsapp_no" value="<?php echo e(old('whatsapp_no',$customer->whatsapp_no)); ?>" >
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="email" class="form-control email required_for_valid" input-type="email" error_data="Enter valid Email" placeholder="Email" name="email" value="<?php echo e(old('email',$customer->email)); ?>" >
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control pan_card required_for_valid" input-type="pan_card" error_data="Enter valid Pancard No" placeholder="Pan Card No" name="pan_card" value="<?php echo e(old('pan_card',$customer->pan_card)); ?>" >
                <span class="mandatory"> <?php echo e($errors->first('pan_card')); ?> </span>
                <div class="invalid-feedback">
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control gst_no required_for_valid" input-type="gst_no" error_data="Enter valid Gst No" placeholder="Gst No" name="gst_no" value="<?php echo e(old('gst_no',$customer->gst_no)); ?>" >
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control max_credit_limit only_allow_digit required_for_valid"  error_data="Enter valid Maximum Credit Limit" placeholder="Maximum Credit Limit" name="max_credit_limit" value="<?php echo e(old('max_credit_limit',$customer->max_credit_limit)); ?>" >
                <span class="mandatory"> <?php echo e($errors->first('max_credit_limit')); ?> </span>
                <div class="invalid-feedback">
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control max_credit_days only_allow_digit required_for_valid"  error_data="Enter valid Maximum Credit Days" placeholder="Maximum Credit Days" name="max_credit_days" value="<?php echo e(old('max_credit_days',$customer->max_credit_days)); ?>" >
                <span class="mandatory"> <?php echo e($errors->first('max_credit_days')); ?> </span>
                <div class="invalid-feedback">
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control  only_allow_digit required_for_valid" input-type="opening_balance" error_data="Enter valid Opening Balance" placeholder="Opening Balance" name="opening_balance" value="<?php echo e(old('opening_balance',$customer->opening_balance)); ?>" >
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control remark" input-type="remark" error_data="Enter valid Remark" placeholder="Remark" name="remark" value="<?php echo e(old('remark',$customer->remark)); ?>" >
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <option value=""></option>
                 <option value="1"  <?php echo e(old('price_level',$customer->price_level) == '1' ? 'selected' : ''); ?>>Price Level 1</option>
                  <option value="2" <?php echo e(old('price_level',$customer->price_level) == '2' ? 'selected' : ''); ?>>Price Level 2</option>
                  <option value="3" <?php echo e(old('price_level',$customer->price_level) == '3' ? 'selected' : ''); ?>>Price Level 3</option> 
               </select>
 ...
 <div class="form-row">
  <div class="col-md-8">
           ...
           <div class="common_address_div">
            ...
            <?php $__currentLoopData = $customer_address_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$values): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              ...
              <div class="col-md-12">
                <table class="table bank_dtails">
                 ...
                 <tbody class="append_bank_details">
                  ...
                  <?php $__currentLoopData = $customer_bank_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bank_key=>$bank_value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
...
$(document).on("click",".perment_proof_details",function(){
  ...
  if(confirm('Are You Sure Want to Delete this ?')){
   $.ajax({
                      type: "post",
                      url: "<?php echo e(url('master/customer/delete-agent-proof-details')); ?>",
...
if($(".remove_address").length >1){
  ...
  if(confirm('Are You Sure Want to Delete this ?')){
    ...
    $.ajax({
                      type: "post",
                      url: "<?php echo e(url('master/customer/delete-customer-address-details')); ?>",
...
if($(".perment_delete_bank").length >1){
  ...
  if(confirm('Are You Sure Want to Delete this ?')){
    ...
    $.ajax({
                      type: "post",
                      url: "<?php echo e(url('master/customer/delete-customer-bank-details')); ?>",
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ns_pollachi\resources\views/admin/master/customer/edit.blade.php ENDPATH**/ ?>
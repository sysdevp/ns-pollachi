      ...
      <div class="row">
        ...
        <div class="col-8 mr-auto">
          <ul class="h-right-btn mb-0 pl-0">
            <li><button type="button" class="btn btn-success"><a href="<?php echo e(url('receipt_note/index/0')); ?>">Back</a></button></li>
          </ul>
        </div>
      </div>
    </div>
...
<form  method="post" class="form-horizontal" action="<?php echo e(route('receipt_note.update',$receipt_note->rn_no)); ?>" id="dataInput" enctype="multipart/form-data">
                  ...
                  <div class="form-group row">
                     <div class="col-sm-8">
                      <select class="js-example-basic-multiple col-12 form-control custom-select supplier_id" onchange="supplier_details()" name="supplier_id" id="supplier_id">
                           <?php if(isset($receipt_note->supplier->name) && !empty($receipt_note->supplier->name)): ?>
                           <option value="<?php echo e($receipt_note->supplier->id); ?>"><?php echo e($receipt_note->supplier->name); ?></option>
                           <?php else: ?>
                     ...
                     <button type="button"  class="px-2 btn btn-success mx-2 refresh_supplier_id" title="Add Brand"><i class="fa fa-refresh" aria-hidden="true"></i></button>
                       ...
                       <div class="row col-md-12">
                        ...
                        <div class="col-md-2">
                                  ...
                                  <div class="">
                                    <input type="hidden" readonly="" id="voucher_no" name="voucher_no" value="<?php echo e($receipt_note->rn_no); ?>">
                                    <font size="2"><?php echo e($receipt_note->rn_no); ?></font>
                                  </div>
                                ...
                                <input type="date" class="form-control voucher_date  required_for_proof_valid" id="voucher_date" placeholder="Voucher Date" name="voucher_date" value="<?php echo e($receipt_note->rn_date); ?>">
                        ...
                        <div class="col-md-2">
                                ...
                                <option value="<?php echo e($receipt_note->po_no); ?>"><?php echo e($receipt_note->po_no); ?></option>
                                <?php $__currentLoopData = $purchaseorders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $purchaseorders): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-md-2">
                                ...
                                <input type="date" class="form-control po_date  required_for_proof_valid" readonly="" id="po_date" placeholder="Voucher Date" name="po_date" value="<?php echo e($receipt_note->po_date); ?>">
                                ...
                                <option value="<?php echo e($receipt_note->estimation_no); ?>"><?php echo e($receipt_note->estimation_no); ?></option>
                                ...
                                <input type="date" class="form-control p_estimation_date  required_for_proof_valid" readonly="" id="p_estimation_date" placeholder="Gate Pass Entry Date" name="p_estimation_date" value="<?php echo e($receipt_note->estimation_date); ?>">
                                ...
                                <option value="<?php echo e($receipt_note->r_out_no); ?>"><?php echo e($receipt_note->r_out_no); ?></option>
                                ...
                                <input type="date" class="form-control r_out_date  required_for_proof_valid" readonly="" id="r_out_date" placeholder="Voucher Date" name="r_out_date" value="<?php echo e($receipt_note->r_out_date); ?>">
                ...
                <table class="table" id="team-list">
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <input type="number" class="form-control overall_discount" id="overall_discount" name="overall_discount" oninput="overall_discounts()" pattern="[0-9]{0,100}" title="Numbers Only" value="<?php echo e($receipt_note->overall_discount); ?>">
                      </div>
                    </div>
                    ...
                    <!-- <div class="row col-md-12">
                        ...
                        <div class="row col-md-12 append_expense">
                          ...
                          <?php $__currentLoopData = $receipt_note_expense; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <div class="form-group row">
                    ...
                    <?php endif; ?>
                       ...
                       <div class="col-md-12" style="float: right;">
                        ...
                        <font color="black" style="font-size: 150%; margin-left: 700px; font-weight: 900;">NET Value :</font>&nbsp;<font class="total_net_value" style="font-size: 150%; font-weight: 900;"><?php echo e($receipt_note->total_net_value); ?></font> 
                       </div>
                    <!-- net value -->
                      ...
                      <input type="text" class="form-control round_off" readonly="" value="<?php echo e($receipt_note->round_off); ?>" id="round_off" name="round_off" >
                      </div>
...
$(document).on("click",".remove_items",function(){
    ...
    $.ajax({
           type: "GET",
            url: "<?php echo e(url('receipt_note/remove_data/{id}')); ?>",
...
if(append_value == 1)
{
  var row_id=$('#last').val();
      ...
      $.ajax({  
        ...
        type: "GET",
        url: "<?php echo e(url('receipt_note/getdata/{id}')); ?>",
        data: { id: item_code },             
      ...
      $.ajax({
           type: "POST",
            url: "<?php echo e(url('receipt_note/last_purchase_rate/')); ?>",
            data: { id: item_code },
           success: function(data) {
...
var row_id=$('#last').val();
      ...
      $.ajax({  
        ...
        type: "GET",
        url: "<?php echo e(url('receipt_note/getdata_item/{id}')); ?>",
        data: { id: item_code },             
...
function item_with_same_data(item_code)
{
  $.ajax({
        ...
        type: "GET",
        url: "<?php echo e(url('receipt_note/same_items/{id}')); ?>",
        data: { id: item_code },
...
function browse_item()
{
  ...
  $.ajax({  
        ...
        type: "GET",
        url: "<?php echo e(url('receipt_note/browse_item/{id}')); ?>",
...
function categories_check()
{
  ...
  $.ajax({  
        ...
        type: "GET",
        url: "<?php echo e(url('receipt_note/change_items/{id}')); ?>",
...
function brand_check()
{
  ...
  $.ajax({
        ...
        type: "POST",
        url: "<?php echo e(url('receipt_note/brand_filter/')); ?>",
        data: {brand: brand },             
...
function supplier_details()
{
  ...
  $.ajax({
           type: "POST",
            url: "<?php echo e(url('receipt_note/address_details/')); ?>",
...
function estimation_details()
{
  ...
  $.ajax({
           type: "POST",
            url: "<?php echo e(url('receipt_note/estimation_details/')); ?>",
...
function po_details()
{
  ...
  $.ajax({
           type: "POST",
            url: "<?php echo e(url('receipt_note/po_details/')); ?>",
            data: { po_no : po_no },
           success: function(data) {
            $('.tables').remove();
            $('.expense').remove();
...
function r_out_details()
{
  ...
  $.ajax({
           type: "POST",
            url: "<?php echo e(url('receipt_note/r_out_details/')); ?>",
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ns_pollachi\resources\views/admin/receipt_note/edit.blade.php ENDPATH**/ ?>
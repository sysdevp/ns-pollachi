      ...
      <div class="row">
        ...
        <div class="col-8 mr-auto">
          <ul class="h-right-btn mb-0 pl-0">
            <li><button type="button" class="btn btn-success"><a href="<?php echo e(url('sales_entry/index/0')); ?>">Back</a></button></li>
          </ul>
        </div>
      </div>
    </div>
...
<form  method="post" class="form-horizontal" action="<?php echo e(route('sales_entry.update',$sale_entry->s_no)); ?>" id="dataInput" enctype="multipart/form-data">
      ...
      <?php echo method_field('PATCH'); ?>
                      ...
                      <div class="row col-md-12">
                          ...
                          <div class="col-md-1">
                                  ...
                                  <div class="">
                                    <input type="hidden" readonly="" id="voucher_no" name="voucher_no" value="<?php echo e($sale_entry->s_no); ?>">
                                    <font size="2"><?php echo e($sale_entry->s_no); ?></font>
                                  </div>
                                ...
                                <input type="date" class="form-control voucher_date  required_for_proof_valid" id="voucher_date" placeholder="Voucher Date" name="voucher_date" value="<?php echo e($sale_entry->s_date); ?>">
                  ...
                  <div class="form-group row">
                     <div class="col-sm-8">
                      <select class="js-example-basic-multiple col-12 form-control custom-select customer_id" onchange="customer_details()" name="customer_id" id="customer_id">
                           <?php if(isset($sale_entry->customer->name) && !empty($sale_entry->customer->name)): ?>
                           <option value="<?php echo e($sale_entry->customer->id); ?>"><?php echo e($sale_entry->customer->name); ?></option>
                           <?php else: ?>
                  ...
                  <div class="form-group row">
                     <div class="col-sm-8">
                      <select class="js-example-basic-multiple col-12 form-control custom-select salesmen_id" name="salesmen_id" id="salesmen_id">
                           <?php if(isset($sale_entry->salesman->id) && !empty($sale_entry->salesman->id)): ?>
                           <option value="<?php echo e($sale_entry->salesman->id); ?>"><?php echo e($sale_entry->salesman->name); ?></option>
                           <?php else: ?>
                           <option value="">Choose Sales Man Name</option>
                           <?php endif; ?>
                           <?php $__currentLoopData = $sales_man; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                           <option value="<?php echo e($value->id); ?>"><?php echo e($value->name); ?></option>
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                     </div>
                     <a href="<?php echo e(route('sales_man.create')); ?>" target="_blank">
                     ...
                     <button type="button"  class="px-2 btn btn-success mx-2 refresh_salesmen_id" title="Add Sales Men"><i class="fa fa-refresh" aria-hidden="true"></i></button>
                       ...
                       <div class="row col-md-12">
                                ...
                                <option value="<?php echo e($sale_entry->sale_estimation_no); ?>"><?php echo e($sale_entry->sale_estimation_no); ?></option>
                                  ...
                                  <option value="<?php echo e($value->sale_estimation_no); ?>"><?php echo e($value->sale_estimation_no); ?></option>
                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                 </select>
                                ...
                                <input type="date" class="form-control sale_estimation_date  required_for_proof_valid" id="sale_estimation_date" placeholder="Voucher Date" name="sale_estimation_date" value="<?php echo e($sale_entry->sale_estimation_date); ?>">
                        ...
                        <div class="col-md-2">
                                ...
                                <option value="<?php echo e($sale_entry->so_no); ?>"><?php echo e($sale_entry->so_no); ?></option>
                        ...
                        <div class="col-md-2">
                                ...
                                <input type="date" class="form-control so_date  required_for_proof_valid" id="so_date" placeholder="Voucher Date" name="so_date" value="<?php echo e($date); ?>">
                                ...
                                <option value="<?php echo e($sale_entry->d_no); ?>"><?php echo e($sale_entry->d_no); ?></option>
                                  ...
                                  <option value="<?php echo e($value->d_no); ?>"><?php echo e($value->d_no); ?></option>
                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                 </select>
                                ...
                                <input type="date" class="form-control d_date  required_for_proof_valid" id="d_date" placeholder="Voucher Date" name="d_date" value="<?php echo e($sale_entry->d_date); ?>">
...
<div class="form-row">
              ...
              <div class="col-md-12" id="middlecol">
                ...
                <table class="table" id="team-list">
                  ...
                  <input type="hidden" name="total_price" value="<?php echo e($sale_entry->total_net_value); ?>" id="total_price">
                  <input type="hidden" name="last_purchase_rate" value="0" id="last_purchase_rate">

                  <?php $__currentLoopData = $sale_entry_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <input type="number" class="form-control overall_discount" id="overall_discount" name="overall_discount" oninput="overall_discounts()" pattern="[0-9]{0,100}" title="Numbers Only" value="<?php echo e($sale_entry->overall_discount); ?>">
                      </div>
                    </div>
                    ...
                    <!-- <div class="row col-md-12">
                        ...
                        <div class="row col-md-12 append_expense">
                          ...
                          <?php $__currentLoopData = $sale_entry_expense; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <div class="form-group row">
                    ...
                    <?php endif; ?>
                       ...
                       <div class="col-md-12" style="float: right;">
                        ...
                        <font color="black" style="font-size: 150%; margin-left: 700px; font-weight: 900;">NET Value :</font>&nbsp;<font class="total_net_value" style="font-size: 150%; font-weight: 900;"><?php echo e($sale_entry->total_net_value); ?></font> 
                       </div>
                    <!-- net value -->
                      ...
                      <input type="text" class="form-control round_off" readonly="" value="<?php echo e($sale_entry->round_off); ?>" id="round_off" name="round_off" >
                      </div>
...
$(document).on("click",".remove_items",function(){
    ...
    $.ajax({
           type: "GET",
            url: "<?php echo e(url('sales_entry/remove_data/{id}')); ?>",
...
function item_with_same_data(item_code)
{
  $.ajax({
        ...
        type: "GET",
        url: "<?php echo e(url('sales_entry/same_items/{id}')); ?>",
        data: { id: item_code },
...
function browse_item()
{
  ...
  $.ajax({  
        ...
        type: "GET",
        url: "<?php echo e(url('sales_entry/browse_item/{id}')); ?>",
...
function categories_check()
{
  ...
  $.ajax({  
        ...
        type: "GET",
        url: "<?php echo e(url('sales_entry/change_items/{id}')); ?>",
...
function brand_check()
{
  ...
  $.ajax({
        ...
        type: "POST",
        url: "<?php echo e(url('sales_entry/brand_filter/')); ?>",
        data: {brand: brand },             
...
function customer_details()
{
  ...
  $.ajax({
           type: "POST",
            url: "<?php echo e(url('sales_entry/address_details/')); ?>",
...
function se_details()
{
  ...
  $.ajax({
           type: "POST",
            url: "<?php echo e(url('delivery_note/se_details/')); ?>",
            data: { se_no : se_no },
           success: function(data) {
            $('.tables').remove();
            $('.expense').remove();
...
function so_details()
{
  ...
  $.ajax({
           type: "POST",
            url: "<?php echo e(url('sales_entry/so_details/')); ?>",
            data: { so_no : so_no },
           success: function(data) {
            $('.tables').remove();
            $('.expense').remove();
...
function delivery_details()
{
  ...
  $.ajax({
           type: "POST",
            url: "<?php echo e(url('sales_entry/delivery_details/')); ?>",
            data: { d_no : d_no },
           success: function(data) {
            $('.tables').remove();
            $('.expense').remove();
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ns_pollachi\resources\views/admin/sales_entry/edit.blade.php ENDPATH**/ ?>
...
<div class="col-12 body-sec">
  <div class="card container px-0">
    ...
    <div class="card-body">
      ...
      <form  method="post" class="form-horizontal needs-validation" novalidate action="<?php echo e(url('master/employee/update/'.$employee->id)); ?>" enctype="multipart/form-data">
         ...
         <div class="col-md-6">
           ...
           <div class="input-group-prepend">
             <select class="form-control required_for_valid salutation" name="salutation" error-data="Enter valid Salutation" >
                 <option value="Mr" <?php echo e(old('salutation',$employee->salutation) == 'Mr' ? 'selected' : ''); ?>>Mr</option>
                 <option value="Mrs" <?php echo e(old('salutation',$employee->salutation) == 'Mrs' ? 'selected' : ''); ?> >Mrs</option>
             </select>
             <span class="mandatory"> <?php echo e($errors->first('salutation')); ?> </span>
           </div>
           <input type="text" class="form-control  required_for_valid name" name="name" error-data="Employee Name Field is required" aria-label="Text input with dropdown button" value=<?php echo e(old('name',$employee->name)); ?>>
      ...
      <div class="col-md-6">
           <div class="form-group row">
             ...
             <div class="col-sm-8">
               <input type="text" class="form-control code  required_for_valid" error-data="Enter valid Employee Code" placeholder="Employee Code" name="code" value="<?php echo e(old('code',$employee->code)); ?>" >
         ...
         <div class="col-md-6">
           <div class="form-group row">
             ...
             <div class="col-sm-8">
               <input type="text" class="form-control only_allow_digit phone_no required_for_valid" input-type="phone_no" pattern="[1-9]{1}[0-9]{9}" error-data="Enter valid Phone No" placeholder="Phone No" name="phone_no" value="<?php echo e(old('phone_no',$employee->phone_no)); ?>" >
         ...
         <div class="col-md-6">
           <div class="form-group row">
             ...
             <div class="col-sm-8">
               <input type="email" class="form-control email required_for_valid" input-type="email" error_data="Enter valid Email" placeholder="Email" name="email" value="<?php echo e(old('email',$employee->email)); ?>" >
         ...
         <div class="col-md-6">
           ...
           <div class="form-group row">
             ...
             <div class="col-sm-8">
               <input type="text" class="form-control dob required_for_valid" error-data="Enter valid DOB" placeholder="dd-mm-yyyy" name="dob" value="<?php echo e(old('dob',$dob)); ?>" >
            ...
            <select class="js-example-basic-multiple col-12 form-control custom-select department_id required_for_valid" 
             error-data="Enter valid Department" data-placeholder="Choose Department" name="department_id" >
               <option value="">Choose Department</option>
                 ...
                 <option value="<?php echo e($value->id); ?>" <?php echo e(old('department_id',$employee->department_id) == $value->id  ? 'selected' : ''); ?>><?php echo e($value->name); ?></option>
...
<div class="form-row">
    ...
    <div class="common_address_div">
      <?php $__currentLoopData = $employee_address_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$values): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <div class="form-row address_div">
          ...
          <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                    <input type="text" class="form-control old_address_line_1 required_for_valid required_for_address_valid" error-data="Enter valid Address" placeholder="Address Line 1" name="old_address_line_1[]" value="<?php echo e(old('old_address_line_1.'.$key,$values->address_line_1)); ?>"  required>
      ...
      <div class="col-md-6">
        ...
        <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control land_mark" placeholder="Land Mark" name="old_land_mark[]" value="<?php echo e(old('old_land_mark.'.$key,$values->land_mark)); ?>">
      ...
      <div class="col-md-6">
       ...
       <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                    <input type="text" class="form-control only_allow_digit old_postal_code required_for_valid required_for_address_valid" error-data="Enter valid Postal Code" placeholder="Postal Code" name="old_postal_code[]" value="<?php echo e(old('old_postal_code.'.$key,$values->postal_code)); ?>" required>
      ...
      <div class="col-md-6">
              <div class="form-group row">
                <label for="validationCustom01" class="col-sm-4 col-form-label">Address Line 1 <span class="mandatory">*</span></label>
                <div class="col-sm-8">
                <input type="text" class="form-control address_line_1 required_for_valid required_for_address_valid" error-data="Enter valid Address" placeholder="Address Line 1" name="address_line_1[]" value="<?php echo e(old('address_line_1.'.$key)); ?>" required>
  ...
  <div class="col-md-6">
    ...
    <div class="col-md-6">
            ...
            <!-- Old Values For Dropdown Start Here  -->
          <input type="hidden" class="form-control new_old_state_id" value="<?php echo e(old('state_id.'.$key)); ?>">
          <input type="hidden" class="form-control new_old_district_id" value="<?php echo e(old('district_id.'.$key)); ?>">
          <input type="hidden" class="form-control new_old_city_id" value="<?php echo e(old('city_id.'.$key)); ?>">
            <!-- Old Values For Dropdown End Here  -->
  <div class="col-md-6">
              <div class="form-group row">
                <label for="validationCustom01" class="col-sm-4 col-form-label">State <span class="mandatory">*</span></label>
  ...
  <div class="col-md-6">
   ...
   <div class="col-md-6">
              <div class="form-group row">
                <label for="land_mark" class="col-sm-4 col-form-label">Postal Code <span class="mandatory">*</span></label>
                <div class="col-sm-8">
                <input type="text" class="form-control only_allow_digit postal_code required_for_valid required_for_address_valid" error-data="Enter valid Postal Code" placeholder="Postal Code" name="postal_code[]" value="<?php echo e(old('postal_code.'.$key)); ?>" required>
...
<?php $__currentLoopData = $employee_proof_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$proof_value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                    <tr>
                      <td><span class="s_no"> <?php echo e($key+1); ?> </span>
                        <input type="hidden" name="proof_details_id[]" value=<?php echo e($proof_value->id); ?>>
                      </td>
                      <td>
                        <div class="form-group row">
                          <div class="col-sm-12">
                          <input type="text" class="form-control old_proof_name  required_for_proof_valid" error-data="Enter valid Postal Code" placeholder="Proof Name" name="old_proof_name[]" value="<?php echo e(old('old_proof_name.'.$key,$proof_value->name)); ?>" >
                            <span class="mandatory"> <?php echo e($errors->first('old_proof_name.'.$key)); ?> </span>
                            <div class="invalid-feedback">
                   ...
                   <td>
                            <div class="form-group row">
                              <div class="col-sm-12">
                              <input type="text" class="form-control old_proof_number only_allow_digit required_for_proof_valid" error-data="Enter valid Postal Code" placeholder="Proof Number" name="old_proof_number[]" value="<?php echo e(old('old_proof_number.'.$key,$proof_value->number)); ?>" >
                                <span class="mandatory"> <?php echo e($errors->first('old_proof_number.'.$key)); ?> </span>
                                <div class="invalid-feedback">
                          ...
                          <td>
                              <div class="form-group row">
                                ...
                                <input type="file" class="form-control old_proof_file only_allow_digit " error-data="Enter valid Postal Code" placeholder="Proof Name" name="old_proof_file[]" value="" >
                                  <span class="mandatory"> <?php echo e($errors->first('old_proof_file.'.$key)); ?> </span>
                                  <div class="invalid-feedback">
                            ...
                            <td>
                                <a href="<?php echo e(asset('storage/employee_proof_details/'.$proof_value->file)); ?>" download><img src="<?php echo e(asset('storage/agent_proof_details/'.$proof_value->file)); ?>" class="img-fluid" style="max-width:60px;" alt="logo" /></a>
                            </td>
                            ...
                            <td>
                                <div class="form-group row">
                                    ...
                                    <label class="btn btn-danger perment_proof_details" attr-id="<?php echo e($proof_value->id); ?>">-</label>
                                      </div>
                                  </div>
                            </td>
...
$(document).on("click",".perment_proof_details",function(){
  ...
  if(confirm('Are You Sure Want to Delete this ?')){
   $.ajax({
                      type: "post",
                      url: "<?php echo e(url('master/employee/delete-employee-proof-details')); ?>",
...
if($(".remove_address").length >1){
  ...
  if(confirm('Are You Sure Want to Delete this ?')){
    ...
    $.ajax({
                      type: "post",
                      url: "<?php echo e(url('master/employee/delete-employee-address-details')); ?>",
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ns_pollachi\resources\views/admin/master/employee/edit.blade.php ENDPATH**/ ?>
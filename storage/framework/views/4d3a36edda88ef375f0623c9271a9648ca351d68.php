...
<div class="col-12 body-sec">
  <div class="card container px-0">
      ...
      <div class="row">
        ...
        <div class="col-8 mr-auto">
          <ul class="h-right-btn mb-0 pl-0">
            <li><button type="button" class="btn btn-success"><a href="<?php echo e(url('master/agent')); ?>">Back</a></button></li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="card-body">
      ...
      <form  method="post" class="form-horizontal needs-validation" novalidate action="<?php echo e(url('master/agent/update/'.$agent->id)); ?>" enctype="multipart/form-data">
        ...
        <div class="col-md-6">
          ...
          <div class="input-group-prepend">
            <select class="form-control required_for_valid salutation" name="salutation" error-data="Enter valid Salutation" >
                <option value="Mr" <?php echo e(old('salutation',$agent->salutation) == 'Mr' ? 'selected' : ''); ?>>Mr</option>
                <option value="Mrs" <?php echo e(old('salutation',$agent->salutation) == 'Mrs' ? 'selected' : ''); ?> >Mrs</option>
            </select>
            <span class="mandatory"> <?php echo e($errors->first('salutation')); ?> </span>
          </div>
          <input type="text" class="form-control required_for_valid name" name="name" error-data="Agent Name Field is required" aria-label="Text input with dropdown button" value=<?php echo e(old('name',$agent->name)); ?>>
...
<div class="col-md-6">
          <div class="form-group row">
            ...
            <div class="col-sm-8">
              <input type="text" class="form-control code only_allow_alp_num_dot_com_amp required_for_valid" error-data="Enter valid Agent Code" placeholder="Agent Code" name="code" value="<?php echo e(old('code',$agent->code)); ?>" >
        ...
        <div class="col-md-6">
          <div class="form-group row">
            ...
            <div class="col-sm-8">
              <input type="text" class="form-control  phone_no only_allow_digit required_for_valid" input-type="phone_no" pattern="[1-9]{1}[0-9]{9}" error-data="Enter valid Phone No" placeholder="Phone No" name="phone_no" value="<?php echo e(old('phone_no',$agent->phone_no)); ?>" >
        ...
        <div class="col-md-6">
          <div class="form-group row">
            ...
            <div class="col-sm-8">
              <input type="email" class="form-control email" input-type="email" error_data="Enter valid Email" placeholder="Email" name="email" value="<?php echo e(old('email',$agent->email)); ?>" >
...
<div class="col-md-6">
          <div class="form-group row">
            ...
            <div class="col-sm-8">
              <input type="text" class="form-control father_name required_for_valid" error-data="Enter valid Father's Name" placeholder="Father's Name" name="father_name" value="<?php echo e(old('father_name',$agent->father_name)); ?>">
        ...
        <div class="col-md-6">
          <div class="form-group row">
            ...
            <div class="col-sm-8">
              <input type="text" class="form-control blood_group required_for_valid" error-data="Enter valid Blood Group" placeholder="Blood Group" name="blood_group" value="<?php echo e(old('blood_group',$agent->blood_group)); ?>" >
        ...
        <div class="col-md-6">
          <div class="form-group row">
            ...
            <option value=""></option>
               <option value="Married"  <?php echo e(old('material_status',$agent->material_status) == 'Married' ? 'selected' : ''); ?>>Married</option>
                <option value="Single" <?php echo e(old('material_status',$agent->material_status) == 'Single' ? 'selected' : ''); ?>>Single</option>
                <option value="Divorced" <?php echo e(old('material_status',$agent->material_status) == 'Divorced' ? 'selected' : ''); ?>>Divorced</option> 
             </select>
 ...
 <div class="form-row">
  <div class="col-md-8">
           ...
           <div class="common_address_div">
            ...
            <?php $__currentLoopData = $agent_address_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$values): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $__currentLoopData = $agent_proof_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$proof_value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                   ...
                   <td>
                          ...
                          <td>
                            ...
                            <td>
                                <a href="<?php echo e(asset('storage/agent_proof_details/'.$proof_value->file)); ?>" download><img src="<?php echo e(asset('storage/agent_proof_details/'.$proof_value->file)); ?>" class="img-fluid" style="max-width:60px;" alt="logo" /></a>
                            </td>
            ...
            <tr>
             ...
             <td>
                      <div class="form-group row">
                        <div class="col-sm-12">
                        <input type="text" class="form-control proof_number  required_for_proof_valid" error-data="Enter valid Postal Code" placeholder="Proof Number" name="proof_number[]" value="<?php echo e(old('proof_number.'.$key)); ?>" >
...
$(document).on("click",".perment_proof_details",function(){
  ...
  if(confirm('Are You Sure Want to Delete this ?')){
   $.ajax({
                      type: "post",
                      url: "<?php echo e(url('master/agent/delete-agent-proof-details')); ?>",
...
if($(".remove_address").length >1){
  ...
  if(confirm('Are You Sure Want to Delete this ?')){
    ...
    $.ajax({
                      type: "post",
                      url: "<?php echo e(url('master/agent/delete-agent-address-details')); ?>",
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ns_pollachi\resources\views/admin/master/agent/edit.blade.php ENDPATH**/ ?>
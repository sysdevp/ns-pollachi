      ...
      <div class="row">
        ...
        <div class="col-8 mr-auto">
          <ul class="h-right-btn mb-0 pl-0">
            <li><button type="button" class="btn btn-success"><a href="<?php echo e(route('payable_partywise.index')); ?>">Back</a></button></li>
          </ul>
        </div>
      </div>
    </div>
...
#payable_party_filter {
    opacity: 0;
    z-index: -1;
}
#payable_party_length {
  display: none;
}
#payable_party_wrapper div.dt-buttons {
  z-index: 10;
}
</style>
    <div class="card-body">
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ns_pollachi\resources\views/admin/outstanding/payables/partywise/bill.blade.php ENDPATH**/ ?>
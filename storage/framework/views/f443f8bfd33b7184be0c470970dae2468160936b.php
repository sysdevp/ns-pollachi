...
<form  method="post" class="form-horizontal" action="<?php echo e(route('purchase_order.store')); ?>" id="dataInput" enctype="multipart/form-data">
      <?php echo e(csrf_field()); ?>
         ...
         <div class="row col-md-10">
                  ...
                  <div class="col-md-2">
                    ...
                    <input type="hidden" name="voucher_no" value="<?php echo e($voucher_no); ?>">
                    <div class="">
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ns_pollachi\resources\views/admin/purchaseorder/add.blade.php ENDPATH**/ ?>
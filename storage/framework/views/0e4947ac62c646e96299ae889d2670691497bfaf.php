...
<form  method="post" class="form-horizontal" action="<?php echo e(route('sales_gatepass_entry.update',$sales_gatepass->sales_gatepass_no)); ?>" id="dataInput" enctype="multipart/form-data">
      ...
      <?php echo method_field('PATCH'); ?>
                       ...
                       <div class="row col-md-12">
                                ...
                                <div class="col-md-2">
                                  ...
                                  <div class="">
                                    <input type="hidden" readonly="" class="form-control proof_file  required_for_proof_valid" id="voucher_no" placeholder="Auto Generate Voucher No" name="voucher_no" value="<?php echo e($sales_gatepass->sales_gatepass_no); ?>">
                                    <font size="2"><?php echo e($sales_gatepass->sales_gatepass_no); ?></font>
                                  </div>
                                ...
                                <input type="date" class="form-control voucher_date  required_for_proof_valid" id="voucher_date" placeholder="Voucher Date" name="voucher_date" value="<?php echo e($sales_gatepass->sales_gatepass_date); ?>">
                                ...
                                <option value="<?php echo e($sales_gatepass->so_no); ?>"><?php echo e($sales_gatepass->so_no); ?></option>
                                ...
                                <input type="date" class="form-control so_date  required_for_proof_valid" id="so_date" placeholder="Purchase Order Date" name="so_date" value="<?php echo e($sales_gatepass->so_date); ?>">
                                ...
                                <option value="<?php echo e($sales_gatepass->estimation_no); ?>"><?php echo e($sales_gatepass->estimation_no); ?></option>
                                ...
                                <input type="date" class="form-control estimation_date  required_for_proof_valid" id="estimaton_date" placeholder="Estimaton Date" name="estimation_date" value="<?php echo e($sales_gatepass->estimation_date); ?>">
                  ...
                  <div class="form-group row">
                     <div class="col-sm-8">
                      <select class="js-example-basic-multiple col-12 form-control custom-select customer_id" onchange="customer_details()" name="customer_id" id="customer_id">
                           <option value="<?php echo e($sales_gatepass->customer->id); ?>"><?php echo e($sales_gatepass->customer->name); ?></option>
              ...
              <div class="row col-md-12">
                      ...
                      <input type="text" class="form-control" name="load_bill" id="load_bill" placeholder="Load Bill" value="<?php echo e($sales_gatepass->load_bill); ?>">
                      </div>

                      <div class="col-md-2">
                      <label style="font-family: Times new roman;">Unload Bill</label><br>
                      <input type="text" class="form-control" name="unload_bill" id="unload_bill" placeholder="Unload Bill" value="<?php echo e($sales_gatepass->unload_bill); ?>">
                      </div>
                      
                      <div class="col-md-2">
                      <label style="font-family: Times new roman;">Load Live</label><br>
                      <input type="text" class="form-control" name="load_live" id="load_live" placeholder="Load Live" value="<?php echo e($sales_gatepass->load_live); ?>">
                      </div>

                      <div class="col-md-2">
                      <label style="font-family: Times new roman;">Unload Live</label><br>
                      <input type="text" class="form-control" name="unload_live" id="unload_live" placeholder="Unload Live" value="<?php echo e($sales_gatepass->unload_live); ?>">
                      </div>          
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ns_pollachi\resources\views/admin/sales_gatepass/edit.blade.php ENDPATH**/ ?>
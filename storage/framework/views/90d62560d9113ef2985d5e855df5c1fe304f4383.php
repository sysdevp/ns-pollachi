...
<form  method="post" class="form-horizontal" action="<?php echo e(route('pos.store')); ?>" id="dataInput" enctype="multipart/form-data">
...
function new_page()
          {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(url('estimation/print/')); ?>",
...
<?php echo $__env->make('admin.layout.app1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ns_pollachi\resources\views/admin/pos/add.blade.php ENDPATH**/ ?>
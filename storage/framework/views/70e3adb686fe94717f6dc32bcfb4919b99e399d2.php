...
<div class="col-12 body-sec">
  <div class="card container px-0">
    ...
    <div class="card-header px-2">
      <div class="row">
        <div class="col-4">
          <h3>View Purchase Entry Details</h3>
        </div>
    ...
    <div class="card-body">
      <div class="row col-md-12">
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> <?php echo e($purchase_entry->p_no); ?></label>
          </div>
              </div>
          ...
          <div class="col-md-6">
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> <?php echo e($purchase_entry->p_date); ?></label>
          </div>
              </div>
            </div>
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> <?php echo e($purchase_entry->po_no); ?></label>
          </div>
              </div>
          ...
          <div class="col-md-6">
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> <?php echo e($purchase_entry->po_date); ?></label>
          </div>
              </div>
            </div>
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> 
              ...
              <?php echo e($purchase_entry->supplier->name); ?>
          ...
          <div class="col-md-6">
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> 
              <?php if($purchase_entry->purchase_type == 1): ?>
              Cash Purchase
              <?php else: ?>
               Credit purchase
              <?php endif; ?>
...
<div class="form-row">
              ...
              <div>
                ...
                <table class="table table-bordered table-responsive" style="max-width: 90%; height: 100%;">
                  <thead>
                    <th> S.no </th>
                    <th> Item S.no </th>
                    <th> Item Code</th>
          ...
          <div class="col-md-6">
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> <?php echo e($purchase_entry->overall_discount); ?></label>
          </div>
              </div>
            </div>
        ...
        <table class="table table-bordered table-responsive" style="width: 100%; height: 100%;">
          <thead>
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> <?php echo e($purchase_entry->round_off); ?></label>
          </div>
              </div>
          ...
          <div class="col-md-6">
            ...
            <label for="validationCustom01" class="col-sm-4 col-form-label"> <?php echo e($purchase_entry->total_net_value); ?></label>
          </div>
              </div>
            </div>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ns_pollachi\resources\views/admin/purchase_entry/show.blade.php ENDPATH**/ ?>
                    ...
                    <div class="col-md-2">
                     <label for="validationCustom01" class="">Location</label>
                       <select class="js-example-basic-multiple col-12 form-control custom-select location select2-hidden-accessible" name="location[]" id="location" data-select2-id="location" tabindex="-1" aria-hidden="true">
                           <option value="<?php echo e(@$opening_data[$k][0]['location']); ?>" data-select2-id="6"><?php echo e(@$opening_data[$k][0]['name']); ?></option>
                       ...
                       <span class="mandatory"> <?php echo e($errors->first('location')); ?> </span>
                     <div class="invalid-feedback">
...
function add_item_tax_details() {
   i++;
    ...
    item_tax_dets += '<tr class="row_count">\
                        ...
                        <td>\
                           <div class="col-sm-12">\
                              <input type="text" class="form-control <?php echo e($value->name); ?>_id only_allow_digit_and_dot common" name="<?php echo e($value->name); ?>_id[]"  placeholder="<?php echo e($value->name); ?>" value="0" id="<?php echo e($value->name); ?>_id'+i+'"  required>\
                              <input type="hidden" name="<?php echo e($value->name); ?>[]" id="<?php echo e($value->name); ?>[]" value="<?php echo e($value->id); ?>">\
                              <span class="mandatory">  </span>\
                              <div class="invalid-feedback">\
                                 Enter valid <?php echo e($value->name); ?>\
                              </div>\
                           </div>\
                        </td>\
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>\
...
function testing(val)
{
   ...
   $(document).ready(function()
   {
    var old_expiry_date="<?php echo e(old('is_expiry_date')); ?>";
     ...
     var category_two_id="<?php echo e(old('category_2')); ?>";
     var category_three_id="<?php echo e(old('category_3')); ?>";
     var bulk_item_id="<?php echo e(old('bulk_item_id')); ?>";

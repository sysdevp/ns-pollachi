...
<div class="col-12 body-sec">
  <div class="card container px-0">
    ...
    <!-- card header end@ -->
    <div class="card-body">
      <form  method="post" class="form-horizontal needs-validation" novalidate action="<?php echo e(url('master/item/update/'.$item->id)); ?>" enctype="multipart/form-data">
      ...
      <div class="form-row">
        <div class="col-md-6">
          <div class="form-group row">
            ...
            <div class="col-sm-8">
              <input type="text" class="form-control name only_allow_alp_num_dot_com_amp" placeholder="Item Name" name="name" value="<?php echo e(old('name',$item->name)); ?>" required>
        ...
        <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control code only_allow_alp_num_dot_com_amp" placeholder="Item Code" name="code" value="<?php echo e(old('code',$item->code)); ?>" required>
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-6">
                <select class="js-example-basic-multiple col-12 form-control custom-select brand_id" name="brand_id" required>
                  ...
                  <option value="0" <?php echo e(old('brand_id',$item->brand_id) == "0" ? 'selected' : ''); ?>> Not Applicable </option>
                  ...
                  <option value="<?php echo e($value->id); ?>" <?php echo e(old('brand_id',$item->brand_id) == $value->id ? 'selected' : ''); ?>  ><?php echo e($value->name); ?></option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                <span class="mandatory"> <?php echo e($errors->first('brand_id')); ?> </span>
               <div class="invalid-feedback">
                  Enter valid Brand
                </div>
              </div>
              <a href="<?php echo e(url('master/brand/create')); ?>" target="_blank">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <select class="js-example-basic-multiple col-12 form-control custom-select category_id" name="category_id" required>
                        ...
                        <option value="<?php echo e($value->id); ?>" <?php echo e(old('category_id',$item->category_id) == $value->id ? 'selected' : ''); ?>  ><?php echo e($value->name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </select>
                      <span class="mandatory"> <?php echo e($errors->first('category_id')); ?> </span>
                     <div class="invalid-feedback">
                        Enter valid Category
                      </div>
                    </div>
                    <a href="<?php echo e(url('master/category/create')); ?>" target="_blank">
                ...
                <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                        <select class="js-example-basic-multiple col-12 form-control custom-select item_type" name="item_type" required>
                         ...
                         <option value="Direct"   <?php echo e(old('item_type',$item->item_type) == "Direct" ? 'selected' : ''); ?>  >Direct</option>
                          <option value="Bulk" <?php echo e(old('item_type',$item->item_type) == "Bulk" ? 'selected' : ''); ?>  >Bulk</option>
                          <option value="Repack" <?php echo e(old('item_type',$item->item_type) == "Repack" ? 'selected' : ''); ?>  >Repack</option>
                          <option value="Parent" <?php echo e(old('item_type',$item->item_type) == "Parent" ? 'selected' : ''); ?>  >Parent</option>
                         <!-- <option value="Child" <?php echo e(old('item_type',$item->item_type) == "Child" ? 'selected' : ''); ?>  >Child</option> -->
                        </select>
                        <span class="mandatory"> <?php echo e($errors->first('item_type')); ?> </span>
                       <div class="invalid-feedback">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-6">
                        <select class="js-example-basic-multiple col-12 form-control custom-select child_item_id" name="child_item_id">
                          ...
                          <?php $__currentLoopData = $child_item; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <option value="<?php echo e($value->id); ?>" <?php echo e(old('child_item_id',$item->child_item_id) == $value->id ? 'selected' : ''); ?>  ><?php echo e($value->name); ?></option>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                         </select>
                        <span class="mandatory"> <?php echo e($errors->first('child_item_id')); ?> </span>
                       <div class="invalid-feedback">
                          Enter valid Child Name
                        </div>
                      </div>
                      <a href="<?php echo e(url('master/item/create')); ?>" target="_blank">
                  ...
                  <div class="col-md-6 child_div" style="display:none">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control child_unit only_allow_digit_and_dot" placeholder="Units" name="child_unit" value="<?php echo e(old('child_unit',$item->child_unit)); ?>" >
                        <span class="mandatory"> <?php echo e($errors->first('child_unit')); ?> </span>
                       <div class="invalid-feedback">
                          Enter valid Units
                        </div>
                      </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-6">
                        <select class="js-example-basic-multiple col-12 form-control custom-select bulk_item_id" name="bulk_item_id">
                          ...
                          <?php $__currentLoopData = $bulk_item; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <option value="<?php echo e($value->id); ?>" <?php echo e(old('bulk_item_id') == $value->id ? 'selected' : ''); ?>  ><?php echo e($value->name); ?></option>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                         </select>
                        <span class="mandatory"> <?php echo e($errors->first('bulk_item_id')); ?> </span>
                       <div class="invalid-feedback">
                  ...
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control weight_in_grams only_allow_digit_and_dot" placeholder="Weight In Grams " name="weight_in_grams" value="<?php echo e(old('weight_in_grams',$item->weight_in_grams)); ?>" >
                        <span class="mandatory"> <?php echo e($errors->first('weight_in_grams')); ?> </span>
                        <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control print_name_in_english only_allow_alp_num_dot_com_amp" placeholder="Print Name in English " name="print_name_in_english" value="<?php echo e(old('print_name_in_english',$item->print_name_in_english)); ?>" required>
                        <span class="mandatory"> <?php echo e($errors->first('print_name_in_english')); ?> </span>
                        <div class="invalid-feedback">
                  ...
                  <div class="col-md-6">
                      ...
                      <label for="validationCustom01" class="col-sm-4 col-form-label">Print Name in <?php echo e($language_1); ?></label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control print_name_in_language_1 only_allow_alp_num_dot_com_amp" placeholder="Print Name in <?php echo e($language_1); ?>" name="print_name_in_language_1" value="<?php echo e(old('print_name_in_language_1',$item->print_name_in_language_1)); ?>" >
                          <span class="mandatory"> <?php echo e($errors->first('print_name_in_language_1')); ?> </span>
                          <div class="invalid-feedback">
                            Enter valid Print Name in <?php echo e($language_1); ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control print_name_in_language_2 only_allow_alp_num_dot_com_amp" placeholder="Print Name in <?php echo e($language_2); ?>" name="print_name_in_language_2" value="<?php echo e(old('print_name_in_language_2',$item->print_name_in_language_2)); ?>">
                            <span class="mandatory"> <?php echo e($errors->first('print_name_in_language_2')); ?> </span>
                            <div class="invalid-feedback">
                              Enter valid Print Name in <?php echo e($language_2); ?>
                      ...
                      <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                              <input type="text" class="form-control print_name_in_language_3 only_allow_alp_num_dot_com_amp" placeholder="Print Name in <?php echo e($language_3); ?>" name="print_name_in_language_3" value="<?php echo e(old('print_name_in_language_3',$item->print_name_in_language_3)); ?>">
                              <span class="mandatory"> <?php echo e($errors->first('print_name_in_language_3')); ?> </span>
                              <div class="invalid-feedback">
                                Enter valid Print Name in <?php echo e($language_3); ?>
                        ...
                        <!-- <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-sm-8">
                                <input type="text" class="form-control ptc only_allow_alp_num_dot_com_amp" placeholder="PTC Code" name="ptc" value="<?php echo e(old('ptc',$item->ptc)); ?>" required>
                                <span class="mandatory"> <?php echo e($errors->first('ptc')); ?> </span>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-6">
                              <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                  <input type="text" class="form-control hsn only_allow_alp_num_dot_com_amp" placeholder="Hsn Code" name="hsn" value="<?php echo e(old('hsn',$item->hsn)); ?>" required>
                                  <span class="mandatory"> <?php echo e($errors->first('hsn')); ?> </span>
                                  <div class="invalid-feedback">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                  ...
                                  <div class="col-sm-8">
                                    <input type="text" class="form-control only_allow_digit_and_dot mrp only_allow_alp_num_dot_com_amp" placeholder="MRP" name="mrp" value="<?php echo e(old('mrp',$item->mrp)); ?>" required>
                                    <span class="mandatory"> <?php echo e($errors->first('mrp')); ?> </span>
                                    <div class="invalid-feedback">
                                      Enter valid MRP 
                                    </div>
                                  </div>
                              ...
                              <div class="col-md-6">
                                  <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                      <input type="text" class="form-control only_allow_digit_and_dot default_selling_price only_allow_alp_num_dot_com_amp" placeholder="Default Selling Price" name="default_selling_price" value="<?php echo e(old('default_selling_price',$item->default_selling_price)); ?>" required>
                                      <span class="mandatory"> <?php echo e($errors->first('default_selling_price')); ?> </span>
                                      <div class="invalid-feedback">
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-sm-6">
                                        <select class="js-example-basic-multiple col-12 form-control custom-select uom_id" name="uom_id" required>
                                          ...
                                          <?php $__currentLoopData = $uom; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                          <option value="<?php echo e($value->id); ?>" <?php echo e(old('uom_id',$item->uom_id) == $value->id ? 'selected' : ''); ?>  ><?php echo e($value->name); ?></option>
                                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                        <span class="mandatory"> <?php echo e($errors->first('uom_id')); ?> </span>
                                       <div class="invalid-feedback">
                                          Enter valid UOM
                                        </div>
                                      </div>
                                        ...
                                        <div class="col-sm-8">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                  <input type="radio" class="form-check-input is_machine_weight_applicable" <?php echo e(old('is_machine_weight_applicable',$item->is_machine_weight_applicable) == 1 ? 'checked' : ''); ?> value ="1" name="is_machine_weight_applicable">Yes
                                                </label>
                                              </div>

                                              <div class="form-check">
                                                  <label class="form-check-label">
                                                    <input type="radio" class="form-check-input is_machine_weight_applicable" value ="0" <?php echo e(old('is_machine_weight_applicable',$item->is_machine_weight_applicable) == 0 ? 'checked' : ''); ?> name="is_machine_weight_applicable">No
                                                  </label>
                                                </div>
                                          
                                          <span class="mandatory"> <?php echo e($errors->first('is_machine_weight_applicable')); ?> </span>
                                         <div class="invalid-feedback">
                                  ...
                                  <div class="col-md-6">
                                      <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                  <input type="radio" class="form-check-input is_expiry_date" value ="1" <?php echo e(old('is_expiry_date',$item->is_expiry_date) == 1 ? 'checked' : ''); ?>  name="is_expiry_date">Yes
                                                </label>
                                              </div>

                                              <div class="form-check">
                                                  <label class="form-check-label">
                                                    <input type="radio" class="form-check-input is_expiry_date" value ="0" <?php echo e(old('is_expiry_date',$item->is_expiry_date) == 0 ? 'checked' : ''); ?>  name="is_expiry_date">No
                                                  </label>
                                                </div>
                                    ...
                                    <div class="col-md-6 expiry_date_div" style="display: none">
                                      ...
                                      ?>
                                        <div class="form-group row">
                                          ...
                                          <div class="col-sm-8">
                                            <input type="text" class="form-control expiry_date" placeholder="Expiry Date" name="expiry_date" value="<?php echo e(old('expiry_date',$expiry_date)); ?>">
                                            <span class="mandatory"> <?php echo e($errors->first('expiry_date')); ?> </span>
                                            <div class="invalid-feedback">
                                      ...
                                      <div class="col-md-6">
                                        <div class="form-group row">
                                          ...
                                          <div class="col-sm-8">
                                              <div class="form-check">
                                                  <label class="form-check-label">
                                                    <input type="radio" class="form-check-input is_minimum_sales_qty_applicable" value ="1" <?php echo e(old('is_minimum_sales_qty_applicable',$item->is_minimum_sales_qty_applicable) == 1 ? 'checked' : ''); ?> name="is_minimum_sales_qty_applicable">Yes
                                                  </label>
                                                </div>

                                                <div class="form-check">
                                                    <label class="form-check-label">
                                                      <input type="radio" class="form-check-input is_minimum_sales_qty_applicable" value ="0" <?php echo e(old('is_minimum_sales_qty_applicable',$item->is_minimum_sales_qty_applicable) == 0 ? 'checked' : ''); ?> name="is_minimum_sales_qty_applicable">No
                                                    </label>
                                                  </div>
                                            
                                            <span class="mandatory"> <?php echo e($errors->first('is_minimum_sales_qty_applicable')); ?> </span>
                                           <div class="invalid-feedback">
                                              Enter valid UOM
                                            </div>
                                          </div>
                                      ...
                                      <div class="col-md-6 minimum_sales_div" style="display: none">
                                        <div class="form-group row">
                                          ...
                                          <div class="col-sm-8">
                                            <input type="text" class="form-control minimum_sales_qty" placeholder="Minimum Sales Qty" name="minimum_sales_qty" value="<?php echo e(old('minimum_sales_qty',$item->minimum_sales_qty)); ?>">
                                            <span class="mandatory"> <?php echo e($errors->first('minimum_sales_qty')); ?> </span>
                                            <div class="invalid-feedback">
                                      ...
                                      <div class="col-md-6 minimum_sales_div" style="display: none">
                                        <div class="form-group row">
                                          ...
                                          <div class="col-sm-8">
                                            <input type="text" class="form-control minimum_sales_price" placeholder="Minimum Sales Price" name="minimum_sales_price" value="<?php echo e(old('minimum_sales_price',$item->minimum_sales_price)); ?>">
                                            <span class="mandatory"> <?php echo e($errors->first('minimum_sales_price')); ?> </span>
                                            <div class="invalid-feedback">
                                      ...
                                      <div class="col-md-6">
                                          <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                              <input type="file" class="form-control image" placeholder="Product Image" name="image" value="<?php echo e(old('image')); ?>">
                                              <span class="mandatory"> <?php echo e($errors->first('image')); ?> </span>
                                              <div class="invalid-feedback">
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-sm-6">
                        <select class="js-example-basic-multiple col-12 form-control custom-select supplier_id" name="supplier_id">
                           ...
                           <option value="<?php echo e($value->id); ?>" <?php echo e(old('supplier_id',$item->supplier_id) == $value->id ? 'selected' : ''); ?>  ><?php echo e($value->name); ?></option>
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <span class="mandatory"> <?php echo e($errors->first('supplier_id')); ?> </span>
                        <div class="invalid-feedback">
              ...
              <div class="col-md-2 mb-3">
                  ...
                  <div class="col-md-12 openings">
                    <?php for($k = 0; $k < $opening_count; $k++): ?>
                  <div class="row mb-3 opening_row">

                     <div class="col-md-2">
                     <label for="validationCustom01" class="">Batch No</label>
                       <input type="text" placeholder="Batch No" required="" name="batch_no[]" value="<?php echo e(@$opening_data[$k][0]['batch_no']); ?>" class="form-control mandatory" >
                  ...
                  <div class="col-md-2">
                     <label for="validationCustom01" class="">Opening Quantity<span class="mandatory">*</span></label>
                       <input type="number" required="" id="quantity" placeholder="Opening Quantity" name="quantity[]" value="<?php echo e(@$opening_data[$k][0]['opening_qty']); ?>" class="form-control quantity mandatory" >
                     <span class="mandatory"> <?php echo e($errors->first('quantity')); ?> </span>
                     <div class="invalid-feedback">
                     ...
                     <label for="validationCustom01" class="">Rate</label>
                       <input type="text" placeholder="Rate" value="<?php echo e(@$opening_data[$k][0]['rate']); ?>" id="rate" name="rate[]" class="form-control rate" >
               </div>

                                 <div class="col-md-2">
                     <label for="validationCustom01" class="">Amount</label>
                       <input type="text" name="amount[]" value="<?php echo e(@$opening_data[$k][0]['amount']); ?>" readonly="" id="amount" placeholder="Amount" class="form-control amount" >
               </div>

                                 <div class="col-md-2">
                     <label for="validationCustom01" class="">Applicable Date</label>
                       <input type="date" name="applicable_date[]" value="<?php echo e(@$opening_data[$k][0]['applicable_date']); ?>" class="form-control" >
               </div>

               <div class="col-md-1">
                     <label for="validationCustom01" class="">W/B</label>
                       <select class="form-control" name="black_or_white[]">
                        <?php if($opening_data[$k][0]['black_or_white'] == 1): ?>
            ...
            <?php endfor; ?>
            <input type="hidden" name="opening_cnt" id="opening_cnt" value="<?php echo e($opening_count); ?>">
         </div> 
...
<input type="hidden" name="count" id="count" value="<?php echo e($tax_detail_count); ?>">
 <div class="form-row">
  ...
  <table class="table">
    ...
    <tbody class="append_row">
      <?php $__currentLoopData = $tax_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i =>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
      <tr>
         <td class="s_no"><?php echo e($i+1); ?></td>
        <?php $__currentLoopData = $tax; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        
        <td>
            <div class="col-sm-12">
            <input type="hidden" name="<?php echo e($value->name); ?>[]" class="" id="<?php echo e($value->name); ?>[]" value="<?php echo e($value->id); ?>">
            <input type="text" class="form-control <?php echo e($value->name); ?>_id only_allow_digit_and_dot common" name="<?php echo e($value->name); ?>_id[]"  placeholder="<?php echo e($value->name); ?>" value="<?php echo e(@$tax_value[$i][$key]['value']); ?>" required >
          ...
          <td>
             <div class="col-sm-12">
                <input type="text" class="form-control valid_from" name="valid_from[]" placeholder="dd-mm-yyyy" value="<?php echo e(@$tax_value[$i][$key]['valid_from']); ?>" required>

               
                <span class="mandatory"> <?php echo e($errors->first('valid_from.0')); ?> 
             </div>
          </td>
     ...
     <?php if(old('igst')): ?>
         <?php $__currentLoopData = old('igst'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $old_key=>$old_value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
   <tr>
         <td class="s_no"></td> 
         <td>
             <div class="col-sm-12">
             <input type="text" class="form-control igst only_allow_digit_and_dot" name="igst[]" placeholder="IGST" value="<?php echo e(old('igst.'.$old_key)); ?>" required>
             <span class="mandatory"> <?php echo e($errors->first('igst.'.$old_key)); ?> </span>
             <div class="invalid-feedback">
                 Enter valid IGST
               </div>
             </div>
         ...
         <td>
             <div class="col-sm-12">
             <input type="text" class="form-control cgst only_allow_digit_and_dot" name="cgst[]" readonly placeholder="CGST" value="<?php echo e(old('cgst.'.$old_key)); ?>" required>
             <span class="mandatory"> <?php echo e($errors->first('cgst.'.$old_key)); ?> </span>
             <div class="invalid-feedback">
                 Enter valid CGST
               </div>
             </div>
       ...
       <td>
                 <div class="col-sm-12">
                 <input type="text" class="form-control sgst only_allow_digit_and_dot" name="sgst[]" readonly placeholder="SGST" value="<?php echo e(old('sgst.'.$old_key)); ?>" required>
                 <span class="mandatory"> <?php echo e($errors->first('sgst.'.$old_key)); ?> </span>
                 <div class="invalid-feedback">
                     Enter valid SGST
                   </div>
                 </div>
               ...
               <td>
                   <div class="col-sm-12">
                    <input type="text" class="form-control valid_from" name="valid_from[]" placeholder="dd-mm-yyyy" value="<?php echo e(old('valid_from.'.$old_key)); ?>" required>
                    <span class="mandatory"> <?php echo e($errors->first('valid_from.'.$old_key)); ?> </span>
                    <div class="invalid-feedback">
 ...
 <div class="form-row">
  <table class="table">
     ...
     <tbody class="append_barcode_dets">
       <?php $__currentLoopData = $item->item_barcode_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item_barcode_key=>$item_barcode_value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
       <tr>
       <td class="barcode_s_no"><?php echo e($item_barcode_key+1); ?></td>
        <td>
           <div class="col-sm-12">
             <input type="hidden" class="form-control item_barcode_details_id" name="item_barcode_details_id[]" value="<?php echo e(old('item_barcode_details_id.'.$item_barcode_key,$item_barcode_value->id)); ?>">
              <input type="text" class="form-control barcode" name="old_barcode[]"  placeholder="Barcode" value="<?php echo e(old('old_barcode.'.$item_barcode_key,$item_barcode_value->barcode)); ?>" required>
              <span class="mandatory"> <?php echo e($errors->first('old_barcode.'.$item_barcode_key)); ?> </span>
              <div class="invalid-feedback">
                 Enter valid Barcode
              </div>
           </div>
        ...
        <td>
           <div class="col-sm-12">
              <input type="text" class="form-control confirm_barcode" name="old_barcode_confirmation[]"  placeholder="Confirm Barcode" value="<?php echo e(old('old_barcode_confirmation.'.$item_barcode_key,$item_barcode_value->barcode)); ?>" required>
              <span class="mandatory"> <?php echo e($errors->first('old_barcode_confirmation.'.$item_barcode_key)); ?> </span>
              <div class="invalid-feedback">
       ...
       <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <?php if(old('barcode')): ?>
        <?php $__currentLoopData = old('barcode'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $old_barcode_key=>$old_barcode_value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
       
        <tr>
           <td class="barcode_s_no">1</td>
           <td>
              <div class="col-sm-12">
                 <input type="text" class="form-control barcode" name="barcode[]"  placeholder="Barcode" value="<?php echo e(old('barcode.'.$old_barcode_key)); ?>" required>
                 <span class="mandatory"> <?php echo e($errors->first('barcode.'.$old_barcode_key)); ?> </span>
                 <div class="invalid-feedback">
                    Enter valid Barcode
                 </div>
              </div>
           ...
           <td>
              <div class="col-sm-12">
                 <input type="text" class="form-control confirm_barcode" name="barcode_confirmation[]"  placeholder="Confirm Barcode" value="<?php echo e(old('barcode_confirmation.'.$old_barcode_key)); ?>" required>
                 <span class="mandatory"> <?php echo e($errors->first('barcode_confirmation.'.$old_barcode_key)); ?> </span>
                 <div class="invalid-feedback">
                    Enter valid Confirm Barcode
                 </div>
              </div>
...
function add_item_tax_details() {
    ...
    item_tax_dets += '<tr class="row_count">\
                        ...
                        <td>\
                           <div class="col-sm-12">\
                              <input type="text" class="form-control <?php echo e($value->name); ?>_id only_allow_digit_and_dot common" name="<?php echo e($value->name); ?>_id[]"  placeholder="<?php echo e($value->name); ?>"  required>\
...
$(document).on("click",".remove_existing_barcode",function(){
  ...
  $.ajax({
              type: "post",
              url: "<?php echo e(url('master/item/remove-item-barcode-details')); ?>",
...
function get_category_based_item(category_one_id,category_two_id,category_three_id,item_id)
{
  ...
  $.ajax({
              type: "post",
              url: "<?php echo e(url('common/get-category-based-bulk-item')); ?>",
  ...
  function get_category_one_based_category_two(category_one_id,category_two_id)
 {
   $.ajax({
               type: "post",
               url: "<?php echo e(url('common/get-category-one-based-category-two')); ?>",
 ...
 function get_category_two_based_category_three(category_two_id,category_three_id)
 {
   $.ajax({
               type: "post",
               url: "<?php echo e(url('common/get-category-two-based-category-three')); ?>",
...
$(document).on("click",".refresh_child_item_id",function(){
 ...
 $(document).ready(function(){
  item_type();
   var old_expiry_date="<?php echo e(old('is_expiry_date')); ?>";
   var is_expiry_date="";
   is_expiry_date="<?php echo e($item->is_expiry_date); ?>";
   if(old_expiry_date != ""){
   ...
   var new_category_2="<?php echo e($item->category_2); ?>";
   var new_category_3="<?php echo e($item->category_3); ?>";
   var new_bulk_item_id="<?php echo e($item->bulk_item_id); ?>";
   var old_category_1="<?php echo e(old('category_1')); ?>";
   var old_category_2="<?php echo e(old('category_2')); ?>";
   var old_category_3="<?php echo e(old('category_3')); ?>";
   var old_bulk_item_id="<?php echo e(old('bulk_item_id')); ?>";
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ns_pollachi\resources\views/admin/master/item/edit.blade.php ENDPATH**/ ?>
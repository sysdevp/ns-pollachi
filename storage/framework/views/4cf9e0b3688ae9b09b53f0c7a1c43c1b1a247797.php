...
<div class="col-12 body-sec">
  <div class="card container px-0">
    ...
    <div class="card-body">
      ...
      <form  method="post" class="form-horizontal needs-validation" novalidate action="<?php echo e(url('master/user/store')); ?>" enctype="multipart/form-data">
        ...
        <div class="form-row">
              ...
              <div class="col-md-6">
                ...
                <label for="validationCustom01" class="col-sm-4 col-form-label">Name<span class="mandatory">*</span></label>
                  ...
                  <option value="<?php echo e($value->id); ?>" <?php echo e(old('employee_id') == $value->id ? 'selected' : ''); ?> ><?php echo e($value->name); ?></option>
              ...
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control user_name only_allow_alp_num_dot_com_amp" placeholder="User Name" name="user_name" value="<?php echo e(old('user_name')); ?>" required>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ns_pollachi\resources\views/admin/master/user/add.blade.php ENDPATH**/ ?>
      ...
      <div class="row">
        ...
        <div class="col-8 mr-auto">
          <ul class="h-right-btn mb-0 pl-0">
            <li><button type="button" class="btn btn-success"><a href="<?php echo e(url('rejection_in/index/0')); ?>">Back</a></button></li>
          </ul>
        </div>
      </div>
    </div>
...
<form  method="post" class="form-horizontal" action="<?php echo e(route('rejection_in.store')); ?>" id="dataInput" enctype="multipart/form-data">
...
$(document).on("click",".remove_items",function(){
    ...
    $.ajax({
           type: "GET",
            url: "<?php echo e(url('rejection_in/remove_data/{id}')); ?>",
...
function delivery_details()
{
  ...
  $.ajax({
           type: "POST",
            url: "<?php echo e(url('rejection_in/delivery_details/')); ?>",
            data: { d_no : d_no },
           success: function(data) {
            if(data == 1)
            {
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ns_pollachi\resources\views/admin/rejection_in/add.blade.php ENDPATH**/ ?>
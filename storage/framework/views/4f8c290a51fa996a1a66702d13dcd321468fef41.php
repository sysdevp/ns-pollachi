...
<form  method="post" class="form-horizontal" action="<?php echo e(route('purchase_gatepass_entry.store')); ?>" id="dataInput" enctype="multipart/form-data">
      <?php echo e(csrf_field()); ?>
                       ...
                       <div class="row col-md-12">
                                ...
                                <input type="date" class="form-control po_date  required_for_proof_valid" id="po_date" placeholder="Purchase Order Date" name="po_date" value="<?php echo e($date); ?>">
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ns_pollachi\resources\views/admin/purchase_gatepass/add.blade.php ENDPATH**/ ?>
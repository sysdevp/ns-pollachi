...
<form  method="post" class="form-horizontal" action="<?php echo e(route('sales_entry.store')); ?>" id="dataInput" enctype="multipart/form-data">
      <?php echo e(csrf_field()); ?>
                      ...
                      <div class="row col-md-12">
                        ...
                        <div class="col-md-1">
                                  ...
                                  <div class="">
                                    <font size="2" id="voucher_no"><?php echo e($voucher_no); ?></font>
                                  </div>
                     ...
                     <button type="button"  class="px-2 btn btn-success mx-2 refresh_salesmen_id" title="Add Sales Men"><i class="fa fa-refresh" aria-hidden="true"></i></button>
                       ...
                       <div class="row col-md-12">
                        ...
                        <div class="col-md-2">
                                ...
                                data-placeholder="Choose Purchase Order No" onchange="so_details()" id="so_no" name="so_no" >
                        ...
                        <div class="col-md-2">
                              ...
                              <div class="row col-md-12 mb-3">
                                ...
                                <input type="checkbox" name="check" class="po_alpha_beta" value="1">
...
<div class="form-row">
 ...
 <div class="col-md-8">
        ...
        <div class="col-md-12 row mb-3" id="bank_reference" style="display: none;">
          ...
          <div class="col-md-3">
            <input type="date" class="form-control" value="<?php echo e($date); ?>" name="payment_date" id="payment_date">
          </div>
          <div class="col-md-3">
...
$.ajax({
           type: "POST",
            url: "<?php echo e(url('sales_entry/po_alpha_beta/')); ?>",
            data: { id: val },
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ns_pollachi\resources\views/admin/sales_entry/add.blade.php ENDPATH**/ ?>
...
<form  method="post" class="form-horizontal" action="<?php echo e(route('debit_note.store')); ?>" id="dataInput" enctype="multipart/form-data">
                  ...
                  <div class="form-group row">
                     ...
                     <button type="button"  class="px-2 btn btn-success mx-2 refresh_supplier_id" title="Add Brand"><i class="fa fa-refresh" aria-hidden="true"></i></button>
                        ...
                        <div class="col-md-2">
                                ...
                                <?php $__currentLoopData = $purchase_entry; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $purchase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($purchase->p_no); ?>"><?php echo e($purchase->p_no); ?></option>
                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
                                 </select>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ns_pollachi\resources\views/admin/debit_note/add.blade.php ENDPATH**/ ?>
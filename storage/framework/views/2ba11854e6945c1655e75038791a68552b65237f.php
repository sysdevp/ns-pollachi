...
<div class="col-12 body-sec">
  <div class="card container px-0">
      ...
      <div class="row">
        ...
        <div class="col-8 mr-auto">
          <ul class="h-right-btn mb-0 pl-0">
            <li><button type="button" class="btn btn-success"><a href="<?php echo e(route('gate_pass_entry.index')); ?>">Back</a></button></li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="card-body">
      ...
      <form  method="post" class="form-horizontal needs-validation" action="<?php echo e(route('gate_pass_entry.update',$gatepass->pass_id)); ?>" enctype="multipart/form-data">
         ...
         <!--  <div class="col-md-8">
          ...
          <div class="col-md-6">
            ...
            <div class="input-group">
                     ...
                     <input type="text" class="form-control" readonly placeholder="Gate Pass No" name="num" value="<?php echo e($gatepass->gate_pass_no); ?>">
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="date" class="form-control"  placeholder="Date"  name="date" value="<?php echo e($gatepass->date); ?>" >
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-6">
                        <select class="js-example-basic-multiple col-12 form-control custom-select supplier_name required_for_valid" name="supplier_name">
                          <option value="<?php echo e($gatepass->suppliers_id); ?>"><?php echo e($gatepass->name); ?></option>
         ...
         <!--  <div class="col-md-8">
          ...
          <div class="col-md-6">
            ...
            <div class="input-group">
                     ...
                     <input type="text" class="form-control" id="invoice_num" placeholder="Supplier Invoice No" name="supplier_invoice_number"  value="<?php echo e($gatepass->supplier_invoice_number); ?>">
          ...
          <div class="form-group row"  style="display: none;" id="delivery_number">
            ...
            <div class="input-group">
                     ...
                     <input type="text" class="form-control" id="delivery_num" placeholder="Supplier Delivery No" name="supplier_delivery_number"  value="<?php echo e($gatepass->supplier_delivery_number); ?>">
...
<div class="form-group row" style="display: none;" id="invoice_number">
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control" id="taxable_value" onchange="calc1()" placeholder="Taxable Value" name="taxable_value" required="" pattern="[0-9][0-9 . 0-9]{0,100}" title="Numbers Only" value="<?php echo e($gatepass->taxable_value); ?>">
         ...
         <!--  <div class="col-md-8">
          ...
          <div class="col-md-6">
            ...
            <div class="input-group">
                     ...
                     <input type="text" class="form-control" required="" id="tax_value" onchange="calc2()" placeholder="Tax Value" name="tax_value"  pattern="[0-9][0-9 . 0-9]{0,100}" title="Numbers Only" value="<?php echo e($gatepass->tax_value); ?>">
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control" required="" readonly="" id="total_invoice_value" onclick="calc()" placeholder="Total invoice Value" name="total_invoice_value"  pattern="[0-9][0-9 . 0-9]{0,100}" title="Numbers Only" value="<?php echo e($gatepass->total_invoice_value); ?>">
         ...
         <!--  <div class="col-md-8">
          ...
          <div class="col-md-6">
            ...
            <div class="input-group">
                     ...
                     <input type="text" class="form-control" required="" placeholder="Load Bill" name="load_bill" pattern="[0-9][0-9 . 0-9]{0,100}" title="Numbers Only" value="<?php echo e($gatepass->load_bill); ?>">
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control" required="" placeholder="Load Live" name="load_live"  pattern="[0-9][0-9 . 0-9]{0,100}" title="Numbers Only" value="<?php echo e($gatepass->load_live); ?>">
         ...
         <!--  <div class="col-md-8">
          ...
          <div class="col-md-6">
            ...
            <div class="input-group">
                     ...
                     <input type="text" class="form-control"  placeholder="Unload Bill" name="unload_bill" pattern="[0-9][0-9 . 0-9]{0,100}" title="Numbers Only" value="<?php echo e($gatepass->unload_bill); ?>">
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control"  placeholder="Unload Live" name="unload_live" pattern="[0-9][0-9 . 0-9]{0,100}" title="Numbers Only" value="<?php echo e($gatepass->unload_live); ?>">
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ns_pollachi\resources\views/admin/master/gate_pass_entry/show.blade.php ENDPATH**/ ?>
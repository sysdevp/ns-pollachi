...
<div class="col-12 body-sec">
  <div class="card container px-0">
    ...
    <div class="card-body">
      ...
      <form method="post" class="form-horizontal needs-validation" novalidate action="<?php echo e(url('master/bank-branch/store')); ?>" enctype="multipart/form-data">
        ...
        <div class="form-row">
          <div class="col-md-8">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control name only_allow_alp_num_dot_com_amp branch" placeholder="Branch Name" name="branch" value="<?php echo e(old('branch')); ?>" required>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-6">
                <select class="js-example-basic-multiple col-12 custom-select bank_id" name="bank_id" required>
                  ...
                  <option value="<?php echo e($value->id); ?>" <?php echo e(old('bank_id') == $value->id ? 'selected' : ''); ?> ><?php echo e($value->name); ?></option>
          ...
          <div class="col-md-8">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control  only_allow_alp_numeric  ifsc" placeholder="IFSC Code" name="ifsc" value="<?php echo e(old('ifsc')); ?>" required>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ns_pollachi\resources\views/admin/master/bank_branch/add.blade.php ENDPATH**/ ?>
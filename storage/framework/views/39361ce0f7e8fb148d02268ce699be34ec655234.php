      ...
      <div class="row">
        ...
        <div class="col-8 mr-auto">
          <ul class="h-right-btn mb-0 pl-0">
            <li><button type="button" class="btn btn-success"><a href="<?php echo e(route('rejection_in.index')); ?>">Back</a></button></li>
          </ul>
        </div>
      </div>
    </div>
...
<form  method="post" class="form-horizontal" action="<?php echo e(route('rejection_in.update',$rejection_in->r_in_no)); ?>" id="dataInput" enctype="multipart/form-data">
                  ...
                  <div class="form-group row">
                     <div class="col-sm-8">
                      <select class="js-example-basic-multiple col-12 form-control custom-select customer_id" onchange="customer_details()" name="customer_id" id="customer_id">
                           <?php if(isset($rejection_in->customer->name) && !empty($rejection_in->customer->name)): ?>
                           <option value="<?php echo e($rejection_in->customer->id); ?>"><?php echo e($rejection_in->customer->name); ?></option>
                           <?php else: ?>
                     ...
                     <button type="button"  class="px-2 btn btn-success mx-2 refresh_customer_id" title="Add Brand"><i class="fa fa-refresh" aria-hidden="true"></i></button>
                        ...
                        <div class="col-md-2">
                                  ...
                                  <div class="">
                                    <input type="hidden" readonly="" id="voucher_no" name="voucher_no" value="<?php echo e($rejection_in->r_in_no); ?>">
                                    <font size="2"><?php echo e($rejection_in->r_in_no); ?></font>
                                  </div>
                                ...
                                <input type="date" class="form-control voucher_date  required_for_proof_valid" id="voucher_date" placeholder="Voucher Date" name="voucher_date" value="<?php echo e($rejection_in->r_in_date); ?>">
                        ...
                        <div class="col-md-2">
                                ...
                                <option value="<?php echo e($rejection_in->s_no); ?>"><?php echo e($rejection_in->s_no); ?></option>
                                <?php $__currentLoopData = $sale_entry; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $saleorders): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($saleorders->s_no); ?>"><?php echo e($saleorders->s_no); ?></option>
                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
                                 </select>
                        ...
                        <div class="col-md-2">
                                ...
                                <input type="date" class="form-control s_date  required_for_proof_valid" id="s_date" placeholder="Voucher Date" name="s_date" value="<?php echo e($rejection_in->s_date); ?>">
...
<div class="form-row">
              ...
              <div class="col-md-12" id="middlecol">
                ...
                <table class="table" id="team-list">
                  ...
                  <input type="hidden" name="total_price" value="<?php echo e($rejection_in->total_net_value); ?>" id="total_price">
                  <input type="hidden" name="last_purchase_rate" value="0" id="last_purchase_rate">

                  <?php $__currentLoopData = $rejection_in_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <div class="item_show" id="item_show" style="display: none;" title="Item Details">
                    ...
                    <div class="row col-md-12">
                      ...
                      <div class="col-md-3">
                        <label style="font-family: Times New Roman;">Sale Qty: <font class="show_net_value" style="font-weight: bold;"></font></label>
                      </div>
                      <div class="col-md-3">
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <input type="number" class="form-control overall_discount" id="overall_discount" name="overall_discount" oninput="overall_discounts()" pattern="[0-9]{0,100}" title="Numbers Only" value="<?php echo e($rejection_in->overall_discount); ?>">
                      </div>
                    </div>
                    ...
                    <!-- <div class="row col-md-12">
                        ...
                        <div class="row col-md-12 append_expense">
                          ...
                          <?php $__currentLoopData = $rejection_in_expense; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <div class="form-group row">
                    ...
                    <?php endif; ?>
                      ...
                      <input type="text" class="form-control round_off" readonly="" value="<?php echo e($rejection_in->round_off); ?>" id="round_off" name="round_off" >
                      </div>
                      ...
                      <div class="col-md-4" style="float: right;">
                        ...
                        <font color="black" style="font-size: 150%; margin-left: 100px; font-weight: 900;">NET Value :</font>&nbsp;<font class="total_net_value" style="font-size: 150%; font-weight: 900;"><?php echo e($rejection_in->total_net_value); ?></font> 
                       </div>
  ...
  if($('.s_no').val() != '')
{
  ...
  $.ajax({
           type: "POST",
            url: "<?php echo e(url('rejection_in/check_qty/')); ?>",
            data: { qty: qty, item_id:item_id, s_no:s_no },
           success: function(data) {
...
var row_id=$('#last').val();
      ...
      $.ajax({  
        ...
        type: "GET",
        url: "<?php echo e(url('rejection_in/getdata_item/{id}')); ?>",
        data: { id: item_code },             
...
function item_with_same_data(item_code)
{
  $.ajax({
        ...
        type: "GET",
        url: "<?php echo e(url('rejection_in/same_items/{id}')); ?>",
        data: { id: item_code },
...
function browse_item()
{
  ...
  $.ajax({  
        ...
        type: "GET",
        url: "<?php echo e(url('rejection_in/browse_item/{id}')); ?>",
...
function categories_check()
{
  ...
  $.ajax({  
        ...
        type: "GET",
        url: "<?php echo e(url('rejection_in/change_items/{id}')); ?>",
...
function brand_check()
{
  ...
  $.ajax({
        ...
        type: "POST",
        url: "<?php echo e(url('rejection_in/brand_filter/')); ?>",
        data: {brand: brand },             
...
function customer_details()
{
  ...
  $.ajax({
           type: "POST",
            url: "<?php echo e(url('rejection_in/address_details/')); ?>",
...
function s_details()
{
  ...
  $.ajax({
           type: "POST",
            url: "<?php echo e(url('rejection_in/s_details/')); ?>",
            data: { s_no : s_no },
           success: function(data) {
            $('.tables').remove();
            $('.expense').remove();
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ns_pollachi\resources\views/admin/rejection_in/edit.blade.php ENDPATH**/ ?>
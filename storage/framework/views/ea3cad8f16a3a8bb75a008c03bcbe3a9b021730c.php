      ...
      <div class="row">
        ...
        <div class="col-8 mr-auto">
          <ul class="h-right-btn mb-0 pl-0">
            <li><button type="button" class="btn btn-success"><a href="<?php echo e(url('debit_note/index/0')); ?>">Back</a></button></li>
          </ul>
        </div>
      </div>
    </div>
...
<form  method="post" class="form-horizontal" action="<?php echo e(route('debit_note.update',$debit_note->dn_no)); ?>" id="dataInput" enctype="multipart/form-data">
      ...
      <?php echo method_field('PATCH'); ?>
                       ...
                       <div class="row col-md-12">
                        ...
                        <div class="col-md-2">
                                  ...
                                  <div class="">
                                    <input type="hidden" readonly="" id="voucher_no" name="voucher_no" value="<?php echo e($debit_note->dn_no); ?>">
                                    <font size="2"><?php echo e($debit_note->dn_no); ?></font>
                                  </div>
                                ...
                                <input type="date" class="form-control voucher_date  required_for_proof_valid" id="voucher_date" placeholder="Voucher Date" name="voucher_date" value="<?php echo e($debit_note->dn_date); ?>">
                  ...
                  <div class="form-group row">
                     <div class="col-sm-8">
                      <select class="js-example-basic-multiple col-12 form-control custom-select supplier_id" onchange="supplier_details()" name="supplier_id" id="supplier_id">
                           <?php if(isset($debit_note->supplier->name) && !empty($debit_note->supplier->name)): ?>
                           <option value="<?php echo e($debit_note->supplier->id); ?>"><?php echo e($debit_note->supplier->name); ?></option>
                           <?php else: ?>
                     ...
                     <button type="button"  class="px-2 btn btn-success mx-2 refresh_supplier_id" title="Add Brand"><i class="fa fa-refresh" aria-hidden="true"></i></button>
                        ...
                        <div class="col-md-2">
                                ...
                                <option value="<?php echo e($debit_note->p_no); ?>"><?php echo e($debit_note->p_no); ?></option>
                                <?php $__currentLoopData = $purchase_entry; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $purchaseorders): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($purchaseorders->p_no); ?>"><?php echo e($purchaseorders->p_no); ?></option>
                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
                                 </select>
                        ...
                        <div class="col-md-2">
                                ...
                                <input type="date" class="form-control p_date  required_for_proof_valid" readonly="" id="p_date" placeholder="Voucher Date" name="p_date" value="<?php echo e($debit_note->p_date); ?>">
                                 
                                </div>
                                
                                <!-- <div class="col-md-2">
                                  <label style="font-family: Times new roman;">Gate Pass Entry Date</label><br>
                                <input type="date" class="form-control gatepass_date  required_for_proof_valid" id="gatepass_date" placeholder="Gate Pass Entry Date" name="gatepass_date" value="<?php echo e($date); ?>">
                                ...
                                data-placeholder="Choose Rejection Out No" onchange="r_out_details()" id="r_out_no" name="r_out_no" >
                                <option value="<?php echo e($debit_note->r_out_no); ?>"><?php echo e($debit_note->r_out_no); ?></option>
                                ...
                                <option value="<?php echo e($value->r_out_no); ?>"><?php echo e($value->r_out_no); ?></option>
                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                 </select>
                                ...
                                <input type="date" class="form-control r_out_date  required_for_proof_valid" readonly="" id="r_out_date" placeholder="Voucher Date" name="r_out_date" value="<?php echo e($debit_note->r_out_date); ?>">
          ...
          <input type="hidden" class="form-control items_codes  required_for_proof_valid" placeholder="Item Code" id="items_codes" name="items_codes" value="">
                      ...
                      <div class="cat" id="cat" style="display: none;" title="Search Here">
                        ...
                        <!-- <select class="js-example-basic-multiple form-control codes" id="codes" name="codes" style="width: 100%;" style="margin-left: 50%;" data-placeholder="Choose Item Code" onchange="code_check()">
                          ...
                          <option value="<?php echo e($items->id); ?>"><?php echo e($items->code); ?></option>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select><br> -->
...
<div class="form-row">
              ...
              <div class="col-md-12" id="middlecol">
                ...
                <table class="table" id="team-list">
                  ...
                  <input type="hidden" name="counts" value="<?php echo e($item_row_count); ?>" id="counts">
                  <input type="hidden" name="expense_count" value="<?php echo e($expense_row_count); ?>" id="expense_count">
                  <input type="hidden" name="total_amount" value="<?php echo e($item_amount_sum); ?>" id="total_amount">
                  <input type="hidden" name="total_gst" value="<?php echo e($item_gst_rs_sum); ?>" id="total_gst">
                  <input type="hidden" name="total_price" value="<?php echo e($debit_note->total_net_value); ?>" id="total_price">
                  <input type="hidden" name="last_purchase_rate" value="0" id="last_purchase_rate">

                  <?php $__currentLoopData = $debit_note_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  

                  <tr id="row<?php echo e($key); ?>" class="<?php echo e($key); ?> tables"><td><span class="item_s_no"> <?php echo e($key+1); ?> </span></td><td><div class="form-group row"><div class="col-sm-12"><input class="invoice_no<?php echo e($key); ?>" type="hidden" id="invoice<?php echo e($key); ?>" value="<?php echo e($value->item_sno); ?>" name="invoice_sno[]"><font class="item_no<?php echo e($key); ?>"><?php echo e($value->item_sno); ?></font></div></div></td><td><div class="form-group row"><div class="col-sm-12"><input type="hidden" class="item_code<?php echo e($key); ?>" value="<?php echo e($value->item_id); ?>" name="item_code[]"><font class="items<?php echo e($key); ?>"><?php echo e($value->item->code); ?></font></div></div></td><td><div class="form-group row"><div class="col-sm-12"><input class="item_name<?php echo e($key); ?>" type="hidden" value="<?php echo e($value->item->name); ?>" name="item_name[]"><font class="font_item_name<?php echo e($key); ?>"><?php echo e($value->item->name); ?></font></div></div></td><td><div class="form-group row"><div class="col-sm-12"><input class="hsn<?php echo e($key); ?>" type="hidden" value="<?php echo e($value->item->hsn); ?>" name="hsn[]"><font class="font_hsn<?php echo e($key); ?>"><?php echo e($value->item->hsn); ?></font></div></div></td><td><div class="form-group row"><div class="col-sm-12"><input type="hidden" class="mrp<?php echo e($key); ?>" value="<?php echo e($value->mrp); ?>" name="mrp[]"><font class="font_mrp<?php echo e($key); ?>"><?php echo e($value->mrp); ?></font></div></div></td><td><div class="form-group row"><div class="col-sm-12" id="unit_price"><input type="hidden" class="exclusive<?php echo e($key); ?>" value="<?php echo e($value->rate_exclusive_tax); ?>" name="exclusive[]"><font class="font_exclusive<?php echo e($key); ?>"><?php echo e($value->rate_exclusive_tax); ?></font><input type="hidden" class="inclusive<?php echo e($key); ?>" value="<?php echo e($value->rate_inclusive_tax); ?>" name="inclusive[]"></div></div></td><td><font class="font_purchase_quantity<?php echo e($key); ?>"><?php echo e($value->actual_purchase_qty); ?></font></td><td><font class="font_rejected_qty<?php echo e($key); ?>"><?php echo e($value->rejected_qty); ?></font><input type="hidden" class="rejected_quantity" name="rejected_item_qty[]" id="rejected_quantity<?php echo e($key); ?>" value="<?php echo e($value->rejected_qty); ?>"></td><td><div class="form-group row"><div class="col-sm-12"><input type="hidden" class="quantity<?php echo e($key); ?>" value="<?php echo e($value->remaining_qty); ?>" name="quantity[]"><font class="font_quantity<?php echo e($key); ?>"><?php echo e($value->remaining_qty); ?></font><input type="hidden" class="actual_quantity" id="actual_quantity<?php echo e($key); ?>" value="<?php echo e($value->remaining_after_debit); ?>" name="actual_quantity[]"><input type="hidden" class="actual_purchase_quantity" id="actual_purchase_quantity'.$i.'" value="<?php echo e($value->remaining_qty); ?>" name="actual_purchase_quantity[]"><input type="hidden" class="remaining_qty" id="remaining_qty<?php echo e($key); ?>" value="<?php echo e($value->remaining_qty); ?>" name="remaining_qty[]"></div></div></td><td><font class="font_debited_qty<?php echo e($key); ?>"><?php echo e($value->debited_qty); ?></font><input type="hidden" class="debited_qty" value="<?php echo e($value->debited_qty); ?>" name="debited_qty[]" id="debited_qty<?php echo e($key); ?>"></td><td><font class="font_remaining_after_debit<?php echo e($key); ?>"><?php echo e($value->remaining_after_debit); ?></font><input type="hidden" value="<?php echo e($value->remaining_after_debit); ?>" name="remaining_after_debit[]" id="remaining_after_debit<?php echo e($key); ?>"></td><td><div class="form-group row"><div class="col-sm-12"><input type="hidden" class="uom<?php echo e($key); ?>" value="<?php echo e($value->uom->id); ?>" name="uom[]"><font class="font_uom<?php echo e($key); ?>"><?php echo e($value->uom->name); ?></font></div></div></td><td><div class="form-group row"><div class="col-sm-12"><input type="hidden" class="table_amount" id="amnt<?php echo e($key); ?>" value="<?php echo e($item_amount[$key]); ?>" name="amount[]"><font class="font_amount<?php echo e($key); ?>"> <?php echo e($item_amount[$key]); ?> </font></div></div></td><td><div class="form-group row"><div class="col-sm-12"><input type="hidden" class="input_discounts <?php echo e($key); ?>" value="<?php echo e($value->discount); ?>" id="input_discount<?php echo e($key); ?>" ><input class="discount_val<?php echo e($key); ?>" type="hidden" value="<?php echo e($value->discount); ?>" name="discount[]"><font class="font_discount" id="font_discount<?php echo e($key); ?>"><?php echo e($value->discount); ?></font></div></div></td><td><div class="form-group row"><div class="col-sm-12"><input type="hidden" class="table_gst" id="tax<?php echo e($key); ?>" value="<?php echo e($item_gst_rs[$key]); ?>" name="gst[]"><input type="hidden" class="tax_gst<?php echo e($key); ?>"  value="<?php echo e($value->gst); ?>" name="tax_rate[]"><font class="font_gst<?php echo e($key); ?>"> <?php echo e($item_gst_rs[$key]); ?> </font></div></div></td><td><div class="form-group row"><div class="col-sm-12"><input type="hidden" class="table_net_price" id="net_price<?php echo e($key); ?>" value="<?php echo e($item_net_value[$key]); ?>" name="net_price[]"><font class="font_net_price<?php echo e($key); ?>"><?php echo e($item_net_value[$key]); ?></font></div></div></td><td style="background-color: #FAF860;"><div class="form-group row"><div class="col-sm-12"><center><font class="last_purchase<?php echo e($key); ?>"><?php echo e($net_value[$key]); ?></font></center></div></div></td><td><i class="fa fa-eye px-2 py-1 bg-info  text-white rounded show_items" id="<?php echo e($key); ?>" aria-hidden="true"></i><i class="fa fa-pencil px-2 py-1 bg-success  text-white rounded edit_items" id="<?php echo e($key); ?>" aria-hidden="true"></i><i class="fa fa-trash px-2 py-1 bg-danger  text-white rounded remove_items" id="<?php echo e($key); ?>" aria-hidden="true"></i></td></tr>
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <th></th>
                      <th></th>
                      <th><label class="total_amount"><?php echo e($item_amount_sum); ?></label></th>
                      <th></th>
                      <th></th>
                      <th><label class="total_net_price"><?php echo e($item_net_value_sum); ?></label></th>
                      ...
                      <th></th>
                       ...
                       <div class="row col-md-12">
                        ...
                        <div class="col-md-2">
                        <label style="font-family: Times new roman;">Discount(-)</label>
                      <input type="number" readonly="" class="form-control total_discount" id="total_discount" name="total_discount" pattern="[0-9]{0,100}" title="Numbers Only" value="<?php echo e($item_discount_sum); ?>">
                      </div>
                      <div class="col-md-2">
                        <label style="font-family: Times new roman;">Overall Discount</label>
                      <input type="number" class="form-control overall_discount" id="overall_discount" name="overall_discount" oninput="overall_discounts()" pattern="[0-9]{0,100}" title="Numbers Only" value="<?php echo e($debit_note->overall_discount); ?>">
                      </div>
                    </div>
                    ...
                    <!-- <div class="row col-md-12">
                        ...
                        <div class="row col-md-12 append_expense">
                          <?php if($expense_row_count > 0): ?>
                          <?php $__currentLoopData = $debit_note_expense; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <div class="form-group row">
                     <div class="col-sm-8">
                      <select class="js-example-basic-multiple col-12 form-control custom-select expense_type" readonly name="expense_type[]"  id="expense_type" >
                         <?php if(isset($value->expense_types->type) && !empty($value->expense_types->type)): ?>
                           <option value="<?php echo e($value->expense_types->id); ?>"><?php echo e($value->expense_types->type); ?></option>
                           <?php else: ?>
                     ...
                     <button type="button"  class="px-2 btn btn-success mx-2 refresh_expense_type_id" title="Add Expense Type"><i class="fa fa-refresh" aria-hidden="true"></i></button>
                      ...
                      <div class="col-md-2">
                        <label style="font-family: Times new roman;">Expense Amount</label>
                      <input type="number" class="form-control expense_amount" id="expense_amount"  placeholder="Expense Amount" name="expense_amount[]" step="any" title="Numbers Only" value="<?php echo e($value->expense_amount); ?>" readonly="">
                  ...
                  <div class="form-group row">
                    ...
                    <?php endif; ?>
                      ...
                      <input type="text" class="form-control round_off" readonly="" value="<?php echo e($debit_note->round_off); ?>" id="round_off" name="round_off" >
                      </div>
                        
                        <div class="col-md-2">
                        <label style="font-family: Times new roman;">CGST</label>
                      <input type="text" class="form-control cgst" readonly="" id="cgst" name="cgst" value="<?php echo e($item_cgst); ?>">
                      </div>

                      <div class="col-md-2">
                        <label style="font-family: Times new roman;">SGST</label>
                      <input type="text" class="form-control sgst" readonly="" id="sgst" name="sgst" value="<?php echo e($item_sgst); ?>">
                      </div>
                      <div class="col-md-4" style="float: right;">

                        <font color="black" style="font-size: 150%; margin-left: 100px; font-weight: 900;">NET Value :</font>&nbsp;<font class="total_net_value" style="font-size: 150%; font-weight: 900;"><?php echo e($debit_note->total_net_value); ?></font> 
                       </div>
                       
                       <div class="row col-md-12">
                         <div class="col-md-2">
                           <label style="font-family: Times new roman;">IGST</label>
                      <input type="text" class="form-control igst" readonly="" id="igst" name="igst" value="<?php echo e($item_gst_rs_sum); ?>">
                         </div>
                       </div>
...
if(append_value == 1)
{
  var row_id=$('#last').val();
      ...
      $.ajax({  
        ...
        type: "GET",
        url: "<?php echo e(url('debit_note/getdata/{id}')); ?>",
        data: { id: item_code },             
      ...
      $.ajax({
           type: "POST",
            url: "<?php echo e(url('debit_note/last_purchase_rate/')); ?>",
            data: { id: item_code },
           success: function(data) {
...
var row_id=$('#last').val();
      ...
      $.ajax({  
        ...
        type: "GET",
        url: "<?php echo e(url('debit_note/getdata_item/{id}')); ?>",
        data: { id: item_code },             
...
function item_with_same_data(item_code)
{
  $.ajax({
        ...
        type: "GET",
        url: "<?php echo e(url('debit_note/same_items/{id}')); ?>",
        data: { id: item_code },
...
function browse_item()
{
  ...
  $.ajax({  
        ...
        type: "GET",
        url: "<?php echo e(url('debit_note/browse_item/{id}')); ?>",
...
function categories_check()
{
  ...
  $.ajax({  
        ...
        type: "GET",
        url: "<?php echo e(url('debit_note/change_items/{id}')); ?>",
...
function brand_check()
{
  ...
  $.ajax({
        ...
        type: "POST",
        url: "<?php echo e(url('debit_note/brand_filter/')); ?>",
        data: {brand: brand },             
...
function supplier_details()
{
  ...
  $.ajax({
           type: "POST",
            url: "<?php echo e(url('debit_note/address_details/')); ?>",
           ...
           $('.r_out_no').children('option:not(:first)').remove()
           .end().append(result.r_out_options);
           }
        });
}
...
function p_details()
{
  ...
  $.ajax({
           type: "POST",
            url: "<?php echo e(url('debit_note/p_details/')); ?>",
            data: { p_no : p_no },
           success: function(data) {
            $('.tables').remove();
            $('.expense').remove();
...
function r_out_details()
{
  ...
  $.ajax({
           type: "POST",
            url: "<?php echo e(url('debit_note/r_out_details/')); ?>",
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ns_pollachi\resources\views/admin/debit_note/edit.blade.php ENDPATH**/ ?>